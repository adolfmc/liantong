...
public final class MaybeFlatMapIterableFlowable<T, R> extends Flowable<R> {
    ...
    static final class FlatMapIterableObserver<T, R> extends BasicIntQueueSubscription<R> implements MaybeObserver<T> {
        ...
        /* renamed from: it */
        volatile Iterator<? extends R> f24581it;
        final Function<? super T, ? extends Iterable<? extends R>> mapper;
        boolean outputFused;
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f24580d, disposable)) {
                this.f24580d = disposable;
        ...
        public void onError(Throwable th) {
            this.f24580d = DisposableHelper.DISPOSED;
            this.actual.onError(th);
        }
        ...
        void drain() {
            ...
            Iterator<? extends R> it = this.f24581it;
