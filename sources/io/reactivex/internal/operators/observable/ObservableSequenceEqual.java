    ...
    static final class EqualCoordinator<T> extends AtomicInteger implements Disposable {
        ...
        void drain() {
            ...
            while (!this.cancelled) {
                ...
                if (this.f24675v1 == null) {
                    this.f24675v1 = spscLinkedArrayQueue.poll();
                }
                boolean z3 = this.f24675v1 == null;
                if (this.f24676v2 == null) {
                    this.f24676v2 = spscLinkedArrayQueue2.poll();
                }
                boolean z4 = this.f24676v2 == null;
                if (z && z2 && z3 && z4) {
                    ...
                    if (!z3 && !z4) {
                        try {
                            if (!this.comparer.test((T) this.f24675v1, (T) this.f24676v2)) {
                                cancel(spscLinkedArrayQueue, spscLinkedArrayQueue2);
                                this.actual.onNext(false);
                                this.actual.onComplete();
                                return;
