...
public final class ObservableTimeoutTimed<T> extends AbstractObservableWithUpstream<T, T> {
    ...
    static final class TimeoutTimedOtherObserver<T> extends AtomicReference<Disposable> implements Observer<T>, Disposable {
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f24701s, disposable)) {
                this.f24701s = disposable;
        ...
        public void onNext(T t) {
            ...
            long j = this.index + 1;
            this.index = j;
            if (this.arbiter.onNext(t, this.f24701s)) {
                scheduleTimeout(j);
            }
        }
        ...
        public void onError(Throwable th) {
            ...
            this.done = true;
            this.arbiter.onError(th, this.f24701s);
            this.worker.dispose();
        }
        ...
        public void onComplete() {
            ...
            this.done = true;
            this.arbiter.onComplete(this.f24701s);
            this.worker.dispose();
        }

        @Override // io.reactivex.disposables.Disposable
        public void dispose() {
            this.f24701s.dispose();
            this.worker.dispose();
        }
        ...
        public final class SubscribeNext implements Runnable {
            ...
            public void run() {
                if (this.idx == TimeoutTimedOtherObserver.this.index) {
                    ...
                    timeoutTimedOtherObserver.f24701s.dispose();
    ...
    static final class TimeoutTimedObserver<T> extends AtomicReference<Disposable> implements Observer<T>, Disposable {
        ...
        @Override // io.reactivex.Observer
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f24700s, disposable)) {
                this.f24700s = disposable;
        ...
        public final class TimeoutTask implements Runnable {
            ...
            public void run() {
                if (this.idx == TimeoutTimedObserver.this.index) {
                    ...
                    timeoutTimedObserver.f24700s.dispose();
