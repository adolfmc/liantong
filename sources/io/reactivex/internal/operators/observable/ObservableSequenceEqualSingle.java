    ...
    static final class EqualCoordinator<T> extends AtomicInteger implements Disposable {
        ...
        void drain() {
            ...
            while (!this.cancelled) {
                ...
                if (this.f24677v1 == null) {
                    this.f24677v1 = spscLinkedArrayQueue.poll();
                }
                boolean z3 = this.f24677v1 == null;
                if (this.f24678v2 == null) {
                    this.f24678v2 = spscLinkedArrayQueue2.poll();
                }
                boolean z4 = this.f24678v2 == null;
                if (z && z2 && z3 && z4) {
                    ...
                    if (!z3 && !z4) {
                        try {
                            if (!this.comparer.test((T) this.f24677v1, (T) this.f24678v2)) {
                                cancel(spscLinkedArrayQueue, spscLinkedArrayQueue2);
                                this.actual.onSuccess(false);
                                return;
                            }
