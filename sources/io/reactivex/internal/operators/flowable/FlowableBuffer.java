...
public final class FlowableBuffer<T, C extends Collection<? super T>> extends AbstractFlowableWithUpstream<T, C> {
    ...
    static final class PublisherBufferExactSubscriber<T, C extends Collection<? super T>> implements FlowableSubscriber<T>, Subscription {
        ...
        public void request(long j) {
            if (SubscriptionHelper.validate(j)) {
                this.f24452s.request(BackpressureHelper.multiplyCap(j, this.size));
            }
        }
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f24452s, subscription)) {
                this.f24452s = subscription;
    ...
    static final class PublisherBufferSkipSubscriber<T, C extends Collection<? super T>> extends AtomicInteger implements FlowableSubscriber<T>, Subscription {
        ...
        public void request(long j) {
            if (SubscriptionHelper.validate(j)) {
                if (get() == 0 && compareAndSet(0, 1)) {
                    this.f24454s.request(BackpressureHelper.addCap(BackpressureHelper.multiplyCap(j, this.size), BackpressureHelper.multiplyCap(this.skip - this.size, j - 1)));
                    return;
                }
                this.f24454s.request(BackpressureHelper.multiplyCap(this.skip, j));
            }
        }
        ...
        @Override // io.reactivex.FlowableSubscriber, org.reactivestreams.Subscriber
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f24454s, subscription)) {
                this.f24454s = subscription;
                this.actual.onSubscribe(this);
            }
        }
    ...
    static final class PublisherBufferOverlappingSubscriber<T, C extends Collection<? super T>> extends AtomicLong implements FlowableSubscriber<T>, BooleanSupplier, Subscription {
        ...
        public void request(long j) {
            ...
            if (!this.once.get() && this.once.compareAndSet(false, true)) {
                this.f24453s.request(BackpressureHelper.addCap(this.size, BackpressureHelper.multiplyCap(this.skip, j - 1)));
                return;
            }
            this.f24453s.request(BackpressureHelper.multiplyCap(this.skip, j));
        }
        ...
        @Override // io.reactivex.FlowableSubscriber, org.reactivestreams.Subscriber
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f24453s, subscription)) {
                this.f24453s = subscription;
                this.actual.onSubscribe(this);
            }
        }
