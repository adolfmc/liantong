...
public final class FlowableWindowBoundarySelector<T, B, V> extends AbstractFlowableWithUpstream<T, Flowable<T>> {
    ...
    static final class WindowBoundaryMainSubscriber<T, B, V> extends QueueDrainSubscriber<T, Object, Flowable<T>> implements Subscription {
        ...
        /* renamed from: s */
        Subscription f24559s;
        final AtomicLong windows;

        /* renamed from: ws */
        final List<UnicastProcessor<T>> f24560ws;
        ...
        WindowBoundaryMainSubscriber(Subscriber<? super Flowable<T>> subscriber, Publisher<B> publisher, Function<? super B, ? extends Publisher<V>> function, int i) {
            ...
            this.f24560ws = new ArrayList();
            this.windows.lazySet(1L);
        }

        @Override // io.reactivex.FlowableSubscriber, org.reactivestreams.Subscriber
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f24559s, subscription)) {
                this.f24559s = subscription;
        ...
        public void onNext(T t) {
            ...
            if (fastEnter()) {
                for (UnicastProcessor<T> unicastProcessor : this.f24560ws) {
        ...
        void drainLoop() {
            ...
            List<UnicastProcessor<T>> list = this.f24560ws;
            int i = 1;
            while (true) {
                boolean z = this.done;
                ...
                if (z && z2) {
                    ...
                    if (poll instanceof WindowOperation) {
                        ...
                        if (windowOperation.f24561w != null) {
                            if (list.remove(windowOperation.f24561w)) {
                                windowOperation.f24561w.onComplete();
                                if (this.windows.decrementAndGet() == 0) {
                                    dispose();
                                    return;
                                }
        ...
        void close(OperatorWindowBoundaryCloseSubscriber<T, V> operatorWindowBoundaryCloseSubscriber) {
            ...
            this.queue.offer(new WindowOperation(operatorWindowBoundaryCloseSubscriber.f24558w, null));
            if (enter()) {
                drainLoop();
            }
        }
 ...
 */
    ...
    public static final class WindowOperation<T, B> {
        ...
        /* renamed from: w */
        final UnicastProcessor<T> f24561w;

        WindowOperation(UnicastProcessor<T> unicastProcessor, B b) {
            this.f24561w = unicastProcessor;
            this.open = b;
        }
    }
    ...
    public static final class OperatorWindowBoundaryCloseSubscriber<T, V> extends DisposableSubscriber<V> {
        ...
        /* renamed from: w */
        final UnicastProcessor<T> f24558w;
