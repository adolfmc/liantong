...
public final class FlowableWindow<T> extends AbstractFlowableWithUpstream<T, Flowable<T>> {
    ...
    static final class WindowExactSubscriber<T> extends AtomicInteger implements FlowableSubscriber<T>, Runnable, Subscription {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f24554s, subscription)) {
                this.f24554s = subscription;
        ...
        public void request(long j) {
            if (SubscriptionHelper.validate(j)) {
                this.f24554s.request(BackpressureHelper.multiplyCap(this.size, j));
            }
        }
    ...
    static final class WindowSkipSubscriber<T> extends AtomicInteger implements FlowableSubscriber<T>, Runnable, Subscription {
        ...
        @Override // io.reactivex.FlowableSubscriber, org.reactivestreams.Subscriber
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f24556s, subscription)) {
                this.f24556s = subscription;
                this.actual.onSubscribe(this);
            }
        }
        ...
        public void request(long j) {
            if (SubscriptionHelper.validate(j)) {
                if (!this.firstRequest.get() && this.firstRequest.compareAndSet(false, true)) {
                    this.f24556s.request(BackpressureHelper.addCap(BackpressureHelper.multiplyCap(this.size, j), BackpressureHelper.multiplyCap(this.skip - this.size, j - 1)));
                    return;
                }
                this.f24556s.request(BackpressureHelper.multiplyCap(this.skip, j));
            }
        }
    ...
    static final class WindowOverlapSubscriber<T> extends AtomicInteger implements FlowableSubscriber<T>, Runnable, Subscription {
        ...
        @Override // io.reactivex.FlowableSubscriber, org.reactivestreams.Subscriber
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f24555s, subscription)) {
                this.f24555s = subscription;
                this.actual.onSubscribe(this);
            }
        }
        ...
        */
        ...
        public void request(long j) {
            if (SubscriptionHelper.validate(j)) {
                ...
                if (!this.firstRequest.get() && this.firstRequest.compareAndSet(false, true)) {
                    this.f24555s.request(BackpressureHelper.addCap(this.size, BackpressureHelper.multiplyCap(this.skip, j - 1)));
                } else {
                    this.f24555s.request(BackpressureHelper.multiplyCap(this.skip, j));
                }
                drain();
            }
        }
