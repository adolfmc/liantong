...
public final class FlowableCollectSingle<T, U> extends Single<U> implements FuseToFlowable<U> {
    ...
    static final class CollectSubscriber<T, U> implements FlowableSubscriber<T>, Disposable {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f24464s, subscription)) {
                this.f24464s = subscription;
        ...
        public void onNext(T t) {
            ...
            try {
                this.collector.accept((U) this.f24465u, t);
            } catch (Throwable th) {
        ...
        public void onError(Throwable th) {
            ...
            this.done = true;
            this.f24464s = SubscriptionHelper.CANCELLED;
        ...
        public void onComplete() {
            ...
            this.done = true;
            this.f24464s = SubscriptionHelper.CANCELLED;
            this.actual.onSuccess((U) this.f24465u);
        }
        ...
        public boolean isDisposed() {
            return this.f24464s == SubscriptionHelper.CANCELLED;
        }
    }
}
