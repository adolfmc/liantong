...
public final class FlowableWindowTimed<T> extends AbstractFlowableWithUpstream<T, Flowable<T>> {
    ...
    static final class WindowExactUnboundedSubscriber<T> extends QueueDrainSubscriber<T, Object, Flowable<T>> implements FlowableSubscriber<T>, Runnable, Subscription {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f24564s, subscription)) {
                this.f24564s = subscription;
        ...
        */
        void drainLoop() {
            ...
            L63:
                ...
                io.reactivex.internal.fuseable.SimplePlainQueue<U> r0 = r10.queue
                r0.clear()
                org.reactivestreams.Subscription r0 = r10.f24564s
                r0.cancel()
                r10.dispose()
                ...
                return
            L7d:
                org.reactivestreams.Subscription r4 = r10.f24564s
                r4.cancel()
                goto L7
            L83:
    ...
    static final class WindowExactBoundedSubscriber<T> extends QueueDrainSubscriber<T, Object, Flowable<T>> implements Subscription {
        ...
        public void onSubscribe(Subscription subscription) {
            ...
            if (SubscriptionHelper.validate(this.f24563s, subscription)) {
                this.f24563s = subscription;
                Subscriber<? super V> subscriber = this.actual;
                subscriber.onSubscribe(this);
                if (this.cancelled) {
                    return;
    ...
    static final class WindowSkipSubscriber<T> extends QueueDrainSubscriber<T, Object, Flowable<T>> implements Runnable, Subscription {
        ...
        @Override // io.reactivex.FlowableSubscriber, org.reactivestreams.Subscriber
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f24565s, subscription)) {
                this.f24565s = subscription;
            ...
            while (!this.terminated) {
                ...
                if (z && (z2 || z3)) {
                    ...
                    if (subjectWork.open) {
                        ...
                        list.remove(subjectWork.f24566w);
                        subjectWork.f24566w.onComplete();
 ...
 */
        ...
        public static final class SubjectWork<T> {
            ...
            /* renamed from: w */
            final UnicastProcessor<T> f24566w;

            SubjectWork(UnicastProcessor<T> unicastProcessor, boolean z) {
                this.f24566w = unicastProcessor;
                this.open = z;
            }
        }
