 ...
 */
    ...
    public void setSurface(Surface surface) {
        if (this.mScreenOnWhilePlaying && surface != null) {
            DebugLog.m81w(TAG, "setScreenOnWhilePlaying(true) is ineffective for Surface");
        }
    ...
    */
    public void setDataSource(android.content.Context r8, android.net.Uri r9, java.util.Map<java.lang.String, java.lang.String> r10) throws java.io.IOException, java.lang.IllegalArgumentException, java.lang.SecurityException, java.lang.IllegalStateException {
        ...
        L60:
            ...
            r1 = r7
            r1.setDataSource(r2, r3, r5)     // Catch: java.lang.Throwable -> L76 java.io.IOException -> L7d java.lang.SecurityException -> L80
        L70:
            if (r0 == 0) goto L75
            r0.close()
        L75:
    ...
    public void setScreenOnWhilePlaying(boolean z) {
        if (this.mScreenOnWhilePlaying != z) {
            if (z && this.mSurfaceHolder == null) {
                DebugLog.m81w(TAG, "setScreenOnWhilePlaying(true) is ineffective without a SurfaceHolder");
            }
        ...
        public void handleMessage(Message message) {
            ...
            if (ijkMediaPlayer != null) {
                if (ijkMediaPlayer.mNativeMediaPlayer != 0) {
                    ...
                    if (i == 200) {
                        if (message.arg1 == 3) {
                            DebugLog.m85i(IjkMediaPlayer.TAG, "Info: MEDIA_INFO_VIDEO_RENDERING_START\n");
                        }
                        ...
                        switch (i) {
                            ...
                            default:
                                switch (i) {
                                    ...
                                    case 100:
                                        DebugLog.m87e(IjkMediaPlayer.TAG, "Error (" + message.arg1 + "," + message.arg2 + ")");
                                        ...
                                        return;
                                    default:
                                        DebugLog.m87e(IjkMediaPlayer.TAG, "Unknown message type " + message.what);
                                        return;
                                }
                        }
                    }
            ...
            DebugLog.m81w(IjkMediaPlayer.TAG, "IjkMediaPlayer went away with unhandled events");
        }
    }
