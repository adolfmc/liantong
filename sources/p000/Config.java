...
/*  JADX ERROR: Load error
    jadx.core.utils.exceptions.JadxRuntimeException: Error decode class: com.xiaomi.clientreport.data.Config
    ...
    Caused by: java.lang.IllegalArgumentException: newPosition > limit: (12193424 > 11617560)
