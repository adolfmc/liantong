...
/*  JADX ERROR: Load error
    jadx.core.utils.exceptions.JadxRuntimeException: Error decode class: net.lingala.zip4j.tasks.AbstractAddFileToZipTask
    ...
    Caused by: java.lang.IllegalArgumentException: newPosition > limit: (13073604 > 11617560)
    ...
    */
/* renamed from: AbstractAddFileToZipTask */
public abstract class AbstractAddFileToZipTask {
}
