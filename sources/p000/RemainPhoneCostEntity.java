...
/*  JADX ERROR: Load error
    jadx.core.utils.exceptions.JadxRuntimeException: Error decode class: com.sinovatech.unicom.separatemodule.user.entity.HuaFeiEntity.DataEntity.RemainPhoneCostEntity
    ...
    Caused by: java.lang.IllegalArgumentException: newPosition > limit: (12873856 > 11480076)
    ...
    */
/* renamed from: RemainPhoneCostEntity */
public class RemainPhoneCostEntity {
}
