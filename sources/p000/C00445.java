...
/*  JADX ERROR: Load error
    jadx.core.utils.exceptions.JadxRuntimeException: Error decode class: tv.danmaku.ijk.media.player.MediaPlayerProxy.5
    ...
    Caused by: java.lang.IllegalArgumentException: newPosition > limit: (9411980 > 9227576)
