...
/*  JADX ERROR: Load error
    jadx.core.utils.exceptions.JadxRuntimeException: Error decode class: net.lingala.zip4j.crypto.PBKDF2.PBKDF2Engine
    ...
    Caused by: java.lang.IllegalArgumentException: newPosition > limit: (12474440 > 11617560)
