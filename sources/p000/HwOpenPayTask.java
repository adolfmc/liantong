...
/*  JADX ERROR: Load error
    jadx.core.utils.exceptions.JadxRuntimeException: Error decode class: com.huawei.nfc.sdk.service.HwOpenPayTask
    ...
    Caused by: java.lang.IllegalArgumentException: newPosition > limit: (11476776 > 10762272)
