...
/*  JADX ERROR: Load error
    jadx.core.utils.exceptions.JadxRuntimeException: Error decode class: io.socket.engineio.client.transports.PollingXHR
    ...
    Caused by: java.lang.IllegalArgumentException: newPosition > limit: (13281536 > 11617560)
