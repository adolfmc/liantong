...
/*  JADX ERROR: Load error
    jadx.core.utils.exceptions.JadxRuntimeException: Error decode class: com.huawei.hms.common.data.DBInnerIter
    ...
    Caused by: java.lang.IllegalArgumentException: newPosition > limit: (11404836 > 10762272)
