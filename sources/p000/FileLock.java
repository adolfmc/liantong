...
/*  JADX ERROR: Load error
    jadx.core.utils.exceptions.JadxRuntimeException: Error decode class: com.liulishuo.okdownload.core.file.FileLock
    ...
    Caused by: java.lang.IllegalArgumentException: newPosition > limit: (11591524 > 10762272)
