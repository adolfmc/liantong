 ...
 */
    ...
    */
    private java.nio.ByteBuffer serializeConfigBytes() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: szcom.googlecode.mp4parser.boxes.mp4.objectdescriptors.AudioSpecificConfig.serializeConfigBytes():java.nio.ByteBuffer");
    }
    ...
    private void writeAudioObjectType(int i, BitWriterBuffer bitWriterBuffer) {
        ...
        bitWriterBuffer.writeBits(i, i2);
    }
    ...
    int getContentSize() {
        int i = (this.originalAudioObjectType > 30 ? 11 : 5) + 4;
