...
import szcom.googlecode.mp4parser.boxes.AC3SpecificBox;
...
public class AC3TrackImpl extends AbstractTrack {
    ...
    private List<Sample> readSamples() {
        ...
        while (-1 != this.dataSource.read(allocate)) {
            ...
            arrayList.add(new Sample(this.dataSource.position() - 5, frameSize, this.dataSource) { // from class: szcom.googlecode.mp4parser.authoring.tracks.AC3TrackImpl.1SampleImpl
                private final DataSource dataSource;
