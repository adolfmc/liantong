        ...
        if (pictureParameterSet.num_slice_groups_minus1 > 0) {
            ...
            if (i2 == 0) {
                ...
                for (int i6 = 0; i6 <= readUE; i6++) {
                    pictureParameterSet.slice_group_id[i6] = cAVLCReader.readU(i5, "PPS: slice_group_id [" + i6 + "]f");
                }
            }
        }
                ...
                for (int i7 = 0; i7 < ((this.extended.transform_8x8_mode_flag ? 1 : 0) * 2) + 6; i7++) {
                    if (i7 < 6) {
                        ...
                        if (this.extended.scalindMatrix.ScalingList4x4[i7] != null) {
                            scalingList = this.extended.scalindMatrix.ScalingList4x4[i7];
                        ...
                        if (this.extended.scalindMatrix.ScalingList8x8[i8] != null) {
                            scalingList = this.extended.scalindMatrix.ScalingList8x8[i8];
                            scalingList.write(cAVLCWriter);
                        }
                    }
                }
