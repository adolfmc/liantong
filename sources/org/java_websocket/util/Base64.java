    ...
    public static class OutputStream extends FilterOutputStream {
        ...
        public void write(int i) throws IOException {
            if (this.suspendEncoding) {
                ...
                bArr[i2] = (byte) i;
                if (this.position >= this.bufferLength) {
                    this.out.write(Base64.encode3to4(this.f27412b4, this.buffer, this.bufferLength, this.options));
                    this.lineLength += 4;
                ...
                if (bArr2[i3] > -5) {
                    ...
                    bArr3[i4] = (byte) i;
                    if (this.position >= this.bufferLength) {
                        this.out.write(this.f27412b4, 0, Base64.decode4to3(bArr3, 0, this.f27412b4, 0, this.options));
                        this.position = 0;
                    }
                } else if (bArr2[i3] != -5) {
        ...
        public void flushBase64() throws IOException {
            if (this.position > 0) {
                if (this.encode) {
                    this.out.write(Base64.encode3to4(this.f27412b4, this.buffer, this.position, this.options));
                    this.position = 0;
                    return;
                }
