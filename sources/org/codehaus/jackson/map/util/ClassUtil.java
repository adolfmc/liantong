...
public final class ClassUtil {
    ...
    public static boolean isConcrete(Class<?> cls) {
        return (cls.getModifiers() & MediaRecorderBase.VIDEO_BITRATE_MEDIUM) == 0;
    }

    public static boolean isConcrete(Member member) {
        return (member.getModifiers() & MediaRecorderBase.VIDEO_BITRATE_MEDIUM) == 0;
    }
