 ...
 */
    ...
    public static class Pair extends AnnotationIntrospector {
        ...
        public String findRootName(AnnotatedClass annotatedClass) {
            ...
            return (findRootName2.length() <= 0 && (findRootName = this._secondary.findRootName(annotatedClass)) != null) ? findRootName : findRootName2;
        }
        ...
        public String findGettablePropertyName(AnnotatedMethod annotatedMethod) {
            ...
            return (findGettablePropertyName2.length() != 0 || (findGettablePropertyName = this._secondary.findGettablePropertyName(annotatedMethod)) == null) ? findGettablePropertyName2 : findGettablePropertyName;
        }
        ...
        public String findSerializablePropertyName(AnnotatedField annotatedField) {
            ...
            return (findSerializablePropertyName2.length() != 0 || (findSerializablePropertyName = this._secondary.findSerializablePropertyName(annotatedField)) == null) ? findSerializablePropertyName2 : findSerializablePropertyName;
        }
        ...
        public String findSettablePropertyName(AnnotatedMethod annotatedMethod) {
            ...
            return (findSettablePropertyName2.length() != 0 || (findSettablePropertyName = this._secondary.findSettablePropertyName(annotatedMethod)) == null) ? findSettablePropertyName2 : findSettablePropertyName;
        }
        ...
        public String findDeserializablePropertyName(AnnotatedField annotatedField) {
            ...
            return (findDeserializablePropertyName2.length() != 0 || (findDeserializablePropertyName = this._secondary.findDeserializablePropertyName(annotatedField)) == null) ? findDeserializablePropertyName2 : findDeserializablePropertyName;
        }
