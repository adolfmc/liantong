...
abstract class MemberUtils {
    ...
    public static int compareConstructorFit(Constructor<?> constructor, Constructor<?> constructor2, Class<?>[] clsArr) {
        return compareParameterTypes(Executable.m374of(constructor), Executable.m374of(constructor2), clsArr);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static int compareMethodFit(Method method, Method method2, Class<?>[] clsArr) {
        return compareParameterTypes(Executable.m373of(method), Executable.m373of(method2), clsArr);
    }
    ...
    private static float getTotalTransformationCost(Class<?>[] clsArr, Executable executable) {
        ...
        if (isVarArgs) {
            ...
            if (z2) {
                return f + getObjectTransformationCost(componentType, Object.class) + 0.001f;
            }
            if (z) {
                return f + getObjectTransformationCost(clsArr[clsArr.length - 1].getComponentType(), componentType) + 0.001f;
            }
    ...
    public static boolean isMatchingMethod(Method method, Class<?>[] clsArr) {
        return isMatchingExecutable(Executable.m373of(method), clsArr);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static boolean isMatchingConstructor(Constructor<?> constructor, Class<?>[] clsArr) {
        return isMatchingExecutable(Executable.m374of(constructor), clsArr);
    }
 ...
 */
    ...
    public static final class Executable {
        ...
        /* renamed from: of */
        public static Executable m373of(Method method) {
            return new Executable(method);
        }

        /* JADX INFO: Access modifiers changed from: private */
        /* renamed from: of */
        public static Executable m374of(Constructor<?> constructor) {
