...
public class GOST28147ParameterSpec implements AlgorithmParameterSpec {
    ...
    public GOST28147ParameterSpec(String str, byte[] bArr) {
        this(str);
        this.f26897iv = new byte[bArr.length];
        System.arraycopy(bArr, 0, this.f26897iv, 0, bArr.length);
    }

    public GOST28147ParameterSpec(ASN1ObjectIdentifier aSN1ObjectIdentifier, byte[] bArr) {
        this(getName(aSN1ObjectIdentifier));
        this.f26897iv = Arrays.clone(bArr);
    }
    ...
    public GOST28147ParameterSpec(byte[] bArr, byte[] bArr2) {
        this(bArr);
        this.f26897iv = new byte[bArr2.length];
        System.arraycopy(bArr2, 0, this.f26897iv, 0, bArr2.length);
    }
    ...
    public byte[] getIV() {
        return Arrays.clone(this.f26897iv);
    }
