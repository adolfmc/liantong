 ...
 */
    ...
    */
    ...
    protected byte[] engineGetIV() {
        return Arrays.clone(this.f26891iv);
    }
    ...
    protected AlgorithmParameters engineGetParameters() {
        if (this.engineParams == null && this.f26891iv != null) {
            ...
            try {
                ...
                this.engineParams.init(new IvParameterSpec(this.f26891iv));
            } catch (Exception e) {
    ...
    protected void engineInit(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (algorithmParameterSpec instanceof IvParameterSpec) {
            this.f26891iv = ((IvParameterSpec) algorithmParameterSpec).getIV();
            keyParameter = new ParametersWithIV(keyParameter, this.f26891iv);
        }
        ...
        if ((keyParameter instanceof KeyParameter) && this.ivSize != 0 && (i == 3 || i == 1)) {
            this.f26891iv = new byte[this.ivSize];
            secureRandom.nextBytes(this.f26891iv);
            keyParameter = new ParametersWithIV(keyParameter, this.f26891iv);
        }
