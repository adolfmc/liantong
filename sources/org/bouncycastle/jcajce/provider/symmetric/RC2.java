 ...
 */
    ...
    public static class AlgParams extends BaseAlgorithmParameters {
        ...
        protected byte[] engineGetEncoded() {
            return Arrays.clone(this.f26890iv);
        }
        ...
        protected void engineInit(byte[] bArr) throws IOException {
            this.f26890iv = Arrays.clone(bArr);
        }
        ...
        protected void engineInit(byte[] bArr, String str) throws IOException {
            ...
            this.f26890iv = rC2CBCParameter.getIV();
        }
        ...
        public AlgorithmParameterSpec localEngineGetParameterSpec(Class cls) throws InvalidParameterSpecException {
            ...
            if ((cls == RC2ParameterSpec.class || cls == AlgorithmParameterSpec.class) && (i = this.parameterVersion) != -1) {
                return i < 256 ? new RC2ParameterSpec(ekb[i], this.f26890iv) : new RC2ParameterSpec(i, this.f26890iv);
            } else if (cls == IvParameterSpec.class) {
                return new IvParameterSpec(this.f26890iv);
            } else {
