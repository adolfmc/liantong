 ...
 */
    ...
    public static class AlgParams extends BaseAlgorithmParameters {
        ...
        /* renamed from: iv */
        private byte[] f26885iv;
        private int keyLength = 128;

        @Override // java.security.AlgorithmParametersSpi
        protected byte[] engineGetEncoded() {
            byte[] bArr = this.f26885iv;
        ...
        protected void engineInit(AlgorithmParameterSpec algorithmParameterSpec) throws InvalidParameterSpecException {
            ...
            this.f26885iv = ((IvParameterSpec) algorithmParameterSpec).getIV();
        }

        @Override // java.security.AlgorithmParametersSpi
        protected void engineInit(byte[] bArr) throws IOException {
            this.f26885iv = new byte[bArr.length];
            byte[] bArr2 = this.f26885iv;
        ...
        protected void engineInit(byte[] bArr, String str) throws IOException {
            if (isASN1FormatString(str)) {
                ...
                this.f26885iv = cAST5CBCParameters.getIV();
        ...
        public AlgorithmParameterSpec localEngineGetParameterSpec(Class cls) throws InvalidParameterSpecException {
            if (cls == IvParameterSpec.class || cls == AlgorithmParameterSpec.class) {
                return new IvParameterSpec(this.f26885iv);
            }
