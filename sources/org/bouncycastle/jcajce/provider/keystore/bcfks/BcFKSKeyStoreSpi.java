...
import org.bouncycastle.asn1.p454bc.EncryptedObjectStoreData;
import org.bouncycastle.asn1.p454bc.EncryptedPrivateKeyData;
import org.bouncycastle.asn1.p454bc.EncryptedSecretKeyData;
import org.bouncycastle.asn1.p454bc.ObjectData;
import org.bouncycastle.asn1.p454bc.ObjectDataSequence;
import org.bouncycastle.asn1.p454bc.ObjectStore;
import org.bouncycastle.asn1.p454bc.ObjectStoreData;
import org.bouncycastle.asn1.p454bc.ObjectStoreIntegrityCheck;
import org.bouncycastle.asn1.p454bc.PbkdMacIntegrityCheck;
import org.bouncycastle.asn1.p454bc.SecretKeyData;
import org.bouncycastle.asn1.p454bc.SignatureCheck;
 ...
 */
    ...
    private Cipher createCipher(String str, byte[] bArr) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, NoSuchProviderException {
        ...
        createCipher.init(1, new SecretKeySpec(bArr, C0108a.f85c));
        return createCipher;
    }
    ...
    private byte[] decryptData(String str, AlgorithmIdentifier algorithmIdentifier, char[] cArr, byte[] bArr) throws IOException {
        ...
        if (algorithmIdentifier.getAlgorithm().equals((ASN1Primitive) PKCSObjectIdentifiers.id_PBES2)) {
            ...
            try {
                ...
                createCipher.init(2, new SecretKeySpec(generateKey(keyDerivationFunc, str, cArr, 32), C0108a.f85c), algorithmParameters);
    ...
    private void verifySig(ASN1Encodable aSN1Encodable, SignatureCheck signatureCheck, PublicKey publicKey) throws GeneralSecurityException, IOException {
        ...
        createSignature.update(aSN1Encodable.toASN1Primitive().getEncoded("DER"));
    ...
    public void engineLoad(InputStream inputStream, char[] cArr) throws IOException, NoSuchAlgorithmException, CertificateException {
        ...
        try {
            ...
            Object storeData2 = objectStore.getStoreData();
            ...
            ObjectStoreData objectStoreData = ObjectStoreData.getInstance(storeData2);
            try {
    ...
    public void engineSetKeyEntry(String str, Key key, char[] cArr, Certificate[] certificateArr) throws KeyStoreException {
        ...
        if (key instanceof PrivateKey) {
            ...
            try {
                ...
                if (upperCase.indexOf(C0108a.f85c) > -1) {
    ...
    public void engineStore(KeyStore.LoadStoreParameter loadStoreParameter) throws CertificateException, NoSuchAlgorithmException, IOException {
        ...
        if (loadStoreParameter instanceof BCFKSStoreParameter) {
            ...
            extractPassword = ParameterUtil.extractPassword(loadStoreParameter);
