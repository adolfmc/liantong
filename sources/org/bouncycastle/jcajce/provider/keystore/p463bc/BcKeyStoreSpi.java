package org.bouncycastle.jcajce.provider.keystore.p463bc;
...
import org.bouncycastle.crypto.p459io.DigestInputStream;
import org.bouncycastle.crypto.p459io.DigestOutputStream;
import org.bouncycastle.crypto.p459io.MacInputStream;
import org.bouncycastle.crypto.p459io.MacOutputStream;
import org.bouncycastle.jcajce.p460io.CipherInputStream;
import org.bouncycastle.jcajce.p460io.CipherOutputStream;
...
import org.bouncycastle.util.p466io.TeeOutputStream;
 ...
 */
    ...
    /* loaded from: E:\9227576_dexfile_execute.dex */
    static class BCKeyStoreException extends KeyStoreException {
 ...
 */
    ...
    public static class BouncyCastleStore extends BcKeyStoreSpi {
        ...
        @Override // org.bouncycastle.jcajce.provider.keystore.p463bc.BcKeyStoreSpi, java.security.KeyStoreSpi
        ...
        Object getObject(char[] cArr) throws NoSuchAlgorithmException, UnrecoverableKeyException {
            ...
            if (this.type == 4) {
                ...
                try {
                    ...
                    dataInputStream.readFully(bArr);
                    try {
                        return BcKeyStoreSpi.this.decodeKey(new DataInputStream(new CipherInputStream(dataInputStream, BcKeyStoreSpi.this.makePBECipher("PBEWithSHAAnd3-KeyTripleDES-CBC", 2, cArr, bArr, dataInputStream.readInt()))));
