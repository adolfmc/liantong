 ...
 */
    ...
    private X509CertificateInternal getInternalCertificate() {
        ...
        synchronized (this.cacheLock) {
            ...
            try {
                ...
                bArr = this.f26883c.getEncoded("DER");
            } catch (IOException e) {
                bArr = null;
                x509CertificateEncodingException = new X509CertificateEncodingException(e);
            }
            X509CertificateInternal x509CertificateInternal2 = new X509CertificateInternal(this.bcHelper, this.f26883c, this.basicConstraints, this.keyUsage, this.sigAlgName, this.sigAlgParams, bArr, x509CertificateEncodingException);
            synchronized (this.cacheLock) {
                if (this.internalCertificateValue == null) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CertificateObject) {
            ...
            } else if ((this.internalCertificateValue == null || x509CertificateObject.internalCertificateValue == null) && (signature = this.f26883c.getSignature()) != null && !signature.equals((ASN1Primitive) x509CertificateObject.f26883c.getSignature())) {
                return false;
            }
