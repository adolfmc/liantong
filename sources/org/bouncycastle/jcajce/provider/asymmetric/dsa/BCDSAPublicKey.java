...
public class BCDSAPublicKey implements DSAPublicKey {
    ...
    /* renamed from: y */
    private BigInteger f26870y;

    /* JADX INFO: Access modifiers changed from: package-private */
    public BCDSAPublicKey(DSAPublicKey dSAPublicKey) {
        this.f26870y = dSAPublicKey.getY();
        this.dsaSpec = dSAPublicKey.getParams();
        this.lwKeyParams = new DSAPublicKeyParameters(this.f26870y, DSAUtil.toDSAParameters(this.dsaSpec));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public BCDSAPublicKey(DSAPublicKeySpec dSAPublicKeySpec) {
        this.f26870y = dSAPublicKeySpec.getY();
    ...
    public BCDSAPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        try {
            this.f26870y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
    ...
    public BCDSAPublicKey(DSAPublicKeyParameters dSAPublicKeyParameters) {
        this.f26870y = dSAPublicKeyParameters.getY();
    ...
    public byte[] getEncoded() {
        ...
        if (this.dsaSpec == null) {
            ...
            aSN1Integer = new ASN1Integer(this.f26870y);
        } else {
    ...
    public String toString() {
        ...
        stringBuffer.append(DSAUtil.generateKeyFingerprint(this.f26870y, getParams()));
        stringBuffer.append("]");
