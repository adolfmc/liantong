...
public class BCDHPublicKey implements DHPublicKey {
    ...
    /* renamed from: y */
    private BigInteger f26865y;

    /* JADX INFO: Access modifiers changed from: package-private */
    public BCDHPublicKey(BigInteger bigInteger, DHParameterSpec dHParameterSpec) {
        this.f26865y = bigInteger;
    ...
    public BCDHPublicKey(DHPublicKey dHPublicKey) {
        this.f26865y = dHPublicKey.getY();
        this.dhSpec = dHPublicKey.getParams();
        DHParameterSpec dHParameterSpec = this.dhSpec;
        this.dhPublicKey = dHParameterSpec instanceof DHDomainParameterSpec ? new DHPublicKeyParameters(this.f26865y, ((DHDomainParameterSpec) dHParameterSpec).getDomainParameters()) : new DHPublicKeyParameters(this.f26865y, new DHParameters(dHParameterSpec.getP(), this.dhSpec.getG()));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public BCDHPublicKey(DHPublicKeySpec dHPublicKeySpec) {
        this.f26865y = dHPublicKeySpec.getY();
        ...
        if (dHParameterSpec instanceof DHDomainParameterSpec) {
            this.dhPublicKey = new DHPublicKeyParameters(this.f26865y, ((DHDomainParameterSpec) dHParameterSpec).getDomainParameters());
        } else {
            this.dhPublicKey = new DHPublicKeyParameters(this.f26865y, new DHParameters(dHPublicKeySpec.getP(), dHPublicKeySpec.getG()));
        }
    }
    ...
    public BCDHPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            this.f26865y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
            ...
            if (algorithm.equals((ASN1Primitive) PKCSObjectIdentifiers.dhKeyAgreement) || isPKCSParam(aSN1Sequence)) {
                ...
                if (dHParameter.getL() != null) {
                    ...
                    dHPublicKeyParameters = new DHPublicKeyParameters(this.f26865y, new DHParameters(this.dhSpec.getP(), this.dhSpec.getG(), null, this.dhSpec.getL()));
                } else {
                    this.dhSpec = new DHParameterSpec(dHParameter.getP(), dHParameter.getG());
                    dHPublicKeyParameters = new DHPublicKeyParameters(this.f26865y, new DHParameters(this.dhSpec.getP(), this.dhSpec.getG()));
                }
                ...
                if (validationParams != null) {
                    this.dhPublicKey = new DHPublicKeyParameters(this.f26865y, new DHParameters(domainParameters.getP(), domainParameters.getG(), domainParameters.getQ(), domainParameters.getJ(), new DHValidationParameters(validationParams.getSeed(), validationParams.getPgenCounter().intValue())));
                } else {
                    this.dhPublicKey = new DHPublicKeyParameters(this.f26865y, new DHParameters(domainParameters.getP(), domainParameters.getG(), domainParameters.getQ(), domainParameters.getJ(), (DHValidationParameters) null));
                }
    ...
    public BCDHPublicKey(DHPublicKeyParameters dHPublicKeyParameters) {
        this.f26865y = dHPublicKeyParameters.getY();
    ...
    public byte[] getEncoded() {
        ...
        if (!(dHParameterSpec instanceof DHDomainParameterSpec) || ((DHDomainParameterSpec) dHParameterSpec).getQ() == null) {
            return KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(PKCSObjectIdentifiers.dhKeyAgreement, new DHParameter(this.dhSpec.getP(), this.dhSpec.getG(), this.dhSpec.getL()).toASN1Primitive()), new ASN1Integer(this.f26865y));
        }
    ...
    public String toString() {
        return DHUtil.publicKeyToString("DH", this.f26865y, new DHParameters(this.dhSpec.getP(), this.dhSpec.getG()));
    }
}
