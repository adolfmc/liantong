...
public class BCDSTU4145PrivateKey implements ECPrivateKey, ECPointEncoder, org.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier {
    ...
    /* renamed from: d */
    private transient BigInteger f26871d;
    ...
    public BCDSTU4145PrivateKey(String str, ECPrivateKeyParameters eCPrivateKeyParameters) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f26871d = eCPrivateKeyParameters.getD();
        this.ecSpec = null;
    }
    ...
    public BCDSTU4145PrivateKey(ECPrivateKey eCPrivateKey) {
        this.algorithm = "DSTU4145";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f26871d = eCPrivateKey.getS();
    ...
    public BCDSTU4145PrivateKey(ECPrivateKeySpec eCPrivateKeySpec) {
        this.algorithm = "DSTU4145";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f26871d = eCPrivateKeySpec.getS();
    ...
    public BCDSTU4145PrivateKey(BCDSTU4145PrivateKey bCDSTU4145PrivateKey) {
        this.algorithm = "DSTU4145";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f26871d = bCDSTU4145PrivateKey.f26871d;
    ...
    public BCDSTU4145PrivateKey(org.bouncycastle.jce.spec.ECPrivateKeySpec eCPrivateKeySpec) {
        this.algorithm = "DSTU4145";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f26871d = eCPrivateKeySpec.getD();
    ...
    */
    public byte[] getEncoded() {
        ...
        La2:
            ...
            org.bouncycastle.asn1.ASN1ObjectIdentifier r5 = org.bouncycastle.asn1.p456ua.UAObjectIdentifiers.dstu4145be     // Catch: java.io.IOException -> Ldc
        ...
        Lc1:
            org.bouncycastle.asn1.pkcs.PrivateKeyInfo r0 = new org.bouncycastle.asn1.pkcs.PrivateKeyInfo     // Catch: java.io.IOException -> Ldc
            org.bouncycastle.asn1.x509.AlgorithmIdentifier r4 = new org.bouncycastle.asn1.x509.AlgorithmIdentifier     // Catch: java.io.IOException -> Ldc
            org.bouncycastle.asn1.ASN1ObjectIdentifier r5 = org.bouncycastle.asn1.p457x9.X9ObjectIdentifiers.id_ecPublicKey     // Catch: java.io.IOException -> Ldc
            org.bouncycastle.asn1.ASN1Primitive r1 = r1.toASN1Primitive()     // Catch: java.io.IOException -> Ldc
            r4.<init>(r5, r1)     // Catch: java.io.IOException -> Ldc
            org.bouncycastle.asn1.ASN1Primitive r1 = r3.toASN1Primitive()     // Catch: java.io.IOException -> Ldc
            r0.<init>(r4, r1)     // Catch: java.io.IOException -> Ldc
    ...
    public String toString() {
        return ECUtil.privateKeyToString(this.algorithm, this.f26871d, engineGetSpec());
    }
}
