package org.bouncycastle.jcajce.provider.asymmetric.p462ec;
 ...
 */
/* renamed from: org.bouncycastle.jcajce.provider.asymmetric.ec.IESKEMCipher */
...
public class IESKEMCipher extends BaseCipherSpi {
  ...
  E:\9227576_dexfile_execute.dex.fixout.dex
 */
    /* renamed from: org.bouncycastle.jcajce.provider.asymmetric.ec.IESKEMCipher$KEM */
    /* loaded from: E:\9227576_dexfile_execute.dex */
  ...
  E:\9227576_dexfile_execute.dex.fixout.dex
 */
    /* renamed from: org.bouncycastle.jcajce.provider.asymmetric.ec.IESKEMCipher$KEMwithSHA256 */
    /* loaded from: E:\9227576_dexfile_execute.dex */
    ...
    public byte[] engineDoFinal(byte[] bArr, int i, int i2) throws IllegalBlockSizeException, BadPaddingException {
        ...
        if (i3 == 1 || i3 == 3) {
            ...
            byte[] integerToBytes = converter.integerToBytes(this.agreement.calculateAgreement(this.key), converter.getByteLength(parameters.getCurve()));
            byte[] bArr2 = new byte[this.macKeyLength + i2];
            ...
            for (int i4 = 0; i4 != i2; i4++) {
                bArr3[i4] = (byte) (bArr[i + i4] ^ bArr2[i4]);
            }
            ...
            int i5 = fieldSize + 1;
            int i6 = i2 - (this.macLength + i5);
            int i7 = i5 + i;
            ECPoint decodePoint = curve.decodePoint(Arrays.copyOfRange(bArr, i, i7));
            this.agreement.init(this.key);
            byte[] integerToBytes2 = converter.integerToBytes(this.agreement.calculateAgreement(new ECPublicKeyParameters(decodePoint, eCPrivateKeyParameters.getParameters())), converter.getByteLength(parameters.getCurve()));
            byte[] bArr5 = new byte[this.macKeyLength + i6];
            ...
            for (int i8 = 0; i8 != bArr6.length; i8++) {
                bArr6[i8] = (byte) (bArr[i7 + i8] ^ bArr5[i8]);
            }
            KeyParameter keyParameter2 = new KeyParameter(bArr5, i6, bArr5.length - i6);
            this.hMac.init(keyParameter2);
            this.hMac.update(bArr, i7, bArr6.length);
            byte[] bArr7 = new byte[this.hMac.getMacSize()];
            this.hMac.doFinal(bArr7, 0);
            Arrays.clear(keyParameter2.getKey());
            Arrays.clear(bArr5);
            int i9 = this.macLength;
            if (Arrays.constantTimeAreEqual(i9, bArr7, 0, bArr, i + (i2 - i9))) {
                return bArr6;
            }
