 ...
 */
    ...
    /* loaded from: E:\9227576_dexfile_execute.dex */
    public static class C13265DH extends KeyAgreementSpi {
        public C13265DH() {
 ...
 */
    ...
    protected Key engineDoPhase(Key key, boolean z) throws InvalidKeyException, IllegalStateException {
        ...
        if (this.parameters == null) {
            ...
            try {
                this.result = this.agreement instanceof BasicAgreement ? bigIntToBytes(((BasicAgreement) this.agreement).calculateAgreement(generatePublicKeyParameter)) : ((ECDHCUnifiedAgreement) this.agreement).calculateAgreement(generatePublicKeyParameter);
                return null;
            } catch (Exception e) {
