 ...
 */
    ...
    private RawAgreement getAgreement(String str) throws InvalidKeyException {
        if (this.kaAlgorithm.equals("XDH") || this.kaAlgorithm.startsWith(str)) {
            return this.kaAlgorithm.indexOf(85) > 0 ? str.startsWith("X448") ? new XDHUnifiedAgreement(new X448Agreement()) : new XDHUnifiedAgreement(new X25519Agreement()) : str.startsWith("X448") ? new X448Agreement() : new X25519Agreement();
        }
    ...
    protected Key engineDoPhase(Key key, boolean z) throws InvalidKeyException, IllegalStateException {
        if (key instanceof PublicKey) {
            if (this.agreement == null) {
                ...
                this.agreement.calculateAgreement(generatePublicKeyParameter, this.result, 0);
                return null;
            }
        }
