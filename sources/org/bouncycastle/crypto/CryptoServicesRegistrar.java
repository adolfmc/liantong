...
public final class CryptoServicesRegistrar {
    ...
    private static final CryptoServicesConstraints noConstraintsImpl = new CryptoServicesConstraints() { // from class: org.bouncycastle.crypto.CryptoServicesRegistrar.2
