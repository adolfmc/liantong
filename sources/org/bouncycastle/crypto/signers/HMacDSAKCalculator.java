...
public class HMacDSAKCalculator implements DSAKCalculator {
    ...
    /* renamed from: K */
    private final byte[] f26855K;

    /* renamed from: V */
    private final byte[] f26856V;
    private final HMac hMac;

    /* renamed from: n */
    private BigInteger f26857n;

    public HMacDSAKCalculator(Digest digest) {
        this.hMac = new HMac(digest);
        this.f26856V = new byte[this.hMac.getMacSize()];
        this.f26855K = new byte[this.hMac.getMacSize()];
    }

    private BigInteger bitsToInt(byte[] bArr) {
        BigInteger bigInteger = new BigInteger(1, bArr);
        return bArr.length * 8 > this.f26857n.bitLength() ? bigInteger.shiftRight((bArr.length * 8) - this.f26857n.bitLength()) : bigInteger;
    }

    @Override // org.bouncycastle.crypto.signers.DSAKCalculator
    public void init(BigInteger bigInteger, BigInteger bigInteger2, byte[] bArr) {
        this.f26857n = bigInteger;
        Arrays.fill(this.f26856V, (byte) 1);
        Arrays.fill(this.f26855K, (byte) 0);
        ...
        this.hMac.init(new KeyParameter(this.f26855K));
        HMac hMac = this.hMac;
        byte[] bArr4 = this.f26856V;
        ...
        this.hMac.doFinal(this.f26855K, 0);
        this.hMac.init(new KeyParameter(this.f26855K));
        HMac hMac2 = this.hMac;
        byte[] bArr5 = this.f26856V;
        hMac2.update(bArr5, 0, bArr5.length);
        this.hMac.doFinal(this.f26856V, 0);
        HMac hMac3 = this.hMac;
        byte[] bArr6 = this.f26856V;
    ...
    public BigInteger nextK() {
        byte[] bArr = new byte[BigIntegers.getUnsignedByteLength(this.f26857n)];
        while (true) {
            int i = 0;
            while (i < bArr.length) {
                HMac hMac = this.hMac;
                byte[] bArr2 = this.f26856V;
                hMac.update(bArr2, 0, bArr2.length);
                this.hMac.doFinal(this.f26856V, 0);
                int min = Math.min(bArr.length - i, this.f26856V.length);
                System.arraycopy(this.f26856V, 0, bArr, i, min);
                i += min;
            }
            BigInteger bitsToInt = bitsToInt(bArr);
            if (bitsToInt.compareTo(ZERO) > 0 && bitsToInt.compareTo(this.f26857n) < 0) {
                return bitsToInt;
            }
            HMac hMac2 = this.hMac;
            byte[] bArr3 = this.f26856V;
