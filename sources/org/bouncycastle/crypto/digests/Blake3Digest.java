...
public class Blake3Digest implements ExtendedDigest, Xof, Memoable {
    ...
    /* renamed from: IV */
    private static final int[] f26414IV = {1779033703, -1150833019, 1013904242, -1521486534, 1359893119, -1694144372, 528734635, 1541459225};
    ...
    private void initChunkBlock(int i, boolean z) {
        ...
        System.arraycopy(f26414IV, 0, this.theV, 8, 4);
        int[] iArr = this.theV;
        long j = this.theCounter;
        iArr[12] = (int) j;
        iArr[13] = (int) (j >> 32);
        iArr[14] = i;
        iArr[15] = this.theMode + (this.theCurrBytes == 0 ? 1 : 0) + (z ? 2 : 0);
        this.theCurrBytes += i;
    ...
    private void initNullKey() {
        System.arraycopy(f26414IV, 0, this.theK, 0, 8);
    }
