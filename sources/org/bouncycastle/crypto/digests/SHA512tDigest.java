...
public class SHA512tDigest extends LongDigest {
    ...
    */
    ...
    public int doFinal(byte[] bArr, int i) {
        finish();
        longToBigEndian(this.f26444H1, bArr, i, this.digestLength);
        longToBigEndian(this.f26445H2, bArr, i + 8, this.digestLength - 8);
        longToBigEndian(this.f26446H3, bArr, i + 16, this.digestLength - 16);
        longToBigEndian(this.f26447H4, bArr, i + 24, this.digestLength - 24);
        longToBigEndian(this.f26448H5, bArr, i + 32, this.digestLength - 32);
        longToBigEndian(this.f26449H6, bArr, i + 40, this.digestLength - 40);
        longToBigEndian(this.f26450H7, bArr, i + 48, this.digestLength - 48);
        longToBigEndian(this.f26451H8, bArr, i + 56, this.digestLength - 56);
        reset();
    ...
    public byte[] getEncodedState() {
        ...
        byte[] bArr = new byte[encodedStateSize + 4 + 1];
        populateState(bArr);
    ...
    public void reset() {
        super.reset();
        this.f26444H1 = this.H1t;
        this.f26445H2 = this.H2t;
        this.f26446H3 = this.H3t;
        this.f26447H4 = this.H4t;
        this.f26448H5 = this.H5t;
        this.f26449H6 = this.H6t;
        this.f26450H7 = this.H7t;
        this.f26451H8 = this.H8t;
    }
