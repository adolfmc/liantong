...
public class JPAKEParticipant {
    ...
    /* renamed from: b */
    private BigInteger f26369b;
    private final Digest digest;

    /* renamed from: g */
    private final BigInteger f26370g;
    ...
    /* renamed from: p */
    private final BigInteger f26371p;
    private final String participantId;
    private String partnerParticipantId;
    private char[] password;

    /* renamed from: q */
    private final BigInteger f26372q;
    private final SecureRandom random;
    private int state;

    /* renamed from: x1 */
    private BigInteger f26373x1;

    /* renamed from: x2 */
    private BigInteger f26374x2;
    ...
    public JPAKEParticipant(String str, char[] cArr, JPAKEPrimeOrderGroup jPAKEPrimeOrderGroup, Digest digest, SecureRandom secureRandom) {
        ...
        this.f26371p = jPAKEPrimeOrderGroup.getP();
        this.f26372q = jPAKEPrimeOrderGroup.getQ();
        this.f26370g = jPAKEPrimeOrderGroup.getG();
        this.digest = digest;
    ...
    public BigInteger calculateKeyingMaterial() {
        ...
        if (i >= 50) {
            ...
            this.password = null;
            BigInteger calculateKeyingMaterial = JPAKEUtil.calculateKeyingMaterial(this.f26371p, this.f26372q, this.gx4, this.f26374x2, calculateS, this.f26369b);
            this.f26373x1 = null;
            this.f26374x2 = null;
            this.f26369b = null;
            this.state = 50;
    ...
    public JPAKERound1Payload createRound1PayloadToSend() {
        ...
        this.f26373x1 = JPAKEUtil.generateX1(this.f26372q, this.random);
        this.f26374x2 = JPAKEUtil.generateX2(this.f26372q, this.random);
        this.gx1 = JPAKEUtil.calculateGx(this.f26371p, this.f26370g, this.f26373x1);
        this.gx2 = JPAKEUtil.calculateGx(this.f26371p, this.f26370g, this.f26374x2);
        BigInteger[] calculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f26371p, this.f26372q, this.f26370g, this.gx1, this.f26373x1, this.participantId, this.digest, this.random);
        BigInteger[] calculateZeroKnowledgeProof2 = JPAKEUtil.calculateZeroKnowledgeProof(this.f26371p, this.f26372q, this.f26370g, this.gx2, this.f26374x2, this.participantId, this.digest, this.random);
        this.state = 10;
    ...
    public JPAKERound2Payload createRound2PayloadToSend() {
        ...
        if (i >= 30) {
            ...
            BigInteger calculateGA = JPAKEUtil.calculateGA(this.f26371p, this.gx1, this.gx3, this.gx4);
            BigInteger calculateX2s = JPAKEUtil.calculateX2s(this.f26372q, this.f26374x2, JPAKEUtil.calculateS(this.password));
            BigInteger calculateA = JPAKEUtil.calculateA(this.f26371p, this.f26372q, calculateGA, calculateX2s);
            BigInteger[] calculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f26371p, this.f26372q, calculateGA, calculateA, calculateX2s, this.participantId, this.digest, this.random);
            this.state = 30;
    ...
    public void validateRound1PayloadReceived(JPAKERound1Payload jPAKERound1Payload) throws CryptoException {
        ...
        JPAKEUtil.validateZeroKnowledgeProof(this.f26371p, this.f26372q, this.f26370g, this.gx3, knowledgeProofForX1, jPAKERound1Payload.getParticipantId(), this.digest);
        JPAKEUtil.validateZeroKnowledgeProof(this.f26371p, this.f26372q, this.f26370g, this.gx4, knowledgeProofForX2, jPAKERound1Payload.getParticipantId(), this.digest);
        this.state = 20;
    }
    ...
    public void validateRound2PayloadReceived(JPAKERound2Payload jPAKERound2Payload) throws CryptoException {
        ...
        if (i >= 40) {
            ...
            BigInteger calculateGA = JPAKEUtil.calculateGA(this.f26371p, this.gx3, this.gx1, this.gx2);
            this.f26369b = jPAKERound2Payload.getA();
            ...
            JPAKEUtil.validateZeroKnowledgeProof(this.f26371p, this.f26372q, calculateGA, this.f26369b, knowledgeProofForX2s, jPAKERound2Payload.getParticipantId(), this.digest);
            this.state = 40;
        }
    }
