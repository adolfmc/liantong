...
public class PKCS12ParametersGenerator extends PBEParametersGenerator {
    ...
    public PKCS12ParametersGenerator(Digest digest) {
        ...
        if (digest instanceof ExtendedDigest) {
            this.f26683u = digest.getDigestSize();
            this.f26684v = ((ExtendedDigest) digest).getByteLength();
            return;
        }
    ...
    private byte[] generateDerivedKey(int i, int i2) {
        byte[] bArr;
        byte[] bArr2;
        byte[] bArr3 = new byte[this.f26684v];
        ...
        byte[] bArr6 = new byte[this.f26684v];
        int i10 = this.f26683u;
        ...
        for (int i12 = 1; i12 <= i11; i12++) {
            ...
            if (i12 == i11) {
                int i17 = i12 - 1;
                int i18 = this.f26683u;
                System.arraycopy(bArr7, 0, bArr4, i17 * i18, bArr4.length - (i17 * i18));
            } else {
                System.arraycopy(bArr7, 0, bArr4, (i12 - 1) * this.f26683u, bArr7.length);
            }
        }
        return bArr4;
    }
