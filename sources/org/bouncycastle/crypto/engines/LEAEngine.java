...
public class LEAEngine implements BlockCipher {
    ...
    private void generate256RoundKeys(int[] iArr) {
        ...
        for (int i2 = 0; i2 < this.theRounds; i2++) {
            ...
            int i3 = i & 7;
            iArr2[0] = rol32(iArr[i3] + rol32, 1);
            int i4 = i + 1;
            iArr[i3] = iArr2[0];
            int i5 = i4 & 7;
            iArr2[1] = rol32(iArr[i5] + rol32(rol32, 1), 3);
            int i6 = i4 + 1;
            iArr[i5] = iArr2[1];
            int i7 = i6 & 7;
            iArr2[2] = rol32(iArr[i7] + rol32(rol32, 2), 6);
            int i8 = i6 + 1;
            iArr[i7] = iArr2[2];
            int i9 = i8 & 7;
            iArr2[3] = rol32(iArr[i9] + rol32(rol32, 3), 11);
            int i10 = i8 + 1;
            iArr[i9] = iArr2[3];
            int i11 = i10 & 7;
            iArr2[4] = rol32(iArr[i11] + rol32(rol32, 4), 13);
            int i12 = i10 + 1;
            iArr[i11] = iArr2[4];
            int i13 = i12 & 7;
            iArr2[5] = rol32(iArr[i13] + rol32(rol32, 5), 17);
            i = i12 + 1;
            iArr[i13] = iArr2[5];
        }
    }
    ...
    private void generateRoundKeys(byte[] bArr) {
        ...
        this.theRoundKeys = (int[][]) Array.newInstance(int.class, this.theRounds, 6);
