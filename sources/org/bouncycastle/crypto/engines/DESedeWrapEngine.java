...
public class DESedeWrapEngine implements Wrapper {
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (cipherParameters2 instanceof KeyParameter) {
            ...
            if (this.forWrapping) {
                this.f26600iv = new byte[8];
                secureRandom.nextBytes(this.f26600iv);
                this.paramPlusIV = new ParametersWithIV(this.param, this.f26600iv);
            }
        } else if (cipherParameters2 instanceof ParametersWithIV) {
            this.paramPlusIV = (ParametersWithIV) cipherParameters2;
            this.f26600iv = this.paramPlusIV.getIV();
            this.param = (KeyParameter) this.paramPlusIV.getParameters();
            if (!this.forWrapping) {
                throw new IllegalArgumentException("You should not supply an IV for unwrapping");
            }
            byte[] bArr = this.f26600iv;
    ...
    public byte[] unwrap(byte[] bArr, int i, int i2) throws InvalidCipherTextException {
        ...
        if (bArr != null) {
            ...
            System.arraycopy(reverse, 0, this.f26600iv, 0, 8);
    ...
    public byte[] wrap(byte[] bArr, int i, int i2) {
        if (this.forWrapping) {
            ...
            if (bArr3.length % blockSize == 0) {
                ...
                byte[] bArr5 = this.f26600iv;
                byte[] bArr6 = new byte[bArr5.length + bArr4.length];
                System.arraycopy(bArr5, 0, bArr6, 0, bArr5.length);
                System.arraycopy(bArr4, 0, bArr6, this.f26600iv.length, bArr4.length);
