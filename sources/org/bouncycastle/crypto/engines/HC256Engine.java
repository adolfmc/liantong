...
public class HC256Engine implements StreamCipher {
    ...
    /* renamed from: iv */
    private byte[] f26618iv;
    private byte[] key;

    /* renamed from: p */
    private int[] f26619p = new int[1024];

    /* renamed from: q */
    private int[] f26620q = new int[1024];
    private int cnt = 0;
    ...
    private void init() {
        ...
        byte[] bArr5 = this.f26618iv;
        if (bArr5.length < 32) {
            byte[] bArr6 = new byte[32];
            System.arraycopy(bArr5, 0, bArr6, 0, bArr5.length);
            byte[] bArr7 = this.f26618iv;
        ...
        for (int i3 = 0; i3 < 32; i3++) {
            int i4 = (i3 >> 2) + 8;
            iArr[i4] = iArr[i4] | ((this.f26618iv[i3] & 255) << ((i3 & 3) * 8));
        }
        ...
        System.arraycopy(iArr, 512, this.f26619p, 0, 1024);
        System.arraycopy(iArr, MediaRecorderBase.VIDEO_BITRATE_MEDIUM, this.f26620q, 0, 1024);
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (cipherParameters instanceof ParametersWithIV) {
            ...
            this.f26618iv = parametersWithIV.getIV();
            cipherParameters2 = parametersWithIV.getParameters();
        } else {
            this.f26618iv = new byte[0];
