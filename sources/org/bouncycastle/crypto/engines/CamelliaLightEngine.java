...
public class CamelliaLightEngine implements BlockCipher {
    ...
    private static final byte[] SBOX1 = {112, -126, 44, -20, -77, 39, -64, -27, -28, -123, 87, 53, -22, 12, -82, 65, 35, -17, 107, -109, 69, 25, -91, 33, -19, 14, 79, 78, 29, 101, -110, -67, -122, -72, -81, -113, 124, -21, 31, -50, 62, 48, -36, 95, 94, -59, 11, 26, -90, -31, 57, -54, -43, 71, 93, 61, -39, 1, 90, -42, 81, 86, 108, 77, -117, 13, -102, 102, -5, -52, -80, 45, 116, 18, 43, 32, -16, -79, -124, -103, -33, 76, -53, -62, 52, 126, 118, 5, 109, -73, -87, 49, -47, 23, 4, -41, 20, 88, 58, 97, -34, 27, 17, 28, 50, 15, -100, 22, 83, 24, -14, 34, -2, 68, -49, -78, -61, -75, 122, -111, 36, 8, -24, -88, 96, -4, 105, 80, -86, -48, -96, 125, -95, -119, 98, -105, 84, 91, 30, -107, -32, -1, 100, -46, 16, -60, 0, 72, -93, -9, 117, -37, -118, 3, -26, -38, 9, 63, -35, -108, -121, C0548c.f1785i, -125, 2, -51, 74, -112, 51, 115, 103, -10, -13, -99, Byte.MAX_VALUE, -65, -30, 82, -101, -40, 38, -56, 55, -58, 59, -127, -106, 111, 75, 19, -66, 99, 46, -23, 121, -89, -116, -97, 110, -68, -114, 41, -11, -7, -74, 47, -3, -76, 89, 120, -104, 6, 106, -25, 70, 113, -70, -44, 37, -85, 66, -120, -94, -115, -6, 114, 7, -71, 85, -8, -18, -84, 10, C0548c.f1784h, 73, 42, 104, 60, 56, -15, -92, 64, 40, -45, 123, -69, -55, 67, -63, 21, -29, -83, -12, 119, -57, Byte.MIN_VALUE, -98};
    private boolean initialized = false;
    private int[] subkey = new int[96];

    /* renamed from: kw */
    private int[] f26595kw = new int[8];

    /* renamed from: ke */
    private int[] f26594ke = new int[12];
    ...
    private int processBlock192or256(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        camelliaF2(iArr, this.subkey, 28);
        camelliaF2(iArr, this.subkey, 32);
        camelliaFLs(iArr, this.f26594ke, 8);
    ...
    private void setKey(boolean z, byte[] bArr) {
        ...
        if (this._keySize == 16) {
            if (z) {
                ...
                iArr6[18] = iArr4[2];
                iArr6[19] = iArr4[3];
                roldq(17, iArr, 0, this.f26594ke, 4);
                ...
                roldq(15, iArr2, 0, this.f26594ke, 0);
                ...
                roldq(17, iArr2, 0, this.f26595kw, 4);
                return;
            }
            int[] iArr9 = this.f26595kw;
            iArr9[4] = iArr[0];
            iArr9[5] = iArr[1];
            iArr9[6] = iArr[2];
            iArr9[7] = iArr[3];
            ...
            iArr10[16] = iArr4[0];
            iArr10[17] = iArr4[1];
            decroldq(17, iArr, 0, this.f26594ke, 0);
            ...
            decroldq(15, iArr2, 0, this.f26594ke, 4);
            ...
            roldq(17, iArr2, 0, this.f26595kw, 0);
            return;
        }
        for (int i3 = 0; i3 < 4; i3++) {
        ...
        roldqo32(51, iArr3, 0, this.f26595kw, 0);
    }
