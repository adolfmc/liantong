...
public class NoekeonEngine implements BlockCipher {
    ...
    private static final byte[] roundConstants = {Byte.MIN_VALUE, 27, C0548c.f1784h, 108, -40, -85, 77, -102, 47, 94, -68, 99, -58, -105, 53, 106, -44};
    private boolean _forEncryption;

    /* renamed from: k */
    private final int[] f26626k = new int[4];
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        Pack.bigEndianToInt(key, 0, this.f26626k, 0, 4);
        if (!z) {
            int[] iArr = this.f26626k;
            int i = iArr[0];
            int i2 = iArr[1];
