 ...
 */
    ...
    private byte[] decryptBlock(byte[] bArr, int i, int i2) throws InvalidCipherTextException {
        ...
        byte[] bArr3;
        int processBytes;
        if (i2 >= this.f26611V.length + this.mac.getMacSize()) {
            if (this.cipher == null) {
                byte[] bArr4 = new byte[(i2 - this.f26611V.length) - this.mac.getMacSize()];
                ...
                for (int i3 = 0; i3 != bArr4.length; i3++) {
                    bArr6[i3] = (byte) (bArr[(this.f26611V.length + i) + i3] ^ bArr4[i3]);
                }
                bArr3 = bArr6;
                processBytes = 0;
            } else {
            ...
            Mac mac = this.mac;
            byte[] bArr13 = this.f26610IV;
            mac.update(bArr13, 0, bArr13.length);
            Mac mac2 = this.mac;
            byte[] bArr14 = this.f26611V;
    ...
    private byte[] encryptBlock(byte[] bArr, int i, int i2) throws InvalidCipherTextException {
        ...
        if (this.cipher == null) {
            ...
            System.arraycopy(bArr8, 0, bArr7, 0, bArr7.length);
            System.arraycopy(bArr8, bArr7.length, bArr2, 0, bArr2.length);
            if (this.f26610IV != null) {
                bufferedBlockCipher = this.cipher;
                keyParameter = new ParametersWithIV(new KeyParameter(bArr7), this.f26610IV);
            } else {
                bufferedBlockCipher = this.cipher;
        ...
        byte[] bArr13 = this.f26611V;
        byte[] bArr14 = new byte[bArr13.length + i2 + bArr9.length];
        System.arraycopy(bArr13, 0, bArr14, 0, bArr13.length);
        System.arraycopy(bArr3, 0, bArr14, this.f26611V.length, i2);
        System.arraycopy(bArr9, 0, bArr14, this.f26611V.length + i2, bArr9.length);
        return bArr14;
    }
    ...
    private void extractParams(CipherParameters cipherParameters) {
        if (cipherParameters instanceof ParametersWithIV) {
            ...
            this.f26610IV = parametersWithIV.getIV();
    ...
    */
    public byte[] processBlock(byte[] r5, int r6, int r7) throws org.bouncycastle.crypto.InvalidCipherTextException {
        ...
        Lba:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.crypto.engines.EthereumIESEngine.processBlock(byte[], int, int):byte[]");
    }
}
