...
public class CamelliaEngine implements BlockCipher {
    ...
    /* renamed from: kw */
    private int[] f26593kw = new int[8];

    /* renamed from: ke */
    private int[] f26592ke = new int[12];
    ...
    private int processBlock192or256(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        camelliaF2(iArr, this.subkey, 28);
        camelliaF2(iArr, this.subkey, 32);
        camelliaFLs(iArr, this.f26592ke, 8);
    ...
    private void setKey(boolean z, byte[] bArr) {
        ...
        if (this._keySize == 16) {
            if (z) {
                ...
                iArr6[18] = iArr4[2];
                iArr6[19] = iArr4[3];
                roldq(17, iArr, 0, this.f26592ke, 4);
                ...
                roldq(15, iArr2, 0, this.f26592ke, 0);
                ...
                roldq(17, iArr2, 0, this.f26593kw, 4);
                return;
            }
            int[] iArr9 = this.f26593kw;
            iArr9[4] = iArr[0];
            iArr9[5] = iArr[1];
            iArr9[6] = iArr[2];
            iArr9[7] = iArr[3];
            ...
            iArr10[16] = iArr4[0];
            iArr10[17] = iArr4[1];
            decroldq(17, iArr, 0, this.f26592ke, 0);
            ...
            decroldq(15, iArr2, 0, this.f26592ke, 4);
            ...
            roldq(17, iArr2, 0, this.f26593kw, 0);
            return;
        }
        for (int i3 = 0; i3 < 4; i3++) {
        ...
        roldqo32(51, iArr3, 0, this.f26593kw, 0);
    }
