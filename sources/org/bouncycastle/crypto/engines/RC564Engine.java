...
public class RC564Engine implements BlockCipher {
    ...
    private int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        for (int i3 = this._noRounds; i3 >= 1; i3--) {
            int i4 = i3 * 2;
            bytesToWord2 = rotateRight(bytesToWord2 - this.f26632_S[i4 + 1], bytesToWord) ^ bytesToWord;
            bytesToWord = rotateRight(bytesToWord - this.f26632_S[i4], bytesToWord2) ^ bytesToWord2;
        }
        wordToBytes(bytesToWord - this.f26632_S[0], bArr2, i2);
        wordToBytes(bytesToWord2 - this.f26632_S[1], bArr2, i2 + 8);
        return 16;
    }

    private int encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        long bytesToWord = bytesToWord(bArr, i) + this.f26632_S[0];
        long bytesToWord2 = bytesToWord(bArr, i + 8) + this.f26632_S[1];
        for (int i3 = 1; i3 <= this._noRounds; i3++) {
            int i4 = i3 * 2;
            bytesToWord = rotateLeft(bytesToWord ^ bytesToWord2, bytesToWord2) + this.f26632_S[i4];
            bytesToWord2 = rotateLeft(bytesToWord2 ^ bytesToWord, bytesToWord) + this.f26632_S[i4 + 1];
        }
    ...
    private void setKey(byte[] bArr) {
        ...
        this.f26632_S = new long[(this._noRounds + 1) * 2];
        this.f26632_S[0] = -5196783011329398165L;
        int i3 = 1;
        while (true) {
            jArr = this.f26632_S;
            if (i3 >= jArr.length) {
