...
public class DSTU7624WrapEngine implements Wrapper {
    ...
    public DSTU7624WrapEngine(int i) {
        ...
        this.f26609B = new byte[this.engine.getBlockSize() / 2];
    ...
    public byte[] wrap(byte[] bArr, int i, int i2) {
        if (this.forWrapping) {
            if (i2 % this.engine.getBlockSize() != 0) {
                ...
                System.arraycopy(bArr, i, bArr2, 0, i2);
                System.arraycopy(bArr2, 0, this.f26609B, 0, this.engine.getBlockSize() / 2);
                this.Btemp.clear();
                int length = bArr2.length - (this.engine.getBlockSize() / 2);
                int blockSize2 = this.engine.getBlockSize() / 2;
                while (length != 0) {
                ...
                int i5 = 0;
                while (i5 < i4) {
                    System.arraycopy(this.f26609B, 0, bArr2, 0, this.engine.getBlockSize() / 2);
                    ...
                    System.arraycopy(bArr2, this.engine.getBlockSize() / 2, this.f26609B, 0, this.engine.getBlockSize() / 2);
                    for (int i7 = 2; i7 < blockSize; i7++) {
