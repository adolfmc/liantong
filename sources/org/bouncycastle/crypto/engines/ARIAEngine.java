...
public class ARIAEngine implements BlockCipher {
    ...
    /* renamed from: C */
    private static final byte[][] f26577C = {Hex.decodeStrict("517cc1b727220a94fe13abe8fa9a6ee0"), Hex.decodeStrict("6db14acc9e21c820ff28b1d5ef5de2b0"), Hex.decodeStrict("db92371d2126e9700324977504e8c90e")};
    ...
    /* renamed from: A */
    protected static void m307A(byte[] bArr) {
        byte b = bArr[0];
        byte b2 = bArr[1];
        byte b3 = bArr[2];
        byte b4 = bArr[3];
    ...
    /* renamed from: FE */
    protected static void m306FE(byte[] bArr, byte[] bArr2) {
        xor(bArr, bArr2);
        SL2(bArr);
        m307A(bArr);
    }
    ...
    /* renamed from: FO */
    protected static void m305FO(byte[] bArr, byte[] bArr2) {
        xor(bArr, bArr2);
        SL1(bArr);
        m307A(bArr);
    }
        ...
        if (this.roundKeys != null) {
            if (i <= bArr.length - 16) {
                if (i2 <= bArr2.length - 16) {
                    ...
                    while (i3 < length) {
                        int i4 = i3 + 1;
                        m305FO(bArr3, this.roundKeys[i3]);
                        m306FE(bArr3, this.roundKeys[i4]);
                        i3 = i4 + 1;
                    }
                    int i5 = i3 + 1;
                    m305FO(bArr3, this.roundKeys[i3]);
