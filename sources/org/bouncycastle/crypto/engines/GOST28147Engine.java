...
public class GOST28147Engine implements BlockCipher {
    ...
    /* renamed from: S */
    private byte[] f26613S = Sbox_Default;
        ...
        if (this.forEncryption) {
            ...
            while (i14 < 3) {
                ...
                while (i19 >= 0 && (i14 != 2 || i19 != 0)) {
                    int GOST28147_mainStep2 = i17 ^ GOST28147_mainStep(i18, iArr[i19]);
                    i19--;
                    i17 = i18;
                    i18 = GOST28147_mainStep2;
                }
                i14++;
                i3 = i18;
                i16 = i17;
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (cipherParameters instanceof ParametersWithSBox) {
            ...
            this.f26613S = Arrays.clone(sBox);
            if (parametersWithSBox.getParameters() != null) {
                keyParameter = (KeyParameter) parametersWithSBox.getParameters();
