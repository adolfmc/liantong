 ...
 */
    ...
    public class GCMSIVHasher {
        ...
        void updateHash(byte[] bArr, int i, int i2) {
            ...
            if (i5 <= 0 || i2 < i6) {
                ...
                System.arraycopy(bArr, i, this.theBuffer, i5, i6);
            ...
            if (i3 > 0) {
                System.arraycopy(bArr, i + i4, this.theBuffer, this.numActive, i3);
                this.numActive += i3;
            }
            this.numHashed += i2;
        }
    ...
    private void checkAEADStatus(int i) {
        ...
        if (this.theAEADHasher.getBytesProcessed() - Long.MIN_VALUE > (2147483623 - i) - Long.MIN_VALUE) {
