            ...
            if (this.forEncryption) {
                ...
                if (this.bufOff > blockSize) {
                    ...
                    if (i3 == 2 || i3 == 3) {
                        ...
                        System.arraycopy(this.buf, 0, bArr3, 0, blockSize);
                        ...
                        this.cipher.processBlock(bArr2, 0, bArr2, 0);
                        System.arraycopy(bArr2, 0, bArr, i + i2, blockSize);
                    }
                }
                this.cipher.processBlock(this.buf, 0, bArr3, 0);
                System.arraycopy(bArr3, 0, bArr, i, blockSize);
                ...
                if (this.bufOff > blockSize) {
                    ...
                    if (i4 == 3 || (i4 == 2 && (this.buf.length - this.bufOff) % blockSize != 0)) {
                        ...
                        for (int i5 = blockSize; i5 != this.bufOff; i5++) {
                            int i6 = i5 - blockSize;
                            bArr2[i6] = (byte) (bArr3[i6] ^ this.buf[i5]);
                        }
                        System.arraycopy(this.buf, blockSize, bArr3, 0, i2);
                        this.cipher.processBlock(bArr3, 0, bArr, i);
                    } else {
                        ((CBCBlockCipher) this.cipher).getUnderlyingCipher().processBlock(this.buf, this.bufOff - blockSize, bArr2, 0);
                        System.arraycopy(this.buf, 0, bArr3, 0, blockSize);
                        if (i2 != blockSize) {
                            System.arraycopy(bArr2, i2, bArr3, i2, blockSize - i2);
                        }
                        this.cipher.processBlock(bArr3, 0, bArr3, 0);
                        System.arraycopy(bArr3, 0, bArr, i, blockSize);
                        for (int i7 = 0; i7 != i2; i7++) {
                            bArr2[i7] = (byte) (bArr2[i7] ^ this.buf[i7]);
                        }
                    }
                    System.arraycopy(bArr2, 0, bArr, i + blockSize, i2);
                }
