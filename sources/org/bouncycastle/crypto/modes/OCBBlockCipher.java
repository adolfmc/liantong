...
public class OCBBlockCipher implements AEADBlockCipher {
    ...
    protected byte[] getLSub(int i) {
        while (i >= this.f26751L.size()) {
            Vector vector = this.f26751L;
            vector.addElement(OCB_double((byte[]) vector.lastElement()));
        }
        return (byte[]) this.f26751L.elementAt(i);
    }
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        this.f26751L = new Vector();
        this.f26751L.addElement(OCB_double(this.L_Dollar));
        ...
        if (i == 0) {
            ...
            for (int i4 = 0; i4 < 16; i4++) {
                ...
                i3++;
                this.OffsetMAIN_0[i4] = (byte) (((bArr2[i3] & 255) >>> (8 - i)) | ((bArr2[i3] & 255) << i));
            }
        }
        this.hashBlockPos = 0;
        this.mainBlockPos = 0;
