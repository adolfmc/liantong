...
public class OpenPGPCFBBlockCipher implements BlockCipher {
    ...
    /* renamed from: FR */
    private byte[] f26753FR;
    private byte[] FRE;

    /* renamed from: IV */
    private byte[] f26754IV;
    ...
    public OpenPGPCFBBlockCipher(BlockCipher blockCipher) {
        ...
        this.f26754IV = new byte[i];
        this.f26753FR = new byte[i];
        this.FRE = new byte[i];
    }
    ...
    private int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) throws DataLengthException, IllegalStateException {
        ...
        if (i + i4 <= bArr.length) {
            if (i2 + i4 <= bArr2.length) {
                ...
                if (i5 > i4) {
                    byte b = bArr[i];
                    this.f26753FR[i4 - 2] = b;
                    bArr2[i2] = encryptByte(b, i4 - 2);
                    byte b2 = bArr[i + 1];
                    byte[] bArr3 = this.f26753FR;
                    int i8 = this.blockSize;
                    bArr3[i8 - 1] = b2;
                    bArr2[i2 + 1] = encryptByte(b2, i8 - 1);
                    this.cipher.processBlock(this.f26753FR, 0, this.FRE, 0);
                ...
                if (i5 > i4) {
                    ...
                    if (i5 != 0) {
                        if (i5 == i4) {
                            ...
                            byte[] bArr6 = this.f26753FR;
                            System.arraycopy(bArr6, 2, bArr6, 0, this.blockSize - 2);
                            System.arraycopy(bArr2, i2, this.f26753FR, this.blockSize - 2, 2);
                            this.cipher.processBlock(this.f26753FR, 0, this.FRE, 0);
                            while (true) {
                                i3 = this.blockSize;
                                if (i6 >= i3) {
    ...
    public void reset() {
        this.count = 0;
        byte[] bArr = this.f26754IV;
        byte[] bArr2 = this.f26753FR;
