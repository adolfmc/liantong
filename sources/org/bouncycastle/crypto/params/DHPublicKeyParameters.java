...
public class DHPublicKeyParameters extends DHKeyParameters {
    ...
    /* renamed from: y */
    private BigInteger f26793y;

    public DHPublicKeyParameters(BigInteger bigInteger, DHParameters dHParameters) {
        super(false, dHParameters);
        this.f26793y = validate(bigInteger, dHParameters);
    }
    ...
    public boolean equals(Object obj) {
        return (obj instanceof DHPublicKeyParameters) && ((DHPublicKeyParameters) obj).getY().equals(this.f26793y) && super.equals(obj);
    }
    ...
    @Override // org.bouncycastle.crypto.params.DHKeyParameters
    public int hashCode() {
        return this.f26793y.hashCode() ^ super.hashCode();
    }
}
