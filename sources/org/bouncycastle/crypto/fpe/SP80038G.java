...
class SP80038G {
    ...
    static short[] decFF1(BlockCipher blockCipher, RadixConverter radixConverter, byte[] bArr, int i, int i2, int i3, short[] sArr, short[] sArr2) {
        ...
        while (i6 >= 0) {
            ...
            short[] sArr6 = sArr3;
            int i8 = i - i5;
            radixConverter.toEncoding(radixConverter.fromEncoding(sArr5).subtract(calculateY_FF1(blockCipher, bArr, ceil, i4, i6, calculateP_FF1, sArr3, radixConverter)).mod(calculateModUV[i6 & 1]), i8, sArr5);
            i6--;
            i5 = i8;
            sArr3 = sArr5;
            sArr4 = sArr6;
    ...
    private static short[] encFF1(BlockCipher blockCipher, RadixConverter radixConverter, byte[] bArr, int i, int i2, int i3, short[] sArr, short[] sArr2) {
        ...
        while (i5 < 10) {
            short[] sArr5 = sArr3;
            int i7 = i - i6;
            radixConverter.toEncoding(radixConverter.fromEncoding(sArr5).add(calculateY_FF1(blockCipher, bArr, ceil, i4, i5, calculateP_FF1, sArr4, radixConverter)).mod(calculateModUV[i5 & 1]), i7, sArr5);
            i5++;
            sArr3 = sArr4;
            i6 = i7;
            sArr4 = sArr5;
