...
public class ScalarSplitParameters {
    ...
    /* renamed from: g1 */
    protected final BigInteger f27034g1;

    /* renamed from: g2 */
    protected final BigInteger f27035g2;
    ...
    public ScalarSplitParameters(BigInteger[] bigIntegerArr, BigInteger[] bigIntegerArr2, BigInteger bigInteger, BigInteger bigInteger2, int i) {
        ...
        this.f27034g1 = bigInteger;
        this.f27035g2 = bigInteger2;
        this.bits = i;
    }
    ...
    public BigInteger getG1() {
        return this.f27034g1;
    }

    public BigInteger getG2() {
        return this.f27035g2;
    }
