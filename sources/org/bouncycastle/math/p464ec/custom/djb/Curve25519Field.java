...
public class Curve25519Field {
    ...
    /* renamed from: M */
    private static final long f26955M = 4294967295L;

    /* renamed from: P7 */
    private static final int f26957P7 = Integer.MAX_VALUE;
    private static final int PInv = 19;

    /* renamed from: P */
    static final int[] f26956P = {-19, -1, -1, -1, -1, -1, -1, Integer.MAX_VALUE};
    private static final int[] PExt = {361, 0, 0, 0, 0, 0, 0, 0, -19, -1, -1, -1, -1, -1, -1, 1073741823};

    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        Nat256.add(iArr, iArr2, iArr3);
        if (Nat256.gte(iArr3, f26956P)) {
            subPFrom(iArr3);
        }
    }
    ...
    public static int[] fromBigInteger(BigInteger bigInteger) {
        ...
        while (Nat256.gte(fromBigInteger, f26956P)) {
            Nat256.subFrom(f26956P, fromBigInteger);
        }
    ...
    public static void half(int[] iArr, int[] iArr2) {
        ...
        Nat256.add(iArr, f26956P, iArr2);
        Nat.shiftDownBit(8, iArr2, 0);
    }

    public static void inv(int[] iArr, int[] iArr2) {
        Mod.checkedModOddInverse(f26956P, iArr, iArr2);
    }
    ...
    public static void random(SecureRandom secureRandom, int[] iArr) {
        ...
        } while (Nat.lessThan(8, iArr, f26956P) == 0);
    }
