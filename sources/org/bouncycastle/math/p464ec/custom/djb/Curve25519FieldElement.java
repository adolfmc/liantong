...
public class Curve25519FieldElement extends ECFieldElement.AbstractFp {
    ...
    /* renamed from: x */
    protected int[] f26959x;

    /* renamed from: Q */
    public static final BigInteger f26958Q = Nat256.toBigInteger(Curve25519Field.f26956P);
    ...
    public Curve25519FieldElement() {
        this.f26959x = Nat256.create();
    }

    public Curve25519FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f26958Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for Curve25519FieldElement");
        }
        this.f26959x = Curve25519Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        Curve25519Field.add(this.f26959x, ((Curve25519FieldElement) eCFieldElement).f26959x, create);
    ...
    public ECFieldElement addOne() {
        int[] create = Nat256.create();
        Curve25519Field.addOne(this.f26959x, create);
        return new Curve25519FieldElement(create);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        Curve25519Field.inv(((Curve25519FieldElement) eCFieldElement).f26959x, create);
        Curve25519Field.multiply(create, this.f26959x, create);
        return new Curve25519FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Curve25519FieldElement) {
            return Nat256.m255eq(this.f26959x, ((Curve25519FieldElement) obj).f26959x);
        }
        return false;
    }
    ...
    public int getFieldSize() {
        return f26958Q.bitLength();
    }

    public int hashCode() {
        return f26958Q.hashCode() ^ Arrays.hashCode(this.f26959x, 0, 8);
    }

    @Override // org.bouncycastle.math.p464ec.ECFieldElement
    public ECFieldElement invert() {
        int[] create = Nat256.create();
        Curve25519Field.inv(this.f26959x, create);
        return new Curve25519FieldElement(create);
    }

    @Override // org.bouncycastle.math.p464ec.ECFieldElement
    public boolean isOne() {
        return Nat256.isOne(this.f26959x);
    }

    @Override // org.bouncycastle.math.p464ec.ECFieldElement
    public boolean isZero() {
        return Nat256.isZero(this.f26959x);
    }

    @Override // org.bouncycastle.math.p464ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        Curve25519Field.multiply(this.f26959x, ((Curve25519FieldElement) eCFieldElement).f26959x, create);
        return new Curve25519FieldElement(create);
    }
    ...
    public ECFieldElement negate() {
        int[] create = Nat256.create();
        Curve25519Field.negate(this.f26959x, create);
        return new Curve25519FieldElement(create);
    }

    @Override // org.bouncycastle.math.p464ec.ECFieldElement
    public ECFieldElement sqrt() {
        int[] iArr = this.f26959x;
    ...
    public ECFieldElement square() {
        int[] create = Nat256.create();
        Curve25519Field.square(this.f26959x, create);
        return new Curve25519FieldElement(create);
    }
    ...
    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        Curve25519Field.subtract(this.f26959x, ((Curve25519FieldElement) eCFieldElement).f26959x, create);
        return new Curve25519FieldElement(create);
    }

    @Override // org.bouncycastle.math.p464ec.ECFieldElement
    public boolean testBitZero() {
        return Nat256.getBit(this.f26959x, 0) == 1;
    }

    @Override // org.bouncycastle.math.p464ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat256.toBigInteger(this.f26959x);
    }
}
