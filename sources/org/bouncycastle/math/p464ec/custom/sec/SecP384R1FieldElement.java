...
public class SecP384R1FieldElement extends ECFieldElement.AbstractFp {
    ...
    /* renamed from: Q */
    public static final BigInteger f27018Q = new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFF0000000000000000FFFFFFFF"));

    /* renamed from: x */
    protected int[] f27019x;

    public SecP384R1FieldElement() {
        this.f27019x = Nat.create(12);
    }

    public SecP384R1FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f27018Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for SecP384R1FieldElement");
        }
        this.f27019x = SecP384R1Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SecP384R1Field.add(this.f27019x, ((SecP384R1FieldElement) eCFieldElement).f27019x, create);
    ...
    public ECFieldElement addOne() {
        int[] create = Nat.create(12);
        SecP384R1Field.addOne(this.f27019x, create);
        return new SecP384R1FieldElement(create);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat.create(12);
        SecP384R1Field.inv(((SecP384R1FieldElement) eCFieldElement).f27019x, create);
        SecP384R1Field.multiply(create, this.f27019x, create);
        return new SecP384R1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecP384R1FieldElement) {
            return Nat.m260eq(12, this.f27019x, ((SecP384R1FieldElement) obj).f27019x);
        }
        return false;
    }
    ...
    public int getFieldSize() {
        return f27018Q.bitLength();
    }

    public int hashCode() {
        return f27018Q.hashCode() ^ Arrays.hashCode(this.f27019x, 0, 12);
    }

    @Override // org.bouncycastle.math.p464ec.ECFieldElement
    public ECFieldElement invert() {
        int[] create = Nat.create(12);
        SecP384R1Field.inv(this.f27019x, create);
        return new SecP384R1FieldElement(create);
    }

    @Override // org.bouncycastle.math.p464ec.ECFieldElement
    public boolean isOne() {
        return Nat.isOne(12, this.f27019x);
    }

    @Override // org.bouncycastle.math.p464ec.ECFieldElement
    public boolean isZero() {
        return Nat.isZero(12, this.f27019x);
    }

    @Override // org.bouncycastle.math.p464ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat.create(12);
        SecP384R1Field.multiply(this.f27019x, ((SecP384R1FieldElement) eCFieldElement).f27019x, create);
        return new SecP384R1FieldElement(create);
    }
    ...
    public ECFieldElement negate() {
        int[] create = Nat.create(12);
        SecP384R1Field.negate(this.f27019x, create);
        return new SecP384R1FieldElement(create);
    }

    @Override // org.bouncycastle.math.p464ec.ECFieldElement
    public ECFieldElement sqrt() {
        int[] iArr = this.f27019x;
    ...
    public ECFieldElement square() {
        int[] create = Nat.create(12);
        SecP384R1Field.square(this.f27019x, create);
        return new SecP384R1FieldElement(create);
    }
    ...
    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] create = Nat.create(12);
        SecP384R1Field.subtract(this.f27019x, ((SecP384R1FieldElement) eCFieldElement).f27019x, create);
        return new SecP384R1FieldElement(create);
    }

    @Override // org.bouncycastle.math.p464ec.ECFieldElement
    public boolean testBitZero() {
        return Nat.getBit(this.f27019x, 0) == 1;
    }

    @Override // org.bouncycastle.math.p464ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat.toBigInteger(12, this.f27019x);
    }
}
