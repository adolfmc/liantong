...
import org.bouncycastle.math.p464ec.WTauNafMultiplier;
...
public class SecT233K1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT233K1Curve() {
        ...
        this.f26934a = fromBigInteger(BigInteger.valueOf(0L));
        this.f26935b = fromBigInteger(BigInteger.valueOf(1L));
