...
public class SecP160R2Curve extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f26977q = SecP160R2FieldElement.f26980Q;
    ...
    public SecP160R2Curve() {
        ...
        this.f26934a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFAC70")));
        this.f26935b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("B4E134D3FB59EB8BAB57274904664D5AF50388BA")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat160.copy(((SecP160R2FieldElement) eCPoint.getRawXCoord()).f26981x, 0, iArr, i3);
            int i5 = i3 + 5;
            Nat160.copy(((SecP160R2FieldElement) eCPoint.getRawYCoord()).f26981x, 0, iArr, i5);
            i3 = i5 + 5;
        }
