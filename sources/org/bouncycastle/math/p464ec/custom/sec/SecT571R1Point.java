...
public class SecT571R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecT571FieldElement secT571FieldElement4 = (SecT571FieldElement) this.f26949x;
        ...
        SecT571FieldElement secT571FieldElement6 = (SecT571FieldElement) this.f26950y;
        SecT571FieldElement secT571FieldElement7 = (SecT571FieldElement) this.f26951zs[0];
        ...
        long[] precompMultiplicand = secT571FieldElement7.isOne() ? null : SecT571Field.precompMultiplicand(secT571FieldElement7.f27032x);
        if (precompMultiplicand == null) {
            jArr = secT571FieldElement5.f27032x;
            jArr2 = secT571FieldElement8.f27032x;
        } else {
            SecT571Field.multiplyPrecomp(secT571FieldElement5.f27032x, precompMultiplicand, create642);
            SecT571Field.multiplyPrecomp(secT571FieldElement8.f27032x, precompMultiplicand, create644);
            jArr = create642;
            jArr2 = create644;
        }
        long[] precompMultiplicand2 = secT571FieldElement9.isOne() ? null : SecT571Field.precompMultiplicand(secT571FieldElement9.f27032x);
        if (precompMultiplicand2 == null) {
            jArr3 = secT571FieldElement4.f27032x;
            jArr4 = secT571FieldElement6.f27032x;
        } else {
            SecT571Field.multiplyPrecomp(secT571FieldElement4.f27032x, precompMultiplicand2, create64);
            SecT571Field.multiplyPrecomp(secT571FieldElement6.f27032x, precompMultiplicand2, create643);
            jArr3 = create64;
            jArr4 = create643;
        }
        ...
        if (secT571FieldElement5.isZero()) {
            ...
            SecT571Field.multiply(create64, create642, secT571FieldElement.f27032x);
            ...
            SecT571Field.multiplyPrecomp(create644, precompMultiplicand3, secT571FieldElement2.f27032x);
            if (precompMultiplicand2 != null) {
                SecT571Field.multiplyPrecomp(secT571FieldElement2.f27032x, precompMultiplicand2, secT571FieldElement2.f27032x);
            }
            ...
            SecT571Field.add(secT571FieldElement6.f27032x, secT571FieldElement7.f27032x, create644);
            SecT571Field.multiplyAddToExt(create644, secT571FieldElement2.f27032x, createExt64);
            SecT571FieldElement secT571FieldElement12 = new SecT571FieldElement(create644);
            SecT571Field.reduce(createExt64, secT571FieldElement12.f27032x);
            if (precompMultiplicand != null) {
                SecT571Field.multiplyPrecomp(secT571FieldElement2.f27032x, precompMultiplicand, secT571FieldElement2.f27032x);
            }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecT571FieldElement secT571FieldElement = (SecT571FieldElement) this.f26949x;
        if (secT571FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecT571FieldElement secT571FieldElement2 = (SecT571FieldElement) this.f26950y;
        SecT571FieldElement secT571FieldElement3 = (SecT571FieldElement) this.f26951zs[0];
        long[] create64 = Nat576.create64();
        long[] create642 = Nat576.create64();
        long[] precompMultiplicand = secT571FieldElement3.isOne() ? null : SecT571Field.precompMultiplicand(secT571FieldElement3.f27032x);
        if (precompMultiplicand == null) {
            jArr = secT571FieldElement2.f27032x;
            jArr2 = secT571FieldElement3.f27032x;
        } else {
            SecT571Field.multiplyPrecomp(secT571FieldElement2.f27032x, precompMultiplicand, create64);
            SecT571Field.square(secT571FieldElement3.f27032x, create642);
            jArr = create64;
            jArr2 = create642;
        }
        long[] create643 = Nat576.create64();
        SecT571Field.square(secT571FieldElement2.f27032x, create643);
        ...
        SecT571Field.square(create643, secT571FieldElement4.f27032x);
        SecT571FieldElement secT571FieldElement5 = new SecT571FieldElement(create643);
        if (precompMultiplicand != null) {
            SecT571Field.multiply(secT571FieldElement5.f27032x, jArr2, secT571FieldElement5.f27032x);
        }
        if (precompMultiplicand == null) {
            jArr3 = secT571FieldElement.f27032x;
        } else {
            SecT571Field.multiplyPrecomp(secT571FieldElement.f27032x, precompMultiplicand, create642);
            jArr3 = create642;
        }
        SecT571Field.squareAddToExt(jArr3, createExt64);
        SecT571Field.reduce(createExt64, create642);
        SecT571Field.addBothTo(secT571FieldElement4.f27032x, secT571FieldElement5.f27032x, create642);
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        SecT571FieldElement secT571FieldElement4 = (SecT571FieldElement) this.f26950y;
        SecT571FieldElement secT571FieldElement5 = (SecT571FieldElement) this.f26951zs[0];
        SecT571FieldElement secT571FieldElement6 = (SecT571FieldElement) eCPoint.getRawYCoord();
        long[] create64 = Nat576.create64();
        long[] create642 = Nat576.create64();
        long[] create643 = Nat576.create64();
        long[] create644 = Nat576.create64();
        SecT571Field.square(secT571FieldElement.f27032x, create64);
        SecT571Field.square(secT571FieldElement4.f27032x, create642);
        SecT571Field.square(secT571FieldElement5.f27032x, create643);
        SecT571Field.multiply(secT571FieldElement4.f27032x, secT571FieldElement5.f27032x, create644);
        SecT571Field.addBothTo(create643, create642, create644);
        long[] precompMultiplicand = SecT571Field.precompMultiplicand(create643);
        SecT571Field.multiplyPrecomp(secT571FieldElement6.f27032x, precompMultiplicand, create643);
        ...
        if (Nat576.isZero64(create642)) {
            ...
            SecT571Field.square(create643, secT571FieldElement7.f27032x);
            SecT571Field.multiply(secT571FieldElement7.f27032x, create64, secT571FieldElement7.f27032x);
            SecT571FieldElement secT571FieldElement8 = new SecT571FieldElement(create64);
            SecT571Field.multiply(create643, create642, secT571FieldElement8.f27032x);
            SecT571Field.multiplyPrecomp(secT571FieldElement8.f27032x, precompMultiplicand, secT571FieldElement8.f27032x);
            SecT571FieldElement secT571FieldElement9 = new SecT571FieldElement(create642);
            SecT571Field.add(create643, create642, secT571FieldElement9.f27032x);
            SecT571Field.square(secT571FieldElement9.f27032x, secT571FieldElement9.f27032x);
            Nat.zero64(18, createExt64);
            SecT571Field.multiplyAddToExt(secT571FieldElement9.f27032x, create644, createExt64);
            SecT571Field.addOne(secT571FieldElement6.f27032x, create644);
            SecT571Field.multiplyAddToExt(create644, secT571FieldElement8.f27032x, createExt64);
            SecT571Field.reduce(createExt64, secT571FieldElement9.f27032x);
