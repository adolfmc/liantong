...
public class LongArray implements Cloneable {
    ...
    private static long interleave3_13to65(int i) {
        ...
        return (iArr[i & 127] & 4294967295L) | ((iArr[i >>> 7] & 4294967295L) << 35);
    }
    ...
    private static long interleave3_21to63(int i) {
        ...
        int i2 = iArr[i & 127];
        int i3 = iArr[(i >>> 7) & 127];
        return (i2 & 4294967295L) | ((iArr[i >>> 14] & 4294967295L) << 42) | ((i3 & 4294967295L) << 21);
    }

    private static long interleave4_16to64(int i) {
        int[] iArr = INTERLEAVE4_TABLE;
        return (iArr[i & 255] & 4294967295L) | ((iArr[i >>> 8] & 4294967295L) << 32);
    }
    ...
    public LongArray modMultiplyAlt(LongArray longArray, int i, int[] iArr) {
        ...
        iArr2[1] = i8;
        int i9 = i8;
        for (int i10 = 2; i10 < iArr2.length; i10++) {
            i9 += i4;
            iArr2[i10] = i9;
        }
        long[] jArr2 = new long[i9 + i4 + 1];
        int i11 = i7;
