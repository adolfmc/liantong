...
public abstract class Nat256 {
    ...
    /* renamed from: M */
    private static final long f27071M = 4294967295L;
    ...
    /* renamed from: eq */
    public static boolean m255eq(int[] iArr, int[] iArr2) {
        for (int i = 7; i >= 0; i--) {
            if (iArr[i] != iArr2[i]) {
                return false;
            }
    ...
    public static int mulAddTo(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        while (i13 < 8) {
            ...
            iArr3[i12 + 0] = (int) j12;
            int i14 = i12 + 1;
            long j13 = (j12 >>> 32) + (j10 * j2) + (iArr3[i14] & 4294967295L);
            iArr3[i14] = (int) j13;
            long j14 = j3;
            long j15 = (j13 >>> 32) + (j10 * j3) + (iArr3[i5] & 4294967295L);
            iArr3[i12 + 2] = (int) j15;
            int i15 = i12;
            ...
            iArr3[i15 + 6] = (int) j19;
            long j20 = (j19 >>> 32) + (j10 * j8) + (iArr3[i10] & 4294967295L);
            iArr3[i15 + 7] = (int) j20;
