...
public abstract class Nat {
    ...
    /* renamed from: M */
    private static final long f27066M = 4294967295L;
    ...
    public static int addBothTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i6 = 0; i6 < i; i6++) {
            long j2 = j + (iArr[i2 + i6] & 4294967295L) + (iArr2[i3 + i6] & 4294967295L) + (4294967295L & iArr3[i5]);
            iArr3[i4 + i6] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    /* renamed from: eq */
    public static boolean m260eq(int i, int[] iArr, int[] iArr2) {
        for (int i2 = i - 1; i2 >= 0; i2--) {
            if (iArr[i2] != iArr2[i2]) {
                return false;
            }
    ...
    public static int squareWordAddTo(int[] iArr, int i, int i2, int[] iArr2, int i3) {
        ...
        do {
            int i6 = i2 + i5;
            long j3 = j2 + ((iArr[i + i4] & 4294967295L) * j) + (iArr2[i6] & 4294967295L);
            iArr2[i6] = (int) j3;
            j2 = j3 >>> 32;
            i5++;
            i4++;
    ...
    public static int subBothFrom(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        long j = 0;
        for (int i6 = 0; i6 < i; i6++) {
            long j2 = j + (((iArr3[i5] & 4294967295L) - (iArr[i2 + i6] & 4294967295L)) - (4294967295L & iArr2[i3 + i6]));
            iArr3[i4 + i6] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
