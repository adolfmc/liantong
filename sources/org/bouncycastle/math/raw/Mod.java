...
public abstract class Mod {
    ...
    private static int divsteps30(int i, int i2, int i3, int[] iArr) {
        ...
        for (int i11 = 0; i11 < 30; i11++) {
            int i12 = i5 >> 31;
            int i13 = -(i7 & 1);
            int i14 = i7 - ((i6 ^ i12) & i13);
            int i15 = i10 - ((i4 ^ i12) & i13);
    ...
    private static int divsteps30Var(int i, int i2, int i3, int[] iArr) {
        ...
        while (true) {
            ...
            if (i7 < 0) {
                ...
                i4 = ((-1) >>> (32 - i19)) & 63 & (i15 * i18 * ((i15 * i15) - 2));
                i8 = i15;
                i15 = i18;
            } else {
                int i20 = i7 + 1;
    ...
    private static void updateDE30(int i, int[] iArr, int[] iArr2, int[] iArr3, int i2, int[] iArr4) {
        ...
        while (i15 < i3) {
            ...
            long j16 = j11;
            long j17 = i16;
            long j18 = j13 + (j * j14) + (j3 * j15) + (j17 * j10);
            long j19 = j12 + (j14 * j6) + (j15 * j7) + (j17 * j16);
            int i18 = i17 - 1;
            iArr[i18] = ((int) j18) & 1073741823;
            j13 = j18 >> 30;
            iArr2[i18] = ((int) j19) & 1073741823;
            j12 = j19 >> 30;
            i15 = i17 + 1;
            i14 = i14;
            j11 = j16;
