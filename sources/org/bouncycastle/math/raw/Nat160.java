...
public abstract class Nat160 {
    ...
    /* renamed from: M */
    private static final long f27068M = 4294967295L;
    ...
    /* renamed from: eq */
    public static boolean m258eq(int[] iArr, int[] iArr2) {
        for (int i = 4; i >= 0; i--) {
            if (iArr[i] != iArr2[i]) {
                return false;
            }
    ...
    public static void square(int[] iArr, int i, int[] iArr2, int i2) {
        ...
        while (true) {
            ...
            if (i13 <= 0) {
                ...
                long j6 = (((i15 << 31) & 4294967295L) | (j4 >>> 33)) + (j5 * j);
                int i16 = (int) j6;
                ...
                int i22 = (int) j23;
                iArr2[i2 + 5] = (i21 >>> 31) | (i22 << 1);
                int i23 = (int) j24;
                iArr2[i2 + 6] = (i22 >>> 31) | (i23 << 1);
                int i24 = i23 >>> 31;
                int i25 = (int) j25;
                iArr2[i2 + 7] = i24 | (i25 << 1);
                int i26 = i25 >>> 31;
                int i27 = (int) j26;
                iArr2[i2 + 8] = i26 | (i27 << 1);
                int i28 = i27 >>> 31;
                int i29 = i2 + 9;
                iArr2[i29] = i28 | ((iArr2[i29] + ((int) (j26 >>> 32))) << 1);
                return;
            }
            i11 = i15;
            i12 = i13;
