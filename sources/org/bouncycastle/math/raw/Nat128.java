...
public abstract class Nat128 {
    ...
    /* renamed from: M */
    private static final long f27067M = 4294967295L;
    ...
    /* renamed from: eq */
    public static boolean m259eq(int[] iArr, int[] iArr2) {
        for (int i = 3; i >= 0; i--) {
            if (iArr[i] != iArr2[i]) {
                return false;
            }
    ...
    public static void square(int[] iArr, int i, int[] iArr2, int i2) {
        ...
        while (true) {
            ...
            if (i11 <= 0) {
                ...
                long j6 = (((i13 << 31) & 4294967295L) | (j4 >>> 33)) + (j5 * j);
                int i14 = (int) j6;
                ...
                int i18 = (int) j15;
                iArr2[i2 + 3] = (i18 << 1) | i17;
                long j16 = (j11 & 4294967295L) + (j15 >>> 32) + (j12 * j5);
                long j17 = j14 + (j16 >>> 32) + (j12 * j8);
                long j18 = (iArr2[i7] & 4294967295L) + (j13 >>> 32) + (j17 >>> 32);
                int i19 = (int) j16;
                iArr2[i2 + 4] = (i18 >>> 31) | (i19 << 1);
                int i20 = i19 >>> 31;
                int i21 = (int) j17;
                iArr2[i2 + 5] = i20 | (i21 << 1);
                int i22 = i21 >>> 31;
                int i23 = (int) j18;
                iArr2[i2 + 6] = i22 | (i23 << 1);
                int i24 = i23 >>> 31;
                int i25 = i2 + 7;
                iArr2[i25] = i24 | ((iArr2[i25] + ((int) (j18 >>> 32))) << 1);
                return;
            }
            i9 = i13;
            i10 = i11;
