...
public class X509Name extends ASN1Object {
    ...
    /* renamed from: C */
    public static final ASN1ObjectIdentifier f26342C = new ASN1ObjectIdentifier("2.5.4.6");

    /* renamed from: O */
    public static final ASN1ObjectIdentifier f26347O = new ASN1ObjectIdentifier("2.5.4.10");

    /* renamed from: OU */
    public static final ASN1ObjectIdentifier f26348OU = new ASN1ObjectIdentifier("2.5.4.11");

    /* renamed from: T */
    public static final ASN1ObjectIdentifier f26351T = new ASN1ObjectIdentifier("2.5.4.12");

    /* renamed from: CN */
    public static final ASN1ObjectIdentifier f26343CN = new ASN1ObjectIdentifier("2.5.4.3");

    /* renamed from: SN */
    public static final ASN1ObjectIdentifier f26349SN = new ASN1ObjectIdentifier("2.5.4.5");
    public static final ASN1ObjectIdentifier STREET = new ASN1ObjectIdentifier("2.5.4.9");
    public static final ASN1ObjectIdentifier SERIALNUMBER = f26349SN;

    /* renamed from: L */
    public static final ASN1ObjectIdentifier f26346L = new ASN1ObjectIdentifier("2.5.4.7");

    /* renamed from: ST */
    public static final ASN1ObjectIdentifier f26350ST = new ASN1ObjectIdentifier("2.5.4.8");
    ...
    /* renamed from: E */
    public static final ASN1ObjectIdentifier f26345E = EmailAddress;

    /* renamed from: DC */
    public static final ASN1ObjectIdentifier f26344DC = new ASN1ObjectIdentifier("0.9.2342.19200300.100.1.25");
    ...
    static {
        DefaultSymbols.put(f26342C, "C");
        DefaultSymbols.put(f26347O, "O");
        DefaultSymbols.put(f26351T, "T");
        DefaultSymbols.put(f26348OU, "OU");
        DefaultSymbols.put(f26343CN, "CN");
        DefaultSymbols.put(f26346L, "L");
        DefaultSymbols.put(f26350ST, "ST");
        DefaultSymbols.put(f26349SN, "SERIALNUMBER");
        DefaultSymbols.put(EmailAddress, "E");
        DefaultSymbols.put(f26344DC, "DC");
        ...
        RFC2253Symbols.put(f26342C, "C");
        RFC2253Symbols.put(f26347O, "O");
        RFC2253Symbols.put(f26348OU, "OU");
        RFC2253Symbols.put(f26343CN, "CN");
        RFC2253Symbols.put(f26346L, "L");
        RFC2253Symbols.put(f26350ST, "ST");
        RFC2253Symbols.put(STREET, "STREET");
        RFC2253Symbols.put(f26344DC, "DC");
        RFC2253Symbols.put(UID, "UID");
        RFC1779Symbols.put(f26342C, "C");
        RFC1779Symbols.put(f26347O, "O");
        RFC1779Symbols.put(f26348OU, "OU");
        RFC1779Symbols.put(f26343CN, "CN");
        RFC1779Symbols.put(f26346L, "L");
        RFC1779Symbols.put(f26350ST, "ST");
        RFC1779Symbols.put(STREET, "STREET");
        DefaultLookUp.put("c", f26342C);
        DefaultLookUp.put("o", f26347O);
        DefaultLookUp.put("t", f26351T);
        DefaultLookUp.put("ou", f26348OU);
        DefaultLookUp.put("cn", f26343CN);
        DefaultLookUp.put("l", f26346L);
        DefaultLookUp.put("st", f26350ST);
        DefaultLookUp.put("sn", f26349SN);
        DefaultLookUp.put("serialnumber", f26349SN);
        DefaultLookUp.put("street", STREET);
        DefaultLookUp.put("emailaddress", f26345E);
        DefaultLookUp.put("dc", f26344DC);
        DefaultLookUp.put("e", f26345E);
