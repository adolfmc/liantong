...
import org.bouncycastle.math.p464ec.endo.GLVTypeBEndomorphism;
import org.bouncycastle.math.p464ec.endo.GLVTypeBParameters;
import org.bouncycastle.math.p464ec.endo.ScalarSplitParameters;
...
public class SECNamedCurves {
    static X9ECParametersHolder secp112r1 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.1
        @Override // org.bouncycastle.asn1.p457x9.X9ECParametersHolder
        public ECCurve createCurve() {
            return SECNamedCurves.configureCurve(new ECCurve.C13318Fp(SECNamedCurves.fromHex("DB7C2ABF62E35E668076BEAD208B"), SECNamedCurves.fromHex("DB7C2ABF62E35E668076BEAD2088"), SECNamedCurves.fromHex("659EF8BA043916EEDE8911702B22"), SECNamedCurves.fromHex("DB7C2ABF62E35E7628DFAC6561C5"), BigInteger.valueOf(1L), true));
        }
    ...
    static X9ECParametersHolder secp112r2 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.2
        @Override // org.bouncycastle.asn1.p457x9.X9ECParametersHolder
        public ECCurve createCurve() {
            return SECNamedCurves.configureCurve(new ECCurve.C13318Fp(SECNamedCurves.fromHex("DB7C2ABF62E35E668076BEAD208B"), SECNamedCurves.fromHex("6127C24C05F38A0AAAF65C0EF02C"), SECNamedCurves.fromHex("51DEF1815DB5ED74FCC34C85D709"), SECNamedCurves.fromHex("36DF0AAFD8B8D7597CA10520D04B"), BigInteger.valueOf(4L), true));
        }
    ...
    static X9ECParametersHolder secp160r1 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.6
        @Override // org.bouncycastle.asn1.p457x9.X9ECParametersHolder
        public ECCurve createCurve() {
            return SECNamedCurves.configureCurve(new ECCurve.C13318Fp(SECNamedCurves.fromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF7FFFFFFF"), SECNamedCurves.fromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF7FFFFFFC"), SECNamedCurves.fromHex("1C97BEFC54BD7A8B65ACF89F81D4D4ADC565FA45"), SECNamedCurves.fromHex("0100000000000000000001F4C8F927AED3CA752257"), BigInteger.valueOf(1L), true));
        }
    ...
    static X9ECParametersHolder secp160r2 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.7
        @Override // org.bouncycastle.asn1.p457x9.X9ECParametersHolder
        public ECCurve createCurve() {
            return SECNamedCurves.configureCurve(new ECCurve.C13318Fp(SECNamedCurves.fromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFAC73"), SECNamedCurves.fromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFAC70"), SECNamedCurves.fromHex("B4E134D3FB59EB8BAB57274904664D5AF50388BA"), SECNamedCurves.fromHex("0100000000000000000000351EE786A818F3A1A16B"), BigInteger.valueOf(1L), true));
        }
    ...
    static X9ECParametersHolder secp224k1 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.10
        @Override // org.bouncycastle.asn1.p457x9.X9ECParametersHolder
        public ECCurve createCurve() {
            return SECNamedCurves.configureCurveGLV(new ECCurve.C13318Fp(SECNamedCurves.fromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFE56D"), ECConstants.ZERO, BigInteger.valueOf(5L), SECNamedCurves.fromHex("010000000000000000000000000001DCE8D2EC6184CAF0A971769FB1F7"), BigInteger.valueOf(1L), true), new GLVTypeBParameters(new BigInteger("fe0e87005b4e83761908c5131d552a850b3f58b749c37cf5b84d6768", 16), new BigInteger("60dcd2104c4cbc0be6eeefc2bdd610739ec34e317f9b33046c9e4788", 16), new ScalarSplitParameters(new BigInteger[]{new BigInteger("6b8cf07d4ca75c88957d9d670591", 16), new BigInteger("-b8adf1378a6eb73409fa6c9c637d", 16)}, new BigInteger[]{new BigInteger("1243ae1b4d71613bc9f780a03690e", 16), new BigInteger("6b8cf07d4ca75c88957d9d670591", 16)}, new BigInteger("6b8cf07d4ca75c88957d9d67059037a4", 16), new BigInteger("b8adf1378a6eb73409fa6c9c637ba7f5", 16), 240)));
        }
    ...
    static X9ECParametersHolder secp256r1 = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.sec.SECNamedCurves.13
        @Override // org.bouncycastle.asn1.p457x9.X9ECParametersHolder
        public ECCurve createCurve() {
            return SECNamedCurves.configureCurve(new ECCurve.C13318Fp(SECNamedCurves.fromHex("FFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFF"), SECNamedCurves.fromHex("FFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFC"), SECNamedCurves.fromHex("5AC635D8AA3A93E7B3EBBD55769886BC651D06B0CC53B0F63BCE3C3E27D2604B"), SECNamedCurves.fromHex("FFFFFFFF00000000FFFFFFFFFFFFFFFFBCE6FAADA7179E84F3B9CAC2FC632551"), BigInteger.valueOf(1L), true));
        }
