...
public class ECNamedCurveTable {
    public static Enumeration getNames() {
        return org.bouncycastle.asn1.p457x9.ECNamedCurveTable.getNames();
    }

    /* JADX WARN: Code restructure failed: missing block: B:6:0x0011, code lost:
        r0 = org.bouncycastle.asn1.p457x9.ECNamedCurveTable.getByName(r8);
     */
    /*
    ...
    */
    public static org.bouncycastle.jce.spec.ECNamedCurveParameterSpec getParameterSpec(java.lang.String r8) {
        /*
            org.bouncycastle.asn1.x9.X9ECParameters r0 = org.bouncycastle.crypto.p458ec.CustomNamedCurves.getByName(r8)
            if (r0 != 0) goto L20
            ...
            org.bouncycastle.asn1.x9.X9ECParameters r0 = org.bouncycastle.crypto.p458ec.CustomNamedCurves.getByOID(r1)     // Catch: java.lang.IllegalArgumentException -> Lf
        Lf:
            if (r0 != 0) goto L20
            org.bouncycastle.asn1.x9.X9ECParameters r0 = org.bouncycastle.asn1.p457x9.ECNamedCurveTable.getByName(r8)
            if (r0 != 0) goto L20
            ...
            org.bouncycastle.asn1.x9.X9ECParameters r0 = org.bouncycastle.asn1.p457x9.ECNamedCurveTable.getByOID(r1)     // Catch: java.lang.IllegalArgumentException -> L20
        L20:
            if (r0 != 0) goto L24
            r8 = 0
            return r8
