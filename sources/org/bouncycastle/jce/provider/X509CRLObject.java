...
public class X509CRLObject extends X509CRL {
    ...
    /* renamed from: c */
    private CertificateList f26912c;
    ...
    private void doVerify(PublicKey publicKey, Signature signature) throws CRLException, NoSuchAlgorithmException, InvalidKeyException, SignatureException {
        if (!this.f26912c.getSignatureAlgorithm().equals(this.f26912c.getTBSCertList().getSignature())) {
    ...
    private Set getExtensionOIDs(boolean z) {
        ...
        if (getVersion() != 2 || (extensions = this.f26912c.getTBSCertList().getExtensions()) == null) {
            return null;
        }
    ...
    private Set loadCRLEntries() {
        Extension extension;
        HashSet hashSet = new HashSet();
        Enumeration revokedCertificateEnumeration = this.f26912c.getRevokedCertificateEnumeration();
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CRL) {
            if (obj instanceof X509CRLObject) {
                ...
                return this.f26912c.equals(x509CRLObject.f26912c);
            }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f26912c.getEncoded("DER");
        } catch (IOException e) {
    ...
    public byte[] getExtensionValue(String str) {
        Extension extension;
        Extensions extensions = this.f26912c.getTBSCertList().getExtensions();
    ...
    public Principal getIssuerDN() {
        return new X509Principal(X500Name.getInstance(this.f26912c.getIssuer().toASN1Primitive()));
    }

    @Override // java.security.cert.X509CRL
    public X500Principal getIssuerX500Principal() {
        try {
            return new X500Principal(this.f26912c.getIssuer().getEncoded());
    ...
    public Date getNextUpdate() {
        if (this.f26912c.getNextUpdate() != null) {
            return this.f26912c.getNextUpdate().getDate();
        }
        return null;
    }
    ...
    public String getSigAlgOID() {
        return this.f26912c.getSignatureAlgorithm().getAlgorithm().getId();
    }
    ...
    public byte[] getSignature() {
        return this.f26912c.getSignature().getOctets();
    }

    @Override // java.security.cert.X509CRL
    public byte[] getTBSCertList() throws CRLException {
        try {
            return this.f26912c.getTBSCertList().getEncoded("DER");
        } catch (IOException e) {
            throw new CRLException(e.toString());
        }
    }
    ...
    public Date getThisUpdate() {
        return this.f26912c.getThisUpdate().getDate();
    }

    @Override // java.security.cert.X509CRL
    public int getVersion() {
        return this.f26912c.getVersionNumber();
    }
    ...
    public boolean isRevoked(Certificate certificate) {
        ...
        if (certificate.getType().equals("X.509")) {
            Enumeration revokedCertificateEnumeration = this.f26912c.getRevokedCertificateEnumeration();
            X500Name issuer2 = this.f26912c.getIssuer();
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:42:0x0187 -> B:15:0x00b7). Please submit an issue!!! */
    @Override // java.security.cert.CRL
