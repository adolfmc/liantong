...
public class JCEECPublicKey implements ECPublicKey, ECPointEncoder, org.bouncycastle.jce.interfaces.ECPublicKey {
    ...
    public JCEECPublicKey(String str, ECPublicKeySpec eCPublicKeySpec) {
        ...
        this.f26904q = EC5Util.convertPoint(this.ecSpec, eCPublicKeySpec.getW());
    }

    public JCEECPublicKey(String str, ECPublicKeyParameters eCPublicKeyParameters) {
        this.algorithm = "EC";
        this.algorithm = str;
        this.f26904q = eCPublicKeyParameters.getQ();
        this.ecSpec = null;
    }
    ...
    public JCEECPublicKey(String str, JCEECPublicKey jCEECPublicKey) {
        this.algorithm = "EC";
        this.algorithm = str;
        this.f26904q = jCEECPublicKey.f26904q;
    ...
    public JCEECPublicKey(String str, org.bouncycastle.jce.spec.ECPublicKeySpec eCPublicKeySpec) {
        ...
        this.algorithm = "EC";
        this.algorithm = str;
        this.f26904q = eCPublicKeySpec.getQ();
        if (eCPublicKeySpec.getParams() != null) {
            ...
            if (this.f26904q.getCurve() == null) {
                this.f26904q = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa().getCurve().createPoint(this.f26904q.getAffineXCoord().toBigInteger(), this.f26904q.getAffineYCoord().toBigInteger());
            }
    ...
    public JCEECPublicKey(ECPublicKey eCPublicKey) {
        ...
        this.f26904q = EC5Util.convertPoint(this.ecSpec, eCPublicKey.getW());
    }
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        if (algorithm.getAlgorithm().equals((ASN1Primitive) CryptoProObjectIdentifiers.gostR3410_2001)) {
            ...
            try {
                ...
                this.f26904q = curve2.decodePoint(bArr);
        ...
        if (x962Parameters.isNamedCurve()) {
            ...
            this.f26904q = new X9ECPoint(curve, dEROctetString).getPoint();
        } else {
    ...
    public byte[] getEncoded() {
        ...
        if (this.algorithm.equals("ECGOST3410")) {
            ...
            BigInteger bigInteger = this.f26904q.getAffineXCoord().toBigInteger();
            BigInteger bigInteger2 = this.f26904q.getAffineYCoord().toBigInteger();
    ...
    public ECPoint getQ() {
        return this.ecSpec == null ? this.f26904q.getDetachedPoint() : this.f26904q;
    }

    @Override // java.security.interfaces.ECPublicKey
    public java.security.spec.ECPoint getW() {
        return EC5Util.convertPoint(this.f26904q);
    }
    ...
    public String toString() {
        ...
        stringBuffer.append(this.f26904q.getAffineXCoord().toBigInteger().toString(16));
        stringBuffer.append(lineSeparator);
        stringBuffer.append("            Y: ");
        stringBuffer.append(this.f26904q.getAffineYCoord().toBigInteger().toString(16));
        stringBuffer.append(lineSeparator);
