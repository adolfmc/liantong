...
public class Base32Encoder implements Encoder {
    private static final byte[] DEAULT_ENCODING_TABLE = {65, 66, 67, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84, 85, 86, 87, 88, 89, 90, 50, 51, 52, 53, C0548c.f1784h, 55};
    ...
    public int decode(byte[] bArr, int i, int i2, OutputStream outputStream) throws IOException {
        ...
        while (nextI < i4) {
            ...
            int i21 = i20 + 1;
            bArr2[i20] = (byte) ((b5 << 7) | (b6 << 2) | (b7 >> 3));
            i6 = i21 + 1;
            bArr2[i21] = (byte) (b8 | (b7 << 5));
            if (i6 == bArr2.length) {
                outputStream.write(bArr2);
                i6 = 0;
            }
            i7 += 5;
            nextI = nextI(bArr, i17, i16);
            i4 = i16;
            i3 = i14;
        }
        int i22 = i3;
        ...
        int nextI9 = nextI(bArr, nextI, i22);
        int nextI10 = nextI(bArr, nextI9 + 1, i22);
        int nextI11 = nextI(bArr, nextI10 + 1, i22);
        int nextI12 = nextI(bArr, nextI11 + 1, i22);
        int nextI13 = nextI(bArr, nextI12 + 1, i22);
        int nextI14 = nextI(bArr, nextI13 + 1, i22);
        int nextI15 = nextI(bArr, nextI14 + 1, i22);
        return i7 + decodeLastBlock(outputStream, (char) bArr[nextI9], (char) bArr[nextI10], (char) bArr[nextI11], (char) bArr[nextI12], (char) bArr[nextI13], (char) bArr[nextI14], (char) bArr[nextI15], (char) bArr[nextI(bArr, nextI15 + 1, i22)]);
    }
