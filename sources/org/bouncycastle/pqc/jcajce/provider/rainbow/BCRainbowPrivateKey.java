...
public class BCRainbowPrivateKey implements PrivateKey {
    ...
    /* renamed from: b1 */
    private short[] f27277b1;

    /* renamed from: b2 */
    private short[] f27278b2;
    private Layer[] layers;

    /* renamed from: vi */
    private int[] f27279vi;
    ...
    public boolean equals(Object obj) {
        ...
        boolean z = ((((RainbowUtil.equals(this.A1inv, bCRainbowPrivateKey.getInvA1())) && RainbowUtil.equals(this.A2inv, bCRainbowPrivateKey.getInvA2())) && RainbowUtil.equals(this.f27277b1, bCRainbowPrivateKey.getB1())) && RainbowUtil.equals(this.f27278b2, bCRainbowPrivateKey.getB2())) && Arrays.equals(this.f27279vi, bCRainbowPrivateKey.getVi());
    ...
    public short[] getB1() {
        return this.f27277b1;
    }

    public short[] getB2() {
        return this.f27278b2;
    }

    @Override // java.security.Key
    public byte[] getEncoded() {
        try {
            return new PrivateKeyInfo(new AlgorithmIdentifier(PQCObjectIdentifiers.rainbow, DERNull.INSTANCE), new RainbowPrivateKey(this.A1inv, this.f27277b1, this.A2inv, this.f27278b2, this.f27279vi, this.layers)).getEncoded();
    ...
    public int[] getVi() {
        return this.f27279vi;
    }

    public int hashCode() {
        int length = (((((((((this.layers.length * 37) + org.bouncycastle.util.Arrays.hashCode(this.A1inv)) * 37) + org.bouncycastle.util.Arrays.hashCode(this.f27277b1)) * 37) + org.bouncycastle.util.Arrays.hashCode(this.A2inv)) * 37) + org.bouncycastle.util.Arrays.hashCode(this.f27278b2)) * 37) + org.bouncycastle.util.Arrays.hashCode(this.f27279vi);
