...
public class SPHINCSPlusParameterSpec implements AlgorithmParameterSpec {
    ...
    static {
        ...
        parameters.put(sha2_128f_simple.getName(), sha2_128f_simple);
        parameters.put(sha2_128s_simple.getName(), sha2_128s_simple);
        parameters.put(sha2_192f_simple.getName(), sha2_192f_simple);
        parameters.put(sha2_192s_simple.getName(), sha2_192s_simple);
        parameters.put(sha2_256f_simple.getName(), sha2_256f_simple);
        parameters.put(sha2_256s_simple.getName(), sha2_256s_simple);
        ...
        parameters.put(shake_128f_simple.getName(), shake_128f_simple);
        parameters.put(shake_128s_simple.getName(), shake_128s_simple);
        parameters.put(shake_192f_simple.getName(), shake_192f_simple);
        parameters.put(shake_192s_simple.getName(), shake_192s_simple);
        parameters.put(shake_256f_simple.getName(), shake_256f_simple);
        parameters.put(shake_256s_simple.getName(), shake_256s_simple);
