...
public abstract class Polynomial {
    ...
    public Polynomial(NTRUParameterSet nTRUParameterSet) {
        this.coeffs = new short[nTRUParameterSet.m232n()];
    ...
    public void mod3PhiN() {
        ...
        for (int i = 0; i < m232n; i++) {
            short[] sArr = this.coeffs;
            sArr[i] = mod3((short) (sArr[i] + (sArr[m232n - 1] * 2)));
        }
    }
    ...
    public void modQPhiN() {
        ...
        for (int i = 0; i < m232n; i++) {
            short[] sArr = this.coeffs;
            sArr[i] = (short) (sArr[i] - sArr[m232n - 1]);
        }
    }
    ...
    public void r2Inv(Polynomial polynomial, Polynomial polynomial2, Polynomial polynomial3, Polynomial polynomial4, Polynomial polynomial5) {
        ...
        while (i4 < (i * 2) - s) {
            ...
            polynomial4.coeffs[s2] = s2;
            short[] sArr3 = polynomial3.coeffs;
            short s4 = (short) (sArr3[s2] & polynomial2.coeffs[s2]);
            int i6 = -s3;
            short bothNegativeMask = bothNegativeMask((short) i6, (short) (-sArr3[s2]));
            s3 = (short) (((short) (s3 ^ ((i6 ^ s3) & bothNegativeMask))) + s);
            for (int i7 = s2; i7 < length; i7++) {
                short[] sArr4 = polynomial2.coeffs;
                short s5 = sArr4[i7];
                short[] sArr5 = polynomial3.coeffs;
                short s6 = (short) ((s5 ^ sArr5[i7]) & bothNegativeMask);
                sArr4[i7] = (short) (sArr4[i7] ^ s6);
                sArr5[i7] = (short) (sArr5[i7] ^ s6);
                short[] sArr6 = polynomial4.coeffs;
                short s7 = sArr6[i7];
                short[] sArr7 = polynomial5.coeffs;
                short s8 = (short) ((s7 ^ sArr7[i7]) & bothNegativeMask);
                sArr6[i7] = (short) (sArr6[i7] ^ s8);
                sArr7[i7] = (short) (sArr7[i7] ^ s8);
            }
            for (int i8 = 0; i8 < length; i8++) {
                short[] sArr8 = polynomial3.coeffs;
                sArr8[i8] = (short) (sArr8[i8] ^ (polynomial2.coeffs[i8] & s4));
            }
            for (int i9 = 0; i9 < length; i9++) {
                short[] sArr9 = polynomial5.coeffs;
                sArr9[i9] = (short) (sArr9[i9] ^ (polynomial4.coeffs[i9] & s4));
            }
            int i10 = 0;
            while (i10 < i) {
                short[] sArr10 = polynomial3.coeffs;
                int i11 = i10 + 1;
                sArr10[i10] = sArr10[i11];
                i10 = i11;
            }
            polynomial3.coeffs[i] = 0;
            i4++;
        ...
        for (int i12 = 0; i12 < i; i12++) {
            this.coeffs[i12] = polynomial4.coeffs[(length - 2) - i12];
        }
        this.coeffs[i] = 0;
    }
    ...
    public void rqToS3(Polynomial polynomial) {
        int length = this.coeffs.length;
        for (int i = 0; i < length; i++) {
            this.coeffs[i] = (short) modQ(polynomial.coeffs[i] & 65535, this.params.m231q());
            short[] sArr = this.coeffs;
    ...
    public void s3Inv(Polynomial polynomial, Polynomial polynomial2, Polynomial polynomial3, Polynomial polynomial4, Polynomial polynomial5) {
        ...
        for (short s3 = 1; i4 < (i * 2) - s3; s3 = 1) {
            ...
            for (int i7 = s; i7 < length; i7++) {
                ...
                short s5 = (short) ((s4 ^ sArr6[i7]) & bothNegativeMask);
                sArr5[i7] = (short) (sArr5[i7] ^ s5);
                sArr6[i7] = (short) (sArr6[i7] ^ s5);
                short[] sArr7 = polynomial4.coeffs;
                short s6 = sArr7[i7];
                short[] sArr8 = polynomial5.coeffs;
                short s7 = (short) ((s6 ^ sArr8[i7]) & bothNegativeMask);
                sArr7[i7] = (short) (sArr7[i7] ^ s7);
    ...
    public void trinaryZqToZ3() {
        ...
        for (int i = 0; i < length; i++) {
            short[] sArr = this.coeffs;
            sArr[i] = (short) modQ(sArr[i] & 65535, this.params.m231q());
            short[] sArr2 = this.coeffs;
            sArr2[i] = (short) ((sArr2[i] ^ (sArr2[i] >>> (this.params.logQ() - 1))) & 3);
        }
    }
    ...
    public void z3ToZq() {
        ...
        for (int i = 0; i < length; i++) {
            short[] sArr = this.coeffs;
            sArr[i] = (short) (sArr[i] | ((-(sArr[i] >>> 1)) & (this.params.m231q() - 1)));
        }
    }
}
