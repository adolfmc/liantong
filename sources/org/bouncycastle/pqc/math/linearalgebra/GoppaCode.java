 ...
 */
    ...
    public static class MaMaPe {
        ...
        /* renamed from: h */
        private GF2Matrix f27370h;

        /* renamed from: p */
        private Permutation f27371p;

        /* renamed from: s */
        private GF2Matrix f27372s;

        public MaMaPe(GF2Matrix gF2Matrix, GF2Matrix gF2Matrix2, Permutation permutation) {
            this.f27372s = gF2Matrix;
            this.f27370h = gF2Matrix2;
            this.f27371p = permutation;
        }
 ...
 */
    ...
    public static class MatrixSet {
        ...
        /* renamed from: g */
        private GF2Matrix f27373g;
        private int[] setJ;

        public MatrixSet(GF2Matrix gF2Matrix, int[] iArr) {
            this.f27373g = gF2Matrix;
            this.setJ = iArr;
        }
