...
public class GF2Vector extends Vector {
    ...
    public GF2Vector(int i, SecureRandom secureRandom) {
        this.length = i;
        int i2 = (i + 31) >> 5;
        this.f27358v = new int[i2];
        int i3 = i2 - 1;
        for (int i4 = i3; i4 >= 0; i4--) {
            this.f27358v[i4] = secureRandom.nextInt();
        }
        int i5 = i & 31;
        if (i5 != 0) {
            int[] iArr = this.f27358v;
    ...
    public GF2Vector(int i, int[] iArr) {
        ...
        this.f27358v = IntUtils.clone(iArr);
        int i3 = i & 31;
        if (i3 != 0) {
            int[] iArr2 = this.f27358v;
            int i4 = i2 - 1;
    ...
    public GF2Vector(GF2Vector gF2Vector) {
        ...
        this.f27358v = IntUtils.clone(gF2Vector.f27358v);
    }
    ...
    public Vector add(Vector vector) {
        if (vector instanceof GF2Vector) {
            ...
            if (this.length == gF2Vector.length) {
                int[] clone = IntUtils.clone(gF2Vector.f27358v);
                for (int length = clone.length - 1; length >= 0; length--) {
                    clone[length] = clone[length] ^ this.f27358v[length];
                }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof GF2Vector) {
            ...
            return this.length == gF2Vector.length && IntUtils.equals(this.f27358v, gF2Vector.f27358v);
        }
        return false;
    }
    ...
    public GF2Vector extractLeftVector(int i) {
        if (i <= this.length) {
            ...
            int i2 = i >> 5;
            int i3 = i & 31;
            System.arraycopy(this.f27358v, 0, gF2Vector.f27358v, 0, i2);
            if (i3 != 0) {
                gF2Vector.f27358v[i2] = ((1 << i3) - 1) & this.f27358v[i2];
            }
            return gF2Vector;
        }
    ...
    public GF2Vector extractRightVector(int i) {
        ...
        if (i <= this.length) {
            ...
            if (i4 != 0) {
                ...
                int[] iArr3 = gF2Vector.f27358v;
                int[] iArr4 = this.f27358v;
                int i8 = i3 + 1;
                ...
                System.arraycopy(this.f27358v, i3, gF2Vector.f27358v, 0, i5);
            }
            return gF2Vector;
        }
        throw new ArithmeticException("invalid length");
    ...
    public GF2Vector extractVector(int[] iArr) {
        ...
        if (iArr[length - 1] <= this.length) {
            ...
            for (int i = 0; i < length; i++) {
                if ((this.f27358v[iArr[i] >> 5] & (1 << (iArr[i] & 31))) != 0) {
                    int[] iArr2 = gF2Vector.f27358v;
                    int i2 = i >> 5;
    ...
    public int getBit(int i) {
        if (i < this.length) {
            int i2 = i >> 5;
            int i3 = i & 31;
            return (this.f27358v[i2] & (1 << i3)) >>> i3;
        }
    ...
    public byte[] getEncoded() {
        return LittleEndianConversions.toByteArray(this.f27358v, (this.length + 7) >> 3);
    }
    ...
    @Override // org.bouncycastle.pqc.legacy.math.linearalgebra.Vector
    public int hashCode() {
        return (this.length * 31) + Arrays.hashCode(this.f27358v);
    }

    @Override // org.bouncycastle.pqc.legacy.math.linearalgebra.Vector
    public boolean isZero() {
        for (int length = this.f27358v.length - 1; length >= 0; length--) {
            if (this.f27358v[length] != 0) {
                return false;
            }
        }
        return true;
    ...
    public Vector multiply(Permutation permutation) {
        ...
        if (this.length == vector.length) {
            ...
            for (int i = 0; i < vector.length; i++) {
                if ((this.f27358v[vector[i] >> 5] & (1 << (vector[i] & 31))) != 0) {
                    int[] iArr = gF2Vector.f27358v;
                    int i2 = i >> 5;
        ...
        if (this.length % degree == 0) {
            ...
            for (int i3 = i - 1; i3 >= 0; i3--) {
                for (int degree2 = gF2mField.getDegree() - 1; degree2 >= 0; degree2--) {
                    if (((this.f27358v[i2 >>> 5] >>> (i2 & 31)) & 1) == 1) {
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.length; i++) {
            ...
            stringBuffer.append((this.f27358v[i >> 5] & (1 << (i & 31))) == 0 ? '0' : '1');
        }
