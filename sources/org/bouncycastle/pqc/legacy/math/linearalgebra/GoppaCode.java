 ...
 */
    ...
    public static class MaMaPe {
        ...
        /* renamed from: h */
        private GF2Matrix f27361h;

        /* renamed from: p */
        private Permutation f27362p;

        /* renamed from: s */
        private GF2Matrix f27363s;

        public MaMaPe(GF2Matrix gF2Matrix, GF2Matrix gF2Matrix2, Permutation permutation) {
            this.f27363s = gF2Matrix;
            this.f27361h = gF2Matrix2;
            this.f27362p = permutation;
        }
 ...
 */
    ...
    public static class MatrixSet {
        ...
        /* renamed from: g */
        private GF2Matrix f27364g;
        private int[] setJ;

        public MatrixSet(GF2Matrix gF2Matrix, int[] iArr) {
            this.f27364g = gF2Matrix;
            this.setJ = iArr;
        }
