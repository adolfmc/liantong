...
public class GMSSKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    private AsymmetricCipherKeyPair genKeyPair() {
        ...
        while (true) {
            ...
            treehashArr[i4] = new Treehash[iArr[i4] - this.f27290K[i4]];
            if (i4 > 0) {
                int i5 = i4 - 1;
                bArr4[i5] = (byte[][]) Array.newInstance(byte.class, iArr[i4], this.mdLength);
                treehashArr2[i5] = new Treehash[this.heightOfTrees[i4] - this.f27290K[i4]];
            }
        ...
        while (i7 >= 0) {
            ...
            GMSSRootCalc generateCurrentAuthpathAndRoot = generateCurrentAuthpathAndRoot(bArr, vector, bArr2, i7);
            int i8 = 0;
        ...
        return new AsymmetricCipherKeyPair((AsymmetricKeyParameter) new GMSSPublicKeyParameters(bArr5[0], this.gmssPS), (AsymmetricKeyParameter) new GMSSPrivateKeyParameters(this.currentSeeds, this.nextNextSeeds, bArr9, bArr4, treehashArr, treehashArr2, vectorArr5, vectorArr2, vectorArr3, vectorArr4, bArr8, this.currentRootSigs, this.gmssPS, this.digestProvider));
    }
    ...
    private GMSSRootCalc generateCurrentAuthpathAndRoot(byte[] bArr, Vector vector, byte[] bArr2, int i) {
        ...
        GMSSRootCalc gMSSRootCalc = new GMSSRootCalc(this.heightOfTrees[i], this.f27290K[i], this.digestProvider);
        ...
        while (true) {
            ...
            if (i5 == i4 && i3 < iArr[i] - this.f27290K[i]) {
    ...
    private GMSSRootCalc generateNextAuthpathAndRoot(Vector vector, byte[] bArr, int i) {
        ...
        while (true) {
            ...
            if (i2 == i3 && i4 < iArr[i] - this.f27290K[i]) {
