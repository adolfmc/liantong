...
class HQCKeccakRandomGenerator {
    ...
    private void KeccakIncAbsorb(byte[] bArr, int i) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                jArr = this.state;
                if (j3 < j2 - jArr[c]) {
                    int i6 = ((int) (jArr[c] + j3)) >> 3;
                    jArr[i6] = jArr[i6] ^ ((bArr[i5 + i4] & 255) << ((int) (((jArr[c] + j3) & 7) * 8)));
                    i5++;
                    c = 25;
                }
            }
        ...
        while (i7 < i3) {
            ...
            long j4 = i7;
            int i8 = ((int) (jArr2[c3] + j4)) >> 3;
            jArr2[i8] = ((bArr[i7 + i4] & 255) << ((int) (((jArr2[c3] + j4) & 7) * 8))) ^ jArr2[i8];
            i7++;
            c3 = 25;
        }
    ...
    private void KeccakIncFinalize(int i) {
        ...
        jArr[i2] = jArr[i2] ^ ((i & 4294967295L) << ((int) ((jArr[25] & 7) * 8)));
    ...
    private void KeccakIncSqueeze(byte[] bArr, int i) {
        ...
        while (i3 < i) {
            ...
            long j2 = i2;
            bArr[i3] = (byte) (jArr[(int) (((j2 - jArr[25]) + j) >> 3)] >> ((int) ((7 & ((j2 - jArr[25]) + j)) * 8)));
            i3++;
        }
        int i4 = i - i3;
        long[] jArr2 = this.state;
    ...
    private void KeccakPermutation(long[] jArr) {
        ...
        while (i < 24) {
            ...
            long j115 = j101 ^ ((~j88) & j103);
            long j116 = ((~j103) & j87) ^ j88;
            j39 = j85 ^ ((~j107) & j93);
