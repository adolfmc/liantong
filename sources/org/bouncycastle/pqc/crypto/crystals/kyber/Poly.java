...
public class Poly {
    ...
    public byte[] compressPoly() {
        ...
        if (i2 == 128) {
            ...
            while (i3 < 32) {
                int i5 = 0;
                while (i5 < i) {
                    bArr[i5] = (byte) ((((getCoeffIndex((i3 * 8) + i5) << 4) + 1664) / 3329) & 15);
                    i5++;
                    i = 8;
                }
            ...
            for (int i8 = 32; i6 < i8; i8 = 32) {
                for (int i9 = 0; i9 < 8; i9++) {
                    bArr[i9] = (byte) ((((getCoeffIndex((i6 * 8) + i9) << 5) + 1664) / 3329) & 31);
                }
    ...
    public void decompressPoly(byte[] bArr) {
        if (this.engine.getKyberPolyCompressedBytes() == 128) {
            ...
            for (int i2 = 0; i2 < 128; i2++) {
                int i3 = i2 * 2;
                setCoeffIndex(i3 + 0, (short) (((((short) ((bArr[i] & 255) & 15)) * 3329) + 8) >> 4));
            ...
            for (int i5 = 0; i5 < 32; i5++) {
                int i6 = i4 + 0;
                bArr2[0] = (byte) ((bArr[i6] & 255) >> 0);
                int i7 = i4 + 1;
                bArr2[1] = (byte) (((bArr[i6] & 255) >> 5) | ((bArr[i7] & 255) << 3));
                bArr2[2] = (byte) ((bArr[i7] & 255) >> 2);
                int i8 = i4 + 2;
                bArr2[3] = (byte) (((bArr[i7] & 255) >> 7) | ((bArr[i8] & 255) << 1));
                int i9 = i4 + 3;
                bArr2[4] = (byte) (((bArr[i8] & 255) >> 4) | ((bArr[i9] & 255) << 4));
                ...
                for (int i11 = 0; i11 < 8; i11++) {
                    setCoeffIndex((i5 * 8) + i11, (short) ((((bArr2[i11] & 31) * 3329) + 16) >> 5));
                }
            }
        }
    }
    ...
    public void fromBytes(byte[] bArr) {
        ...
        for (int i2 = 0; i2 < 128; i2++) {
            int i3 = i2 * 2;
            int i4 = i2 * 3;
            setCoeffIndex(i3, (short) ((((bArr[i4 + 0] & 255) >> 0) | ((bArr[i4 + 1] & 255) << 8)) & 4095));
            setCoeffIndex(i3 + 1, (short) ((((bArr[i] & 255) >> 4) | ((bArr[i4 + 2] & 255) << 4)) & 4095));
        }
    }
    ...
    public byte[] toMsg() {
        ...
        for (int i = 0; i < 32; i++) {
            bArr[i] = 0;
            for (int i2 = 0; i2 < 8; i2++) {
                bArr[i] = (byte) (((byte) (((short) (((((short) (getCoeffIndex((i * 8) + i2) << 1)) + 1664) / 3329) & 1)) << i2)) | bArr[i]);
            }
        }
        return bArr;
    }
