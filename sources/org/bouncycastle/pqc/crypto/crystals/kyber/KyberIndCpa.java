...
public class KyberIndCpa {
    ...
    public KyberIndCpa(KyberEngine kyberEngine) {
        ...
        this.KyberGenerateMatrixNBlocks = (this.symmetric.xofBlockBytes + 472) / this.symmetric.xofBlockBytes;
    }
    ...
    private static int rejectionSampling(Poly poly, int i, int i2, byte[] bArr, int i3) {
        ...
        while (i4 < i2) {
            ...
            int i7 = i5 + 1;
            short s = (short) (((((short) (bArr[i5] & 255)) >> 0) | (((short) (bArr[i7] & 255)) << 8)) & 4095);
            short s2 = (short) (((((short) (bArr[i5 + 2] & 255)) << 4) | (((short) (bArr[i7] & 255)) >> 4)) & 4095);
            if (s < 3329) {
