    ...
    private void cbd(short[] sArr, byte[] bArr, int i) {
        ...
        if (this.engine.getSABER_MU() == 6) {
            for (int i2 = 0; i2 < this.SABER_N / 4; i2++) {
                ...
                iArr2[3] = i3 >>> 21;
                int i5 = i2 * 4;
                sArr[i5 + 0] = (short) (iArr[0] - iArr2[0]);
                sArr[i5 + 1] = (short) (iArr[1] - iArr2[1]);
                sArr[i5 + 2] = (short) (iArr[2] - iArr2[2]);
                sArr[i5 + 3] = (short) (iArr[3] - iArr2[3]);
            }
            ...
            for (int i6 = 0; i6 < this.SABER_N / 4; i6++) {
                ...
                iArr[3] = (i8 >>> 24) & 15;
                iArr2[3] = i8 >>> 28;
                sArr[i7 + 0] = (short) (iArr[0] - iArr2[0]);
                sArr[i7 + 1] = (short) (iArr[1] - iArr2[1]);
                sArr[i7 + 2] = (short) (iArr[2] - iArr2[2]);
                sArr[i7 + 3] = (short) (iArr[3] - iArr2[3]);
            }
            ...
            for (int i10 = 0; i10 < this.SABER_N / 4; i10++) {
                ...
                iArr2[3] = (int) (j >>> 35);
                int i12 = i10 * 4;
                sArr[i12 + 0] = (short) (iArr[0] - iArr2[0]);
                sArr[i12 + 1] = (short) (iArr[1] - iArr2[1]);
                sArr[i12 + 2] = (short) (iArr[2] - iArr2[2]);
                sArr[i12 + 3] = (short) (iArr[3] - iArr2[3]);
            }
        }
    }
    ...
    public void MatrixVectorMul(short[][][] sArr, short[][] sArr2, short[][] sArr3, int i) {
        ...
        for (int i2 = 0; i2 < this.SABER_L; i2++) {
            for (int i3 = 0; i3 < this.SABER_L; i3++) {
                ...
                poly_mul_acc(sArr4, sArr5, sArr6);
            }
        }
    }
}
