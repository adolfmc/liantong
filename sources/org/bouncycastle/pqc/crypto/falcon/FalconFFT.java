...
class FalconFFT {
        ...
        while (i8 < i3) {
            ...
            while (i11 < i10) {
                ...
                for (int i15 = i12 + i9; i14 < i15; i15 = i15) {
                    ...
                    FalconFPR falconFPR5 = FPC_MUL.f27135re;
                    FalconFPR falconFPR6 = FPC_MUL.f27134im;
                    int i22 = i10;
                    ComplexNumberWrapper FPC_ADD = FPC_ADD(falconFPR3, falconFPR4, falconFPR5, falconFPR6);
                    falconFPRArr[i16] = FPC_ADD.f27135re;
                    falconFPRArr[i17] = FPC_ADD.f27134im;
                    ComplexNumberWrapper FPC_SUB = FPC_SUB(falconFPR3, falconFPR4, falconFPR5, falconFPR6);
                    falconFPRArr[i18] = FPC_SUB.f27135re;
                    falconFPRArr[i20] = FPC_SUB.f27134im;
                    i14++;
                    i9 = i19;
                    i5 = i21;
                    i10 = i22;
        ...
        while (true) {
            ...
            while (i3 < i6) {
                ...
                for (int i14 = i3 + i8; i13 < i14; i14 = i14) {
                    ...
                    falconFPRArr[i15] = FPC_ADD.f27135re;
                    falconFPRArr[i16] = FPC_ADD.f27134im;
                    ComplexNumberWrapper FPC_SUB = FPC_SUB(falconFPR2, falconFPR3, falconFPR4, falconFPR5);
                    ComplexNumberWrapper FPC_MUL = FPC_MUL(FPC_SUB.f27135re, FPC_SUB.f27134im, falconFPR, fpr_neg);
                    falconFPRArr[i17] = FPC_MUL.f27135re;
                    falconFPRArr[i19] = FPC_MUL.f27134im;
                    i13++;
                    i9 = i18;
                    i6 = i20;
                    i8 = i21;
    ...
    public void poly_LDL_fft(FalconFPR[] falconFPRArr, int i, FalconFPR[] falconFPRArr2, int i2, FalconFPR[] falconFPRArr3, int i3, int i4) {
        ...
        for (int i6 = 0; i6 < i5; i6++) {
            ...
            FalconFPR falconFPR7 = FPC_DIV.f27135re;
            FalconFPR falconFPR8 = FPC_DIV.f27134im;
            ComplexNumberWrapper FPC_MUL = FPC_MUL(falconFPR7, falconFPR8, falconFPR3, this.fpr.fpr_neg(falconFPR4));
            ComplexNumberWrapper FPC_SUB = FPC_SUB(falconFPR5, falconFPR6, FPC_MUL.f27135re, FPC_MUL.f27134im);
            falconFPRArr3[i10] = FPC_SUB.f27135re;
            falconFPRArr3[i11] = FPC_SUB.f27134im;
    ...
    public void poly_LDLmv_fft(FalconFPR[] falconFPRArr, int i, FalconFPR[] falconFPRArr2, int i2, FalconFPR[] falconFPRArr3, int i3, FalconFPR[] falconFPRArr4, int i4, FalconFPR[] falconFPRArr5, int i5, int i6) {
        ...
        for (int i8 = 0; i8 < i7; i8++) {
            ...
            ComplexNumberWrapper FPC_SUB = FPC_SUB(falconFPR5, falconFPR6, FPC_MUL.f27135re, FPC_MUL.f27134im);
            int i12 = i + i8;
            falconFPRArr[i12] = FPC_SUB.f27135re;
            falconFPRArr[i12 + i7] = FPC_SUB.f27134im;
            int i13 = i2 + i8;
    ...
    public void poly_add_muladj_fft(FalconFPR[] falconFPRArr, int i, FalconFPR[] falconFPRArr2, int i2, FalconFPR[] falconFPRArr3, int i3, FalconFPR[] falconFPRArr4, int i4, FalconFPR[] falconFPRArr5, int i5, int i6) {
        ...
        for (int i8 = 0; i8 < i7; i8++) {
            ...
            FalconFPR falconFPR9 = FPC_MUL.f27135re;
            FalconFPR falconFPR10 = FPC_MUL.f27134im;
            ComplexNumberWrapper FPC_MUL2 = FPC_MUL(falconFPR3, falconFPR4, falconFPR7, this.fpr.fpr_neg(falconFPR8));
            FalconFPR falconFPR11 = FPC_MUL2.f27135re;
            FalconFPR falconFPR12 = FPC_MUL2.f27134im;
            int i13 = i + i8;
    ...
    void poly_div_fft(FalconFPR[] falconFPRArr, int i, FalconFPR[] falconFPRArr2, int i2, int i3) {
        ...
        for (int i5 = 0; i5 < i4; i5++) {
            ...
            falconFPRArr[i6] = FPC_DIV.f27135re;
            falconFPRArr[i7] = FPC_DIV.f27134im;
        }
    }
    ...
    public void poly_merge_fft(FalconFPR[] falconFPRArr, int i, FalconFPR[] falconFPRArr2, int i2, FalconFPR[] falconFPRArr3, int i3, int i4) {
        ...
        for (int i7 = 0; i7 < i6; i7++) {
            ...
            FalconFPR falconFPR3 = FPC_MUL.f27135re;
            FalconFPR falconFPR4 = FPC_MUL.f27134im;
            ComplexNumberWrapper FPC_ADD = FPC_ADD(falconFPR, falconFPR2, falconFPR3, falconFPR4);
            FalconFPR falconFPR5 = FPC_ADD.f27135re;
            FalconFPR falconFPR6 = FPC_ADD.f27134im;
            int i11 = (i7 << 1) + i;
            int i12 = i11 + 0;
            ...
            FalconFPR falconFPR7 = FPC_SUB.f27135re;
            FalconFPR falconFPR8 = FPC_SUB.f27134im;
            int i13 = i11 + 1;
    ...
    public void poly_mul_fft(FalconFPR[] falconFPRArr, int i, FalconFPR[] falconFPRArr2, int i2, int i3) {
        ...
        for (int i5 = 0; i5 < i4; i5++) {
            ...
            falconFPRArr[i6] = FPC_MUL.f27135re;
            falconFPRArr[i7] = FPC_MUL.f27134im;
        }
    }
    ...
    public void poly_split_fft(FalconFPR[] falconFPRArr, int i, FalconFPR[] falconFPRArr2, int i2, FalconFPR[] falconFPRArr3, int i3, int i4) {
        ...
        for (int i7 = 0; i7 < i6; i7++) {
            ...
            FalconFPR falconFPR10 = FPC_MUL.f27135re;
            FalconFPR falconFPR11 = FPC_MUL.f27134im;
            int i13 = i2 + i7;
