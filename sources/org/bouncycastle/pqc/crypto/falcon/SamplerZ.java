...
class SamplerZ {
    ...
    int gaussian0_sampler(FalconRNG falconRNG) {
        ...
        int prng_get_u8 = ((falconRNG.prng_get_u8() & 255) << 16) | ((int) (prng_get_u64 >>> 48));
        int i3 = 0;
        for (int i4 = 0; i4 < iArr.length; i4 += 3) {
            i3 += ((prng_get_u8 - iArr[i4 + 0]) - (((i2 - iArr[i4 + 1]) - ((i - iArr[i4 + 2]) >>> 31)) >>> 31)) >>> 31;
        }
        return i3;
    }
    ...
    int sampler(SamplerCtx samplerCtx, FalconFPR falconFPR, FalconFPR falconFPR2) {
        ...
        do {
            gaussian0_sampler = gaussian0_sampler(samplerCtx.f27153p);
            int prng_get_u8 = samplerCtx.f27153p.prng_get_u8() & 255 & 1;
            ...
            fPREngine = this.fpr;
        } while (BerExp(samplerCtx.f27153p, fPREngine.fpr_sub(fpr_mul, fPREngine.fpr_mul(fPREngine.fpr_of(gaussian0_sampler * gaussian0_sampler), this.fpr.fpr_inv_2sqrsigma0)), fpr_mul2) == 0);
        return fpr_floor + i;
    }
}
