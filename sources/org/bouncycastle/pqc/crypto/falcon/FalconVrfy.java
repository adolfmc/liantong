...
class FalconVrfy {
    ...
    /* renamed from: Q */
    final int f27148Q = 12289;
    final int Q0I = 12287;

    /* renamed from: R */
    final int f27149R = 4091;

    /* renamed from: R2 */
    final int f27150R2 = 10952;
    ...
    public int complete_private(byte[] bArr, int i, byte[] bArr2, int i2, byte[] bArr3, int i3, byte[] bArr4, int i4, int i5, short[] sArr, int i6) {
        ...
        for (int i11 = 0; i11 < i7; i11++) {
            ...
            int i13 = i6 + i11;
            sArr[i13] = (short) mq_div_12289(sArr[i13], sArr[i12]);
        }
        mq_iNTT(sArr, i6, i5);
        for (int i14 = 0; i14 < i7; i14++) {
            int i15 = sArr[i6 + i14] & 65535;
            int i16 = i15 - ((~(-((i15 - 6144) >>> 31))) & 12289);
            if (i16 < -127 || i16 > 127) {
                return 0;
            }
            bArr[i + i14] = (byte) i16;
    ...
    public int compute_public(short[] sArr, int i, byte[] bArr, int i2, byte[] bArr2, int i3, int i4, short[] sArr2, int i5) {
        ...
        for (int i8 = 0; i8 < i6; i8++) {
            ...
            int i10 = i + i8;
            sArr[i10] = (short) mq_div_12289(sArr[i10], sArr2[i9]);
        }
        mq_iNTT(sArr, i, i4);
        return 1;
    }
    ...
    int verify_recover(short[] sArr, int i, short[] sArr2, int i2, short[] sArr3, int i3, short[] sArr4, int i4, int i5, short[] sArr5, int i6) {
        ...
        for (int i10 = 0; i10 < i7; i10++) {
            int i11 = i6 + i10;
            i9 |= (sArr5[i11] & 65535) - 1;
            int i12 = i + i10;
            sArr[i12] = (short) mq_div_12289(sArr[i12] & 65535, sArr5[i11] & 65535);
        }
        mq_iNTT(sArr, i, i5);
