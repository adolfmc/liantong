...
class FalconKeyGen {
    ...
    public void keygen(SHAKE256 shake256, byte[] bArr, int i, byte[] bArr2, int i2, byte[] bArr3, int i3, byte[] bArr4, int i4, short[] sArr, int i5, int i6) {
        ...
        while (true) {
            ...
            for (int i14 = 0; i14 < mkn; i14++) {
                int i15 = i10 + i14;
                if (bArr[i15] < i13 && bArr[i15] > (i9 = -i13)) {
                    int i16 = i11 + i14;
                    if (bArr5[i16] < i13 && bArr5[i16] > i9) {
                    }
                }
                i13 = -1;
                break;
            ...
            if (i13 >= 0) {
                ...
                if ((((-((poly_small_sqnorm | poly_small_sqnorm2) >>> 31)) | (poly_small_sqnorm + poly_small_sqnorm2)) & 4294967295L) < 16823) {
                    ...
                    poly_small_to_fp(falconFPRArr, i17, bArr2, i2, i6);
                    this.fft.FFT(falconFPRArr, 0, i12);
                    this.fft.FFT(falconFPRArr, i17, i12);
                    this.fft.poly_invnorm2_fft(falconFPRArr, i18, falconFPRArr, 0, falconFPRArr, i17, i6);
                    this.fft.poly_adj_fft(falconFPRArr, 0, i12);
                    this.fft.poly_adj_fft(falconFPRArr, i17, i12);
                    this.fft.poly_mulconst(falconFPRArr, 0, this.fpr.fpr_q, i12);
                    this.fft.poly_mulconst(falconFPRArr, i17, this.fpr.fpr_q, i12);
                    this.fft.poly_mul_autoadj_fft(falconFPRArr, 0, falconFPRArr, i18, i6);
                    this.fft.poly_mul_autoadj_fft(falconFPRArr, i17, falconFPRArr, i18, i6);
                    this.fft.iFFT(falconFPRArr, 0, i12);
                    this.fft.iFFT(falconFPRArr, i17, i12);
                    FalconFPR falconFPR = this.fpr.fpr_zero;
                    for (int i19 = 0; i19 < mkn; i19++) {
                        FPREngine fPREngine = this.fpr;
                        FalconFPR fpr_add = fPREngine.fpr_add(falconFPR, fPREngine.fpr_sqr(falconFPRArr[0 + i19]));
                        FPREngine fPREngine2 = this.fpr;
                        falconFPR = fPREngine2.fpr_add(fpr_add, fPREngine2.fpr_sqr(falconFPRArr[i17 + i19]));
                    }
                    ...
                    if (fPREngine3.fpr_lt(falconFPR, fPREngine3.fpr_bnorm_max)) {
                        ...
                        int i20 = mkn;
                        int i21 = i12;
                        if (this.vrfy.compute_public(sArr2, i7, bArr, i, bArr2, i2, i6, sArr3, i8) != 0) {
                            if (solve_NTRU(i6, bArr3, i3, bArr4, i4, bArr, i, bArr2, i2, (1 << (this.codec.max_FG_bits[i21] - 1)) - 1, new int[i21 > 2 ? i20 * 28 : i20 * 28 * 3], 0) != 0) {
                                return;
                            }
                        }
                        i10 = i;
    ...
    void make_fg(int[] iArr, int i, byte[] bArr, int i2, byte[] bArr2, int i3, int i4, int i5, int i6) {
        int mkn = mkn(i4);
        int i7 = i + mkn;
        FalconSmallPrimeList falconSmallPrimeList = this.primes;
        FalconSmallPrime[] falconSmallPrimeArr = FalconSmallPrimeList.PRIMES;
        int i8 = falconSmallPrimeArr[0].f27146p;
        ...
        int i12 = falconSmallPrimeArr[0].f27146p;
        int modp_ninv31 = modp_ninv31(i12);
        int i13 = i7 + mkn;
        modp_mkgm2(iArr, i13, iArr, i13 + mkn, i4, falconSmallPrimeArr[0].f27145g, i12, modp_ninv31);
    ...
    void make_fg_step(int[] iArr, int i, int i2, int i3, int i4, int i5) {
        ...
        int i25 = 0;
        while (i25 < i15) {
            int i26 = falconSmallPrimeArr[i25].f27146p;
            int modp_ninv31 = modp_ninv31(i26);
            int modp_R2 = modp_R2(i26, modp_ninv31);
            int i27 = i25;
            int i28 = i19;
            int i29 = i16;
            modp_mkgm2(iArr, i22, iArr, i23, i2, falconSmallPrimeArr[i25].f27145g, i26, modp_ninv31);
            int i30 = i28 + i27;
            int i31 = i30;
            int i32 = 0;
            while (i32 < i13) {
        ...
        zint_rebuild_CRT(iArr, i21, i55, i55, i13, falconSmallPrimeArr, 1, iArr, i22);
        int i56 = i55;
        while (i56 < i54) {
            int i57 = falconSmallPrimeArr[i56].f27146p;
            int modp_ninv312 = modp_ninv31(i57);
            int modp_R22 = modp_R2(i57, modp_ninv312);
            int i58 = i55;
            int modp_Rx = modp_Rx(i58, i57, modp_ninv312, modp_R22);
            int i59 = i56;
            modp_mkgm2(iArr, i22, iArr, i23, i2, falconSmallPrimeArr[i56].f27145g, i57, modp_ninv312);
            int i60 = 0;
            int i61 = i53;
            while (i60 < i13) {
            ...
            if (i5 == 0) {
                int i79 = i2 - 1;
                modp_iNTT2_ext(iArr, i62, i54, iArr, i23, i79, i74, i73);
                modp_iNTT2_ext(iArr, i75, i54, iArr, i23, i79, i74, i73);
            }
            i56 = i59 + 1;
            i55 = i58;
        }
    ...
    int mkgauss(SHAKE256 shake256, int i) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            int i6 = 0;
            int i7 = (int) (((j & Long.MAX_VALUE) - this.gauss_1024_12289[0]) >>> 63);
            int i8 = 1;
            while (true) {
                long[] jArr = this.gauss_1024_12289;
                if (i8 < jArr.length) {
                    int i9 = ((int) ((j2 - jArr[i8]) >>> 63)) ^ 1;
                    i6 |= (-((i7 ^ 1) & i9)) & i8;
                    i7 |= i9;
                    i8++;
                }
        ...
        while (i7 < mkn) {
            ...
            while (i10 < i7) {
                ...
                while (i16 < i9) {
                    ...
                    iArr[i15] = modp_add(i17, modp_montymul, i5);
                    iArr[i14] = modp_sub(i17, modp_montymul, i5);
                    i16++;
                    i15 += i2;
                    i14 += i2;
                }
        ...
        while (i7 > 1) {
            ...
            while (i10 < i7) {
                ...
                while (i16 < i8) {
                    int i17 = iArr[i15];
                    int i18 = iArr[i14];
                    iArr[i15] = modp_add(i17, i18, i5);
                    iArr[i14] = modp_montymul(modp_sub(i17, i18, i5), i12, i5, i6);
                    i16++;
                    i15 += i2;
                    i14 += i2;
                }
    ...
    void poly_sub_scaled_ntt(int[] iArr, int i, int i2, int i3, int[] iArr2, int i4, int i5, int i6, int[] iArr3, int i7, int i8, int i9, int i10, int[] iArr4, int i11) {
        ...
        int i15 = 0;
        while (i15 < i13) {
            int i16 = falconSmallPrimeArr[i15].f27146p;
            int modp_ninv31 = modp_ninv31(i16);
            int modp_R2 = modp_R2(i16, modp_ninv31);
            int modp_Rx = modp_Rx(i12, i16, modp_ninv31, modp_R2);
            int i17 = i15;
            modp_mkgm2(iArr4, i11, iArr4, mkn2, i10, falconSmallPrimeArr[i15].f27145g, i16, modp_ninv31);
    ...
    int solve_NTRU(int i, byte[] bArr, int i2, byte[] bArr2, int i3, byte[] bArr3, int i4, byte[] bArr4, int i5, int i6, int[] iArr, int i7) {
        ...
        if (poly_big_to_small(bArr, i2, iArr, i7, i6, i) != 0) {
            ...
            if (poly_big_to_small(bArr5, i8, iArr, i13, i6, i) != 0) {
                ...
                FalconSmallPrimeList falconSmallPrimeList = this.primes;
                FalconSmallPrime[] falconSmallPrimeArr = FalconSmallPrimeList.PRIMES;
                int i17 = falconSmallPrimeArr[0].f27146p;
                int modp_ninv31 = modp_ninv31(i17);
                modp_mkgm2(iArr, i16, iArr, i7, i, falconSmallPrimeArr[0].f27145g, i17, modp_ninv31);
                for (int i18 = 0; i18 < mkn; i18++) {
                    iArr[i7 + i18] = modp_set(bArr5[i8 + i18], i17);
                }
                for (int i19 = 0; i19 < mkn; i19++) {
                    iArr[i13 + i19] = modp_set(bArr3[i4 + i19], i17);
                    iArr[i14 + i19] = modp_set(bArr4[i5 + i19], i17);
                    iArr[i15 + i19] = modp_set(bArr[i2 + i19], i17);
                }
                modp_NTT2(iArr, i13, iArr, i16, i, i17, modp_ninv31);
                modp_NTT2(iArr, i14, iArr, i16, i, i17, modp_ninv31);
                modp_NTT2(iArr, i15, iArr, i16, i, i17, modp_ninv31);
                modp_NTT2(iArr, i7, iArr, i16, i, i17, modp_ninv31);
                int modp_montymul = modp_montymul(12289, 1, i17, modp_ninv31);
                for (int i20 = 0; i20 < mkn; i20++) {
                    if (modp_sub(modp_montymul(iArr[i13 + i20], iArr[i7 + i20], i17, modp_ninv31), modp_montymul(iArr[i14 + i20], iArr[i15 + i20], i17, modp_ninv31), i17) != modp_montymul) {
                        return 0;
                    }
                }
                return 1;
    ...
    int solve_NTRU_binary_depth0(int i, byte[] bArr, int i2, byte[] bArr2, int i3, int[] iArr, int i4) {
        ...
        int i7 = i6 >> 1;
        FalconSmallPrimeList falconSmallPrimeList = this.primes;
        int i8 = FalconSmallPrimeList.PRIMES[0].f27146p;
        ...
        int i12 = i11 + i6;
        int i13 = i12 + i6;
        FalconSmallPrimeList falconSmallPrimeList2 = this.primes;
        int i14 = modp_ninv31;
        modp_mkgm2(iArr, i12, iArr, i13, i, FalconSmallPrimeList.PRIMES[0].f27145g, i8, i14);
        ...
        int i42 = i41 + i37;
        int i43 = i42 + i37;
        FalconSmallPrimeList falconSmallPrimeList3 = this.primes;
        modp_mkgm2(iArr, i39, iArr, i40, i, FalconSmallPrimeList.PRIMES[0].f27145g, i8, i36);
        ...
        FalconSmallPrimeList falconSmallPrimeList4 = this.primes;
        modp_mkgm2(iArr, i39, iArr, i42, i, FalconSmallPrimeList.PRIMES[0].f27145g, i8, i36);
        ...
        FalconSmallPrimeList falconSmallPrimeList5 = this.primes;
        modp_mkgm2(iArr, i40, iArr, i41, i, FalconSmallPrimeList.PRIMES[0].f27145g, i8, i36);
    ...
    int solve_NTRU_binary_depth1(int i, byte[] bArr, int i2, byte[] bArr2, int i3, int[] iArr, int i4) {
        ...
        int i19 = 0;
        while (i19 < i13) {
            FalconSmallPrimeList falconSmallPrimeList = falconKeyGen.primes;
            int i20 = FalconSmallPrimeList.PRIMES[i19].f27146p;
            int modp_ninv31 = falconKeyGen.modp_ninv31(i20);
            int i21 = i8;
            int modp_R2 = falconKeyGen.modp_R2(i20, modp_ninv31);
            int modp_Rx = falconKeyGen.modp_Rx(i12, i20, modp_ninv31, modp_R2);
            int i22 = i16 + i19;
            int i23 = i7;
            int i24 = i15;
            int i25 = i18 + i19;
            ...
            while (i26 < i10) {
                ...
                int i30 = i13;
                int i31 = i12;
                iArr[i22] = zint_mod_small_signed(iArr, i27, i12, i28, modp_ninv31, modp_R2, modp_Rx);
                iArr[i25] = zint_mod_small_signed(iArr, i24, i31, i28, modp_ninv31, modp_R2, modp_Rx);
                i26++;
                i27 += i31;
                i24 += i31;
                i22 += i30;
        ...
        int i36 = i8;
        int i37 = i13;
        System.arraycopy(iArr, i16, iArr, i6, i32);
        int i38 = i6 + i32;
        System.arraycopy(iArr, i18, iArr, i38, i32);
        int i39 = i32 + i38;
        int i40 = i11;
        int i41 = i40 * i35;
        int i42 = i39 + i41;
        ...
        while (i44 < i37) {
            FalconSmallPrimeList falconSmallPrimeList2 = this.primes;
            int i45 = FalconSmallPrimeList.PRIMES[i44].f27146p;
            int modp_ninv312 = modp_ninv31(i45);
            int modp_R22 = modp_R2(i45, modp_ninv312);
            int i46 = i43 + i34;
            int i47 = i46 + i35;
            int i48 = i47 + i34;
            FalconSmallPrimeList falconSmallPrimeList3 = this.primes;
            ...
            int i58 = i33;
            int i59 = i37;
            modp_mkgm2(iArr, i43, iArr, i46, i, FalconSmallPrimeList.PRIMES[i44].f27145g, i53, i52);
            int i60 = i34;
            for (int i61 = 0; i61 < i60; i61++) {
                iArr[i47 + i61] = modp_set(bArr[i2 + i61], i53);
                iArr[i48 + i61] = modp_set(bArr2[i3 + i61], i53);
            }
            modp_NTT2(iArr, i47, iArr, i43, i, i53, i52);
            modp_NTT2(iArr, i48, iArr, i43, i, i53, i52);
            int i62 = i;
            int i63 = i36;
            while (i62 > i63) {
                int i64 = i62;
                modp_poly_rec_res(iArr, i47, i62, i53, i52, i51);
                modp_poly_rec_res(iArr, i48, i64, i53, i52, i51);
                i62 = i64 - 1;
            }
            int i65 = i43 + i35;
            int i66 = i35;
            System.arraycopy(iArr, i46, iArr, i65, i66);
            int i67 = i65 + i66;
            System.arraycopy(iArr, i47, iArr, i67, i66);
            int i68 = i67 + i66;
            System.arraycopy(iArr, i48, iArr, i68, i66);
            int i69 = i68 + i66;
            int i70 = i69 + i58;
            int i71 = i6 + i56;
            int i72 = i57 + i56;
            ...
            int i76 = i63 - 1;
            int i77 = i66;
            modp_NTT2(iArr, i69, iArr, i43, i76, i53, i52);
            modp_NTT2(iArr, i70, iArr, i43, i76, i53, i52);
            int i78 = i71;
            int i79 = i72;
            int i80 = 0;
            while (i80 < i58) {
            ...
            if (i56 < i55) {
                ...
                int i102 = 0;
                while (i102 < i5) {
                    iArr[i101] = iArr[i67 + i102];
                    iArr[i100] = iArr[i68 + i102];
                    i102++;
                    i101 += i55;
                    i100 += i55;
                }
        ...
        int i109 = i107 << 1;
        FalconSmallPrimeList falconSmallPrimeList4 = this.primes;
        zint_rebuild_CRT(iArr, i4, i108, i108, i109, FalconSmallPrimeList.PRIMES, 1, iArr, i43);
        FalconSmallPrimeList falconSmallPrimeList5 = this.primes;
        zint_rebuild_CRT(iArr, i103, i40, i40, i109, FalconSmallPrimeList.PRIMES, 1, iArr, i43);
        ...
        System.arraycopy(iArr, i103, iArr, i4, i40 * 2 * i107);
        ...
        poly_big_to_fp(falconFPRArr4, 0, iArr, i4 + i41, i110, i111, i105);
    ...
    /* JADX WARN: Removed duplicated region for block: B:100:0x0499 A[SYNTHETIC] */
    ...
    */
    ...
    void zint_add_scaled_mul_small(int[] iArr, int i, int i2, int[] iArr2, int i3, int i4, int i5, int i6, int i7) {
        ...
        while (i9 < i2) {
            ...
            int i14 = i + i9;
            long unsignedLong = (toUnsignedLong(i10 | ((i13 << i7) & Integer.MAX_VALUE)) * i5) + toUnsignedLong(iArr[i14]) + i11;
    ...
    int zint_bezout(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3, int[] iArr4, int i4, int i5, int[] iArr5, int i6) {
        ...
        while (i16 >= i15) {
            ...
            while (true) {
                ...
                i22 ^= (i22 ^ i26) & i17;
                i17 = i18;
                i18 &= (((i25 | i26) + Integer.MAX_VALUE) >>> 31) - 1;
                i19 = i24;
            }
            int i27 = (i21 & i17) | i20;
            int i28 = ~i17;
            int i29 = i21 & i28;
            long unsignedLong = (falconKeyGen.toUnsignedLong(i23 & i28) << 31) + falconKeyGen.toUnsignedLong(i22 | (i23 & i17));
            int i30 = iArr6[i10 + 0];
            long j = 0;
            int i31 = i16;
            int i32 = iArr6[i11 + 0];
            long unsignedLong2 = (falconKeyGen.toUnsignedLong(i29) << 31) + falconKeyGen.toUnsignedLong(i27);
            long j2 = 0;
            long j3 = 1;
            long j4 = 1;
            int i33 = i30;
            int i34 = 0;
            for (int i35 = 31; i34 < i35; i35 = 31) {
                long j5 = unsignedLong - unsignedLong2;
                int i36 = (int) ((j5 ^ ((unsignedLong2 ^ unsignedLong) & (unsignedLong2 ^ j5))) >>> 63);
                int i37 = (i33 >> i34) & 1;
                int i38 = (i32 >> i34) & 1 & i37;
                int i39 = i9;
                int i40 = i38 & i36;
                int i41 = (~i36) & i38;
                int i42 = (i37 ^ 1) | i40;
                int i43 = i33 - (i32 & (-i40));
                long j6 = unsignedLong2 - ((-falconKeyGen.toUnsignedLong(i40)) & unsignedLong);
                long j7 = -i40;
                long j8 = j3 - (j2 & j7);
                long j9 = j - (j4 & j7);
                int i44 = i32 - ((-i41) & i43);
                long j10 = unsignedLong - (j6 & (-falconKeyGen.toUnsignedLong(i41)));
                long j11 = -i41;
                long j12 = j2 - (j8 & j11);
                long j13 = j4 - (j9 & j11);
                long j14 = i42;
                ...
                j3 = j8 + (j8 & j15);
                j = j9 + (j9 & j15);
                unsignedLong2 = j6 ^ ((j6 ^ (j6 >> 1)) & (-falconKeyGen.toUnsignedLong(i42)));
                i32 = i44 + (i44 & (-i42));
                long j16 = -j14;
                j2 = j12 + (j12 & j16);
                j4 = j13 + (j13 & j16);
                unsignedLong = j10 ^ (((j10 >> 1) ^ j10) & (falconKeyGen.toUnsignedLong(i42) - 1));
                i34++;
                i33 = i43 + ((i42 - 1) & i43);
                i9 = i39;
            }
            ...
            zint_co_reduce_mod(iArr2, i2, iArr5, i45, iArr3, i3, i5, modp_ninv31, j18, j19, j21, j22);
            i16 = i31 - 30;
            falconKeyGen = this;
            iArr6 = iArr5;
            i15 = 30;
        ...
        int i46 = i10;
        int i47 = iArr5[i46 + 0] ^ 1;
        for (int i48 = 1; i48 < i5; i48++) {
            i47 |= iArr5[i46 + i48];
        }
        return (1 - (((-i47) | i47) >>> 31)) & iArr3[i12] & iArr4[i13];
    }
    ...
    void zint_co_reduce_mod(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3, int i4, int i5, long j, long j2, long j3, long j4) {
        ...
        int i7 = i + 0;
        int i8 = i2 + 0;
        int i9 = (((iArr[i7] * ((int) j5)) + (iArr2[i8] * ((int) j6))) * i5) & Integer.MAX_VALUE;
        int i10 = (((iArr[i7] * ((int) j3)) + (iArr2[i8] * ((int) j4))) * i5) & Integer.MAX_VALUE;
        long j7 = 0;
        int i11 = 0;
        long j8 = 0;
        while (i11 < i6) {
    ...
    void zint_norm_zero(int[] iArr, int i, int[] iArr2, int i2, int i3) {
        ...
        while (true) {
            ...
            int i8 = i2 + i7;
            int i9 = ((i5 << 30) | (iArr2[i8] >>> 1)) - iArr[i + i7];
            i4 |= (((-i9) >>> 31) | (-(i9 >>> 31))) & ((i4 & 1) - 1);
            i6 = i7;
            i5 = iArr2[i8] & 1;
        }
    }
    ...
    void zint_rebuild_CRT(int[] iArr, int i, int i2, int i3, int i4, FalconSmallPrime[] falconSmallPrimeArr, int i5, int[] iArr2, int i6) {
        int i7 = 0;
        iArr2[i6 + 0] = falconSmallPrimeArr[0].f27146p;
        int i8 = i2;
        int i9 = 1;
        while (i9 < i8) {
            int i10 = falconSmallPrimeArr[i9].f27146p;
            int i11 = falconSmallPrimeArr[i9].f27147s;
    ...
    void zint_sub_scaled(int[] iArr, int i, int i2, int[] iArr2, int i3, int i4, int i5, int i6) {
        ...
        while (i8 < i2) {
            ...
            int i13 = i + i8;
            int i14 = (iArr[i13] - (i9 | ((i12 << i6) & Integer.MAX_VALUE))) - i10;
