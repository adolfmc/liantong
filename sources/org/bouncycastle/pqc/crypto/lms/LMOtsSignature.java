...
public class LMOtsSignature implements Encodable {
    ...
    /* renamed from: C */
    private final byte[] f27202C;
    private final LMOtsParameters type;

    /* renamed from: y */
    private final byte[] f27203y;
    ...
    public boolean equals(Object obj) {
        ...
        if (lMOtsParameters == null ? lMOtsSignature.type == null : lMOtsParameters.equals(lMOtsSignature.type)) {
            if (Arrays.equals(this.f27202C, lMOtsSignature.f27202C)) {
                return Arrays.equals(this.f27203y, lMOtsSignature.f27203y);
            }
            return false;
        }
        return false;
    ...
    public byte[] getEncoded() throws IOException {
        return Composer.compose().u32str(this.type.getType()).bytes(this.f27202C).bytes(this.f27203y).build();
    }
    ...
    public int hashCode() {
        LMOtsParameters lMOtsParameters = this.type;
        return ((((lMOtsParameters != null ? lMOtsParameters.hashCode() : 0) * 31) + Arrays.hashCode(this.f27202C)) * 31) + Arrays.hashCode(this.f27203y);
    }
}
