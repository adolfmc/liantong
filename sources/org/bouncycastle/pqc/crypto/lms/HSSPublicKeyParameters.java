...
public class HSSPublicKeyParameters extends LMSKeyParameters implements LMSContextBasedVerifier {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f27192l != hSSPublicKeyParameters.f27192l) {
            return false;
        }
    ...
    public byte[] getEncoded() throws IOException {
        return Composer.compose().u32str(this.f27192l).bytes(this.lmsPublicKey.getEncoded()).build();
    }
    ...
    public int hashCode() {
        return (this.f27192l * 31) + this.lmsPublicKey.hashCode();
    }
