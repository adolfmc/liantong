...
public class LMSPublicKeyParameters extends LMSKeyParameters implements LMSContextBasedVerifier {
    ...
    /* renamed from: I */
    private final byte[] f27208I;

    /* renamed from: T1 */
    private final byte[] f27209T1;
    ...
    public LMSPublicKeyParameters(LMSigParameters lMSigParameters, LMOtsParameters lMOtsParameters, byte[] bArr, byte[] bArr2) {
        ...
        this.f27208I = Arrays.clone(bArr2);
        this.f27209T1 = Arrays.clone(bArr);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.parameterSet.equals(lMSPublicKeyParameters.parameterSet) && this.lmOtsType.equals(lMSPublicKeyParameters.lmOtsType) && Arrays.areEqual(this.f27208I, lMSPublicKeyParameters.f27208I)) {
            return Arrays.areEqual(this.f27209T1, lMSPublicKeyParameters.f27209T1);
        }
        return false;
    }
    ...
    public LMSContext generateOtsContext(LMSSignature lMSSignature) {
        ...
        if (lMSSignature.getOtsSignature().getType().getType() == type) {
            return new LMOtsPublicKey(LMOtsParameters.getParametersForType(type), this.f27208I, lMSSignature.getQ(), null).createOtsContext(lMSSignature);
        }
    ...
    public byte[] getI() {
        return Arrays.clone(this.f27208I);
    }
    ...
    public byte[] getT1() {
        return Arrays.clone(this.f27209T1);
    }

    public int hashCode() {
        return (((((this.parameterSet.hashCode() * 31) + this.lmOtsType.hashCode()) * 31) + Arrays.hashCode(this.f27208I)) * 31) + Arrays.hashCode(this.f27209T1);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public boolean matchesT1(byte[] bArr) {
        return Arrays.constantTimeAreEqual(this.f27209T1, bArr);
    }
    ...
    public byte[] toByteArray() {
        return Composer.compose().u32str(this.parameterSet.getType()).u32str(this.lmOtsType.getType()).bytes(this.f27208I).bytes(this.f27209T1).build();
    }
