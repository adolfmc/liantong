...
public class PrivateKeyFactory {
    ...
    public static AsymmetricKeyParameter createKey(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        if (algorithm.m366on(BCObjectIdentifiers.qTESLA)) {
            ...
            } else if (algorithm.m366on(BCObjectIdentifiers.sphincsPlus)) {
            ...
            } else if (algorithm.m366on(BCObjectIdentifiers.picnic)) {
            ...
            } else if (algorithm.m366on(BCObjectIdentifiers.pqc_kem_mceliece)) {
            ...
            } else if (algorithm.m366on(BCObjectIdentifiers.pqc_kem_frodo)) {
            ...
            } else if (algorithm.m366on(BCObjectIdentifiers.pqc_kem_saber)) {
            ...
            } else if (algorithm.m366on(BCObjectIdentifiers.pqc_kem_sike)) {
            ...
            } else if (algorithm.m366on(BCObjectIdentifiers.pqc_kem_ntru)) {
            ...
            } else if (algorithm.m366on(BCObjectIdentifiers.pqc_kem_kyber)) {
            ...
            } else if (algorithm.m366on(BCObjectIdentifiers.pqc_kem_ntrulprime)) {
            ...
            } else if (algorithm.m366on(BCObjectIdentifiers.pqc_kem_sntruprime)) {
            ...
            } else if (algorithm.m366on(BCObjectIdentifiers.pqc_kem_bike)) {
            ...
            } else if (algorithm.m366on(BCObjectIdentifiers.pqc_kem_hqc)) {
