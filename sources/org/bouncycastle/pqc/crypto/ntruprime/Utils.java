    ...
    public static void getOneThirdInverseInRQ(short[] sArr, byte[] bArr, int i, int i2) {
        ...
        for (int i7 = 0; i7 < (i * 2) - 1; i7++) {
            ...
            for (int i9 = 0; i9 < i3; i9++) {
                int i10 = (sArr2[i9] ^ sArr3[i9]) & checkLessThanZero;
                sArr2[i9] = (short) (sArr2[i9] ^ i10);
                sArr3[i9] = (short) (i10 ^ sArr3[i9]);
                int i11 = (sArr5[i9] ^ sArr4[i9]) & checkLessThanZero;
                sArr5[i9] = (short) (sArr5[i9] ^ i11);
                sArr4[i9] = (short) (i11 ^ sArr4[i9]);
            }
            short s = sArr2[0];
            short s2 = sArr3[0];
            for (int i12 = 0; i12 < i3; i12++) {
                sArr3[i12] = (short) getModFreeze((sArr3[i12] * s) - (sArr2[i12] * s2), i2);
            }
            for (int i13 = 0; i13 < i3; i13++) {
                sArr4[i13] = (short) getModFreeze((sArr4[i13] * s) - (sArr5[i13] * s2), i2);
            }
            int i14 = 0;
            while (i14 < i) {
                int i15 = i14 + 1;
    ...
    public static boolean isInvertiblePolynomialInR3(byte[] bArr, byte[] bArr2, int i) {
        ...
        for (int i6 = 0; i6 < (i * 2) - 1; i6++) {
            ...
            for (int i9 = 0; i9 < i2; i9++) {
                int i10 = (bArr3[i9] ^ bArr4[i9]) & checkLessThanZero;
                bArr3[i9] = (byte) (bArr3[i9] ^ i10);
                bArr4[i9] = (byte) (i10 ^ bArr4[i9]);
                int i11 = (bArr6[i9] ^ bArr5[i9]) & checkLessThanZero;
                bArr6[i9] = (byte) (bArr6[i9] ^ i11);
                bArr5[i9] = (byte) (i11 ^ bArr5[i9]);
            }
