 ...
 */
    ...
    /* loaded from: E:\9227576_dexfile_execute.dex */
    public static final class C13540Id extends Evaluator {

        /* renamed from: id */
        private String f27423id;

        public C13540Id(String str) {
            this.f27423id = str;
        }

        @Override // org.jsoup.select.Evaluator
        public boolean matches(Element element, Element element2) {
            return this.f27423id.equals(element2.m210id());
        }

        public String toString() {
            return String.format("#%s", this.f27423id);
        }
    }
 ...
 */
    ...
    public static abstract class CssNthEvaluator extends Evaluator {
        ...
        /* renamed from: a */
        protected final int f27421a;

        /* renamed from: b */
        protected final int f27422b;
        ...
        public boolean matches(Element element, Element element2) {
            ...
            int i = this.f27421a;
            if (i == 0) {
                return calculatePosition == this.f27422b;
            }
            int i2 = this.f27422b;
        ...
        public String toString() {
            return this.f27421a == 0 ? String.format(":%s(%d)", getPseudoClass(), Integer.valueOf(this.f27422b)) : this.f27422b == 0 ? String.format(":%s(%dn)", getPseudoClass(), Integer.valueOf(this.f27421a)) : String.format(":%s(%dn%+d)", getPseudoClass(), Integer.valueOf(this.f27421a), Integer.valueOf(this.f27422b));
        }
    }
