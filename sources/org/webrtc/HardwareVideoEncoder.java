 ...
 */
            ...
            synchronized (this.countLock) {
                ...
                while (this.count > 0) {
                    try {
                        ...
                        Logging.m204e("HardwareVideoEncoder", "Interrupted while waiting on busy count", e);
                        z = true;
                    }
                }
            }
    ...
    public VideoCodecStatus initEncode(VideoEncoder.Settings settings, VideoEncoder.Callback callback) {
        ...
        Logging.m206d("HardwareVideoEncoder", "initEncode: " + this.width + " x " + this.height + ". @ " + settings.startBitrate + "kbps. Fps: " + settings.maxFramerate + " Use surface mode: " + this.useSurfaceMode);
    ...
    private VideoCodecStatus initEncodeInternal() {
        ...
        try {
            ...
            try {
                ...
                if (this.codecType == VideoCodecMimeType.H264) {
                    ...
                    switch (c) {
                        ...
                        case 1:
                            break;
                        default:
                            Logging.m202w("HardwareVideoEncoder", "Unknown profile level id: " + str);
                            break;
                    }
                }
                Logging.m206d("HardwareVideoEncoder", "Format: " + createVideoFormat);
                ...
                Logging.m204e("HardwareVideoEncoder", "initEncodeInternal failed", e);
                release();
                return VideoCodecStatus.FALLBACK_SOFTWARE;
            }
        } catch (IOException | IllegalArgumentException unused) {
            Logging.m205e("HardwareVideoEncoder", "Cannot create media encoder " + this.codecName);
            return VideoCodecStatus.FALLBACK_SOFTWARE;
        }
    }
    ...
    public VideoCodecStatus release() {
        ...
        if (thread == null) {
            ...
            if (!ThreadUtils.joinUninterruptibly(thread, 5000L)) {
                Logging.m205e("HardwareVideoEncoder", "Media encoder release timeout");
                videoCodecStatus = VideoCodecStatus.TIMEOUT;
            } else if (this.shutdownException != null) {
                Logging.m204e("HardwareVideoEncoder", "Media encoder release exception", this.shutdownException);
    ...
    public VideoCodecStatus encode(VideoFrame videoFrame, VideoEncoder.EncodeInfo encodeInfo) {
        ...
        if ((width == this.width && height == this.height && z2 == this.useSurfaceMode) || (resetCodec = resetCodec(width, height, z2)) == VideoCodecStatus.OK) {
            if (this.outputBuilders.size() > 2) {
                Logging.m205e("HardwareVideoEncoder", "Dropped frame, encoder queue full");
    ...
    private VideoCodecStatus encodeTextureBuffer(VideoFrame videoFrame) {
        ...
        try {
            ...
            Logging.m204e("HardwareVideoEncoder", "encodeTexture failed", e);
    ...
    private VideoCodecStatus encodeByteBuffer(VideoFrame videoFrame, VideoFrame.Buffer buffer, int i) {
        ...
        try {
            ...
            if (dequeueInputBuffer == -1) {
                Logging.m206d("HardwareVideoEncoder", "Dropped frame, no input buffers available");
                return VideoCodecStatus.NO_OUTPUT;
            }
            try {
                ...
                try {
                    ...
                    Logging.m204e("HardwareVideoEncoder", "queueInputBuffer failed", e);
                    return VideoCodecStatus.ERROR;
                }
            } catch (IllegalStateException e2) {
                Logging.m204e("HardwareVideoEncoder", "getInputBuffers failed", e2);
                return VideoCodecStatus.ERROR;
            }
        } catch (IllegalStateException e3) {
            Logging.m204e("HardwareVideoEncoder", "dequeueInputBuffer failed", e3);
            return VideoCodecStatus.ERROR;
        }
    }
    ...
    private void requestKeyFrame(long j) {
        ...
        try {
            ...
            Logging.m204e("HardwareVideoEncoder", "requestKeyFrame failed", e);
        }
    }
    ...
    protected void deliverEncodedImage() {
        ...
        try {
            ...
            if ((bufferInfo.flags & 2) != 0) {
                Logging.m206d("HardwareVideoEncoder", "Config frame generated. Offset: " + bufferInfo.offset + ". Size: " + bufferInfo.size);
            ...
            if (z) {
                Logging.m206d("HardwareVideoEncoder", "Sync frame generated");
            }
            if (z && this.codecType == VideoCodecMimeType.H264) {
                Logging.m206d("HardwareVideoEncoder", "Prepending config frame of size " + this.configBuffer.capacity() + " to output buffer with offset " + bufferInfo.offset + ", size " + bufferInfo.size);
            ...
            EncodedImage createEncodedImage = this.outputBuilders.poll().setBuffer(slice, new Runnable() { // from class: org.webrtc.-$$Lambda$HardwareVideoEncoder$F5M8yR9Mkg8WzwHcYIIOdTEImls
            ...
            Logging.m204e("HardwareVideoEncoder", "deliverOutput failed", e);
        }
    }
    ...
    public static /* synthetic */ void lambda$deliverEncodedImage$0(HardwareVideoEncoder hardwareVideoEncoder, int i) {
        try {
            ...
            Logging.m204e("HardwareVideoEncoder", "releaseOutputBuffer failed", e);
        }
    ...
    public void releaseCodecOnOutputThread() {
        this.outputThreadChecker.checkIsOnValidThread();
        Logging.m206d("HardwareVideoEncoder", "Releasing MediaCodec on output thread");
        this.outputBuffersBusyCount.waitForZero();
        try {
            this.codec.stop();
        } catch (Exception e) {
            Logging.m204e("HardwareVideoEncoder", "Media encoder stop failed", e);
        }
        try {
            this.codec.release();
        } catch (Exception e2) {
            Logging.m204e("HardwareVideoEncoder", "Media encoder release failed", e2);
            this.shutdownException = e2;
        }
        this.configBuffer = null;
        Logging.m206d("HardwareVideoEncoder", "Release on output thread done");
    }
    ...
    private VideoCodecStatus updateBitrate() {
        ...
        try {
            ...
            Logging.m204e("HardwareVideoEncoder", "updateBitrate failed", e);
            return VideoCodecStatus.ERROR;
        }
    }
