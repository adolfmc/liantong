...
public final class WebRtcAudioUtils {
    ...
    public static synchronized void setWebRtcBasedAutomaticGainControl(boolean z) {
        synchronized (WebRtcAudioUtils.class) {
            Logging.m202w("WebRtcAudioUtils", "setWebRtcBasedAutomaticGainControl() is deprecated");
        }
    }
    ...
    public static synchronized boolean useWebRtcBasedAcousticEchoCanceler() {
        ...
        synchronized (WebRtcAudioUtils.class) {
            if (useWebRtcBasedAcousticEchoCanceler) {
                Logging.m202w("WebRtcAudioUtils", "Overriding default behavior; now using WebRTC AEC!");
            }
    ...
    public static synchronized boolean useWebRtcBasedNoiseSuppressor() {
        ...
        synchronized (WebRtcAudioUtils.class) {
            if (useWebRtcBasedNoiseSuppressor) {
                Logging.m202w("WebRtcAudioUtils", "Overriding default behavior; now using WebRTC NS!");
            }
    ...
    static void logDeviceInfo(String str) {
        Logging.m206d(str, "Android SDK: " + Build.VERSION.SDK_INT + ", Release: " + Build.VERSION.RELEASE + ", Brand: " + Build.BRAND + ", Device: " + Build.DEVICE + ", Id: " + Build.ID + ", Hardware: " + Build.HARDWARE + ", Manufacturer: " + Build.MANUFACTURER + ", Model: " + Build.MODEL + ", Product: " + Build.PRODUCT);
    }
    ...
    private static void logAudioStateBasic(String str, AudioManager audioManager) {
        Logging.m206d(str, "Audio State: audio mode: " + modeToString(audioManager.getMode()) + ", has mic: " + hasMicrophone() + ", mic muted: " + audioManager.isMicrophoneMute() + ", music active: " + audioManager.isMusicActive() + ", speakerphone: " + audioManager.isSpeakerphoneOn() + ", BT SCO: " + audioManager.isBluetoothScoOn());
    }
    ...
    private static void logAudioStateVolume(String str, AudioManager audioManager) {
        ...
        Logging.m206d(str, "Audio State: ");
        boolean isVolumeFixed = isVolumeFixed(audioManager);
        Logging.m206d(str, "  fixed volume=" + isVolumeFixed);
        if (isVolumeFixed) {
            return;
        }
        for (int i : iArr) {
    ...
    private static void logAudioDeviceInfo(String str, AudioManager audioManager) {
        ...
        Logging.m206d(str, "Audio Devices: ");
