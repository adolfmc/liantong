 ...
 */
    ...
    static class VideoReaderY4M implements VideoReader {
        ...
        public VideoReaderY4M(String str) throws IOException {
            ...
            while (true) {
                ...
                if (read == -1) {
                    ...
                    Logging.m206d("VideoReaderY4M", "Color space: " + str2);
                    ...
                    this.frameWidth = i;
                    this.frameHeight = i2;
                    Logging.m206d("VideoReaderY4M", "frame dim: (" + i + ", " + i2 + ")");
                    return;
                }
            }
        }
        ...
        public void close() {
            try {
                ...
                Logging.m204e("VideoReaderY4M", "Problem closing file", e);
            }
        }
    }
    ...
    public FileVideoCapturer(String str) throws IOException {
        try {
            ...
            Logging.m206d("FileVideoCapturer", "Could not open video file: " + str);
            throw e;
        }
    }
