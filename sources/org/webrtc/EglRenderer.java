 ...
 */
    ...
    public static class HandlerWithExceptionCallback extends Handler {
        ...
        public void dispatchMessage(Message message) {
            try {
                ...
                Logging.m204e("EglRenderer", "Exception on EglRenderer thread", e);
    ...
    public void init(@Nullable final EglBase.Context context, final int[] iArr, RendererCommon.GlDrawer glDrawer, boolean z) {
        synchronized (this.handlerLock) {
            ...
            ThreadUtils.invokeAtFrontUninterruptibly(this.renderThreadHandler, new Runnable() { // from class: org.webrtc.-$$Lambda$EglRenderer$A5MPsBufyTiKpmjvPS46Dr9iaHs
                @Override // java.lang.Runnable
    ...
    public void release() {
        ...
        synchronized (this.handlerLock) {
            ...
            this.renderThreadHandler.postAtFrontOfQueue(new Runnable() { // from class: org.webrtc.-$$Lambda$EglRenderer$MFF8Cl7oJsgEmXm7UI2GkKtNTYY
                @Override // java.lang.Runnable
                public final void run() {
            ...
            this.renderThreadHandler.post(new Runnable() { // from class: org.webrtc.-$$Lambda$EglRenderer$0TOf6TQvvPy5g4d42QjmzelnDZI
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void addFrameListener(final FrameListener frameListener, final float f, @Nullable final RendererCommon.GlDrawer glDrawer, final boolean z) {
        postToRenderThread(new Runnable() { // from class: org.webrtc.-$$Lambda$EglRenderer$RQnwmlnL5c18V7FwaqbMl6FsQRo
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void removeFrameListener(final FrameListener frameListener) {
        ...
        synchronized (this.handlerLock) {
            ...
            postToRenderThread(new Runnable() { // from class: org.webrtc.-$$Lambda$EglRenderer$6uTxCXz4FQA7p26IUV3iP2Ty5gk
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void onFrame(VideoFrame videoFrame) {
        ...
        synchronized (this.handlerLock) {
            ...
            synchronized (this.frameLock) {
                ...
                this.renderThreadHandler.post(new Runnable() { // from class: org.webrtc.-$$Lambda$EglRenderer$vWDJEj1GWjHSjwoQQjEEK_IVOJE
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public void releaseEglSurface(final Runnable runnable) {
        ...
        synchronized (this.handlerLock) {
            if (this.renderThreadHandler != null) {
                ...
                this.renderThreadHandler.postAtFrontOfQueue(new Runnable() { // from class: org.webrtc.-$$Lambda$EglRenderer$ZLNzG80KHUk0Ad58984FOsNt9s8
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public void clearImage(final float f, final float f2, final float f3, final float f4) {
        synchronized (this.handlerLock) {
            ...
            this.renderThreadHandler.postAtFrontOfQueue(new Runnable() { // from class: org.webrtc.-$$Lambda$EglRenderer$rAPTAEHKQxRxBFU3vvHmF68TV5E
                @Override // java.lang.Runnable
                public final void run() {
    ...
    private void logE(String str, Throwable th) {
        Logging.m204e("EglRenderer", this.name + str, th);
    }

    private void logD(String str) {
        Logging.m206d("EglRenderer", this.name + str);
    }

    private void logW(String str) {
        Logging.m202w("EglRenderer", this.name + str);
    }
}
