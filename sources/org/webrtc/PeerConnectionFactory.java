 ...
 */
    ...
    public static void initialize(InitializationOptions initializationOptions) {
        ...
        Logging.m206d("PeerConnectionFactory", "PeerConnectionFactory was initialized without an injected Loggable. Any existing Loggable will be deleted.");
    ...
    private static void printStackTrace(@Nullable ThreadInfo threadInfo, boolean z) {
        ...
        if (stackTrace.length > 0) {
            Logging.m202w("PeerConnectionFactory", name + " stacktrace:");
            for (StackTraceElement stackTraceElement : stackTrace) {
                Logging.m202w("PeerConnectionFactory", stackTraceElement.toString());
            }
        }
        if (z) {
            Logging.m202w("PeerConnectionFactory", "*** *** *** *** *** *** *** *** *** *** *** *** *** *** *** ***");
            Logging.m202w("PeerConnectionFactory", "pid: " + Process.myPid() + ", tid: " + threadInfo.tid + ", name: " + name + "  >>> WebRTC <<<");
    ...
    private void onNetworkThreadReady() {
        ...
        Logging.m206d("PeerConnectionFactory", "onNetworkThreadReady");
    }
    ...
    private void onWorkerThreadReady() {
        ...
        Logging.m206d("PeerConnectionFactory", "onWorkerThreadReady");
    }
    ...
    private void onSignalingThreadReady() {
        ...
        Logging.m206d("PeerConnectionFactory", "onSignalingThreadReady");
    }
}
