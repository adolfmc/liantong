...
public class HardwareVideoEncoderFactory implements VideoEncoderFactory {
    ...
    public HardwareVideoEncoderFactory(EglBase.Context context, boolean z, boolean z2, @Nullable Predicate<MediaCodecInfo> predicate) {
        if (context instanceof EglBase14.Context) {
            ...
            Logging.m202w("HardwareVideoEncoderFactory", "No shared EglBase.Context.  Encoders will not use texture mode.");
    ...
    private MediaCodecInfo findCodecForType(VideoCodecMimeType videoCodecMimeType) {
        ...
        while (true) {
            ...
            try {
                ...
                Logging.m204e("HardwareVideoEncoderFactory", "Cannot retrieve encoder codec info", e);
            }
