 ...
 */
    ...
    public class CameraStateCallback extends CameraDevice.StateCallback {
        ...
        public void onOpened(CameraDevice cameraDevice) {
            Camera2Session.this.checkIsOnCameraThread();
            Logging.m206d("Camera2Session", "Camera opened.");
        ...
        public void onClosed(CameraDevice cameraDevice) {
            Camera2Session.this.checkIsOnCameraThread();
            Logging.m206d("Camera2Session", "Camera device closed.");
 ...
 */
    ...
    public class CaptureSessionCallback extends CameraCaptureSession.StateCallback {
        ...
        public void onConfigured(CameraCaptureSession cameraCaptureSession) {
            Camera2Session.this.checkIsOnCameraThread();
            Logging.m206d("Camera2Session", "Camera capture session configured.");
            ...
            try {
                ...
                Logging.m206d("Camera2Session", "Camera device successfully started.");
        ...
        public static /* synthetic */ void lambda$onConfigured$0(CaptureSessionCallback captureSessionCallback, VideoFrame videoFrame) {
            ...
            Logging.m206d("Camera2Session", "Texture frame captured but camera is no longer running.");
        }
        ...
        private void chooseStabilizationMode(CaptureRequest.Builder builder) {
            ...
            if (iArr != null) {
                for (int i : iArr) {
                    if (i == 1) {
                        ...
                        Logging.m206d("Camera2Session", "Using optical stabilization.");
                        return;
                    }
                }
            }
            for (int i2 : (int[]) Camera2Session.this.cameraCharacteristics.get(CameraCharacteristics.CONTROL_AVAILABLE_VIDEO_STABILIZATION_MODES)) {
                if (i2 == 1) {
                    ...
                    Logging.m206d("Camera2Session", "Using video stabilization.");
                    return;
                }
            }
            Logging.m206d("Camera2Session", "Stabilization not available.");
        }
        ...
        private void chooseFocusMode(CaptureRequest.Builder builder) {
            for (int i : (int[]) Camera2Session.this.cameraCharacteristics.get(CameraCharacteristics.CONTROL_AF_AVAILABLE_MODES)) {
                if (i == 3) {
                    ...
                    Logging.m206d("Camera2Session", "Using continuous video auto-focus.");
                    return;
                }
            }
            Logging.m206d("Camera2Session", "Auto-focus is not available.");
        }
    }
 ...
 */
    ...
    static class CameraCaptureCallback extends CameraCaptureSession.CaptureCallback {
        ...
        public void onCaptureFailed(CameraCaptureSession cameraCaptureSession, CaptureRequest captureRequest, CaptureFailure captureFailure) {
            Logging.m206d("Camera2Session", "Capture failed: " + captureFailure);
        }
    }
    ...
    private Camera2Session(CameraSession.CreateSessionCallback createSessionCallback, CameraSession.Events events, Context context, CameraManager cameraManager, SurfaceTextureHelper surfaceTextureHelper, String str, int i, int i2, int i3) {
        Logging.m206d("Camera2Session", "Create new camera2 session on camera " + str);
    ...
    private void start() {
        ...
        Logging.m206d("Camera2Session", "start");
        try {
    ...
    private void findCaptureFormat() {
        ...
        Logging.m206d("Camera2Session", "Available preview sizes: " + supportedSizes);
        Logging.m206d("Camera2Session", "Available fps ranges: " + convertFramerates);
        ...
        Logging.m206d("Camera2Session", "Using capture format: " + this.captureFormat);
    }

    private void openCamera() {
        checkIsOnCameraThread();
        Logging.m206d("Camera2Session", "Opening camera " + this.cameraId);
    ...
    public void stop() {
        Logging.m206d("Camera2Session", "Stop camera2 session on camera " + this.cameraId);
        checkIsOnCameraThread();
    ...
    public void stopInternal() {
        Logging.m206d("Camera2Session", "Stop internal");
        checkIsOnCameraThread();
        ...
        Logging.m206d("Camera2Session", "Stop done");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void reportError(String str) {
        checkIsOnCameraThread();
        Logging.m205e("Camera2Session", "Error: " + str);
