 ...
 */
    ...
    private TextureBufferImpl(int i, int i2, int i3, int i4, VideoFrame.TextureBuffer.Type type, int i5, Matrix matrix, Handler handler, YuvConverter yuvConverter, final RefCountMonitor refCountMonitor) {
        ...
        this.refCountDelegate = new RefCountDelegate(new Runnable() { // from class: org.webrtc.-$$Lambda$TextureBufferImpl$UysfDmDl6RDIIv1f8uPEPSGq3m4
    ...
    public VideoFrame.I420Buffer toI420() {
        return (VideoFrame.I420Buffer) ThreadUtils.invokeAtFrontUninterruptibly(this.toI420Handler, new Callable() { // from class: org.webrtc.-$$Lambda$TextureBufferImpl$TZEswaLGgZwDMhjqZ7fKbQLvLlQ
    ...
    private TextureBufferImpl applyTransformMatrix(Matrix matrix, int i, int i2, int i3, int i4) {
        ...
        retain();
        return new TextureBufferImpl(i, i2, i3, i4, this.type, this.f27436id, matrix2, this.toI420Handler, this.yuvConverter, new RefCountMonitor() { // from class: org.webrtc.TextureBufferImpl.2
            @Override // org.webrtc.TextureBufferImpl.RefCountMonitor
            public void onRetain(TextureBufferImpl textureBufferImpl) {
