 ...
 */
    ...
    public AndroidVideoDecoder(MediaCodecWrapperFactory mediaCodecWrapperFactory, String str, VideoCodecMimeType videoCodecMimeType, int i, @Nullable EglBase.Context context) {
        ...
        Logging.m206d("AndroidVideoDecoder", "ctor name: " + str + " type: " + videoCodecMimeType + " color format: " + i + " context: " + context);
    ...
    private VideoCodecStatus initDecodeInternal(int i, int i2) {
        ...
        Logging.m206d("AndroidVideoDecoder", "initDecodeInternal name: " + this.codecName + " type: " + this.codecType + " width: " + i + " height: " + i2);
        if (this.outputThread != null) {
            Logging.m205e("AndroidVideoDecoder", "initDecodeInternal called while the codec is already running");
        ...
        try {
            ...
            try {
                ...
                Logging.m206d("AndroidVideoDecoder", "initDecodeInternal done");
                return VideoCodecStatus.OK;
            } catch (IllegalArgumentException | IllegalStateException e) {
                Logging.m204e("AndroidVideoDecoder", "initDecode failed", e);
                release();
                return VideoCodecStatus.FALLBACK_SOFTWARE;
            }
        } catch (IOException | IllegalArgumentException | IllegalStateException unused) {
            Logging.m205e("AndroidVideoDecoder", "Cannot create media decoder " + this.codecName);
            return VideoCodecStatus.FALLBACK_SOFTWARE;
        }
    }
    ...
    public VideoCodecStatus decode(EncodedImage encodedImage, VideoDecoder.DecodeInfo decodeInfo) {
        ...
        if (this.codec == null || this.callback == null) {
            ...
            Logging.m206d("AndroidVideoDecoder", sb.toString());
            return VideoCodecStatus.UNINITIALIZED;
        } else if (encodedImage.buffer == null) {
            Logging.m205e("AndroidVideoDecoder", "decode() - no input data");
            return VideoCodecStatus.ERR_PARAMETER;
        } else {
            int remaining = encodedImage.buffer.remaining();
            if (remaining == 0) {
                Logging.m205e("AndroidVideoDecoder", "decode() - input buffer empty");
                return VideoCodecStatus.ERR_PARAMETER;
            }
            ...
            if (encodedImage.encodedWidth * encodedImage.encodedHeight <= 0 || ((encodedImage.encodedWidth == i && encodedImage.encodedHeight == i2) || (reinitDecode = reinitDecode(encodedImage.encodedWidth, encodedImage.encodedHeight)) == VideoCodecStatus.OK)) {
                if (this.keyFrameRequired) {
                    if (encodedImage.frameType != EncodedImage.FrameType.VideoFrameKey) {
                        Logging.m205e("AndroidVideoDecoder", "decode() - key frame required first");
                        return VideoCodecStatus.NO_OUTPUT;
                    } else if (!encodedImage.completeFrame) {
                        Logging.m205e("AndroidVideoDecoder", "decode() - complete frame required first");
                        return VideoCodecStatus.NO_OUTPUT;
                    }
                }
                try {
                    ...
                    if (dequeueInputBuffer < 0) {
                        Logging.m205e("AndroidVideoDecoder", "decode() - no HW buffers available; decoder falling behind");
                        return VideoCodecStatus.ERROR;
                    }
                    try {
                        ByteBuffer byteBuffer = this.codec.getInputBuffers()[dequeueInputBuffer];
                        if (byteBuffer.capacity() < remaining) {
                            Logging.m205e("AndroidVideoDecoder", "decode() - HW buffer too small");
                            return VideoCodecStatus.ERROR;
                        }
                        ...
                        try {
                            ...
                            Logging.m204e("AndroidVideoDecoder", "queueInputBuffer failed", e);
                            this.frameInfos.pollLast();
                            return VideoCodecStatus.ERROR;
                        }
                    } catch (IllegalStateException e2) {
                        Logging.m204e("AndroidVideoDecoder", "getInputBuffers failed", e2);
                        return VideoCodecStatus.ERROR;
                    }
                } catch (IllegalStateException e3) {
                    Logging.m204e("AndroidVideoDecoder", "dequeueInputBuffer failed", e3);
                    return VideoCodecStatus.ERROR;
                }
            }
            return reinitDecode;
    ...
    public VideoCodecStatus release() {
        Logging.m206d("AndroidVideoDecoder", "release");
    ...
    /* JADX WARN: Type inference failed for: r1v0, types: [org.webrtc.MediaCodecWrapper, java.lang.Thread] */
    private VideoCodecStatus releaseInternal() {
        if (!this.running) {
            Logging.m206d("AndroidVideoDecoder", "release: Decoder is not running.");
            return VideoCodecStatus.OK;
        }
        try {
            this.running = false;
            if (!ThreadUtils.joinUninterruptibly(this.outputThread, 5000L)) {
                Logging.m204e("AndroidVideoDecoder", "Media decoder release timeout", new RuntimeException());
                return VideoCodecStatus.TIMEOUT;
            } else if (this.shutdownException != null) {
                Logging.m204e("AndroidVideoDecoder", "Media decoder release error", new RuntimeException(this.shutdownException));
    ...
    protected void deliverDecodedFrame() {
        ...
        try {
            ...
            if (dequeueOutputBuffer == -2) {
                ...
                Logging.m203v("AndroidVideoDecoder", "dequeueOutputBuffer returned " + dequeueOutputBuffer);
            } else {
            ...
            Logging.m204e("AndroidVideoDecoder", "deliverDecodedFrame failed", e);
        }
    }
    ...
    private void deliverByteFrame(int i, MediaCodec.BufferInfo bufferInfo, int i2, Integer num) {
        ...
        if (bufferInfo.size < ((i3 * i4) * 3) / 2) {
            Logging.m205e("AndroidVideoDecoder", "Insufficient output buffer size: " + bufferInfo.size);
            return;
        }
    ...
    private void reformat(MediaFormat mediaFormat) {
        ...
        int integer2;
        this.outputThreadChecker.checkIsOnValidThread();
        Logging.m206d("AndroidVideoDecoder", "Decoder format changed: " + mediaFormat.toString());
        ...
        synchronized (this.dimensionLock) {
            ...
            if (this.surfaceTextureHelper == null && mediaFormat.containsKey("color-format")) {
                ...
                Logging.m206d("AndroidVideoDecoder", "Color: 0x" + Integer.toHexString(this.colorFormat));
            ...
            synchronized (this.dimensionLock) {
                ...
                Logging.m206d("AndroidVideoDecoder", "Frame stride and slice height: " + this.stride + " x " + this.sliceHeight);
    ...
    public void releaseCodecOnOutputThread() {
        this.outputThreadChecker.checkIsOnValidThread();
        Logging.m206d("AndroidVideoDecoder", "Releasing MediaCodec on output thread");
        try {
            this.codec.stop();
        } catch (Exception e) {
            Logging.m204e("AndroidVideoDecoder", "Media decoder stop failed", e);
        }
        try {
            this.codec.release();
        } catch (Exception e2) {
            Logging.m204e("AndroidVideoDecoder", "Media decoder release failed", e2);
            this.shutdownException = e2;
        }
        Logging.m206d("AndroidVideoDecoder", "Release on output thread done");
    }
