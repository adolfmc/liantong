 ...
 */
/* renamed from: org.a.e.c.f */
/* loaded from: E:\11617560_dexfile_execute.dex */
public abstract class AbstractC12894f {
    /* renamed from: a */
    public static int m623a(int i, int i2, int[] iArr, int i3) {
        ...
        return AbstractC12891c.m704a(6, iArr, i3, 3);
    }

    /* renamed from: a */
    public static int m622a(int i, long j, int[] iArr, int i2) {
        ...
        return AbstractC12891c.m704a(6, iArr, i2, 4);
    }

    /* renamed from: a */
    public static int m618a(int[] iArr, int i) {
        int i2;
        if (i == 0) {
            i2 = iArr[0];
        } else {
    ...
    /* renamed from: a */
    public static int m617a(int[] iArr, int i, int[] iArr2, int i2) {
        int i3 = i + 0;
        int i4 = i2 + 0;
    ...
    /* renamed from: a */
    public static int m616a(int[] iArr, int i, int[] iArr2, int i2, int i3) {
        int i4 = i2 + 0;
    ...
    /* renamed from: a */
    public static int m613a(int[] iArr, int[] iArr2, int[] iArr3) {
    ...
    /* renamed from: a */
    public static long m621a(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
    ...
    /* renamed from: a */
    public static boolean m619a(int[] iArr) {
        if (iArr[0] != 1) {
            return false;
        }
        for (int i = 1; i < 6; i++) {
    ...
    /* renamed from: a */
    public static boolean m615a(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        boolean m607b = m607b(iArr, i, iArr2, i2);
        if (m607b) {
            m599c(iArr, i, iArr2, i2, iArr3, i3);
        } else {
            m599c(iArr2, i2, iArr, i, iArr3, i3);
        }
        return m607b;
    }

    /* renamed from: a */
    public static boolean m614a(int[] iArr, int[] iArr2) {
        for (int i = 5; i >= 0; i--) {
            if (iArr[i] != iArr2[i]) {
                return false;
            }
    ...
    /* renamed from: a */
    public static boolean m612a(long[] jArr) {
        if (jArr[0] != 1) {
            return false;
        }
        for (int i = 1; i < 3; i++) {
    ...
    /* renamed from: a */
    public static boolean m611a(long[] jArr, long[] jArr2) {
        for (int i = 2; i >= 0; i--) {
            if (jArr[i] != jArr2[i]) {
                return false;
            }
    ...
    /* renamed from: a */
    public static int[] m624a() {
        return new int[6];
    }

    /* renamed from: a */
    public static int[] m620a(BigInteger bigInteger) {
    ...
    /* renamed from: b */
    public static int m604b(int[] iArr, int[] iArr2, int[] iArr3) {
    ...
    /* renamed from: b */
    public static void m606b(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        int i4;
        int i5;
        int i6;
        int i7;
    ...
    /* renamed from: b */
    public static boolean m608b(int[] iArr) {
        for (int i = 0; i < 6; i++) {
            if (iArr[i] != 0) {
                return false;
            }
    ...
    /* renamed from: b */
    public static boolean m607b(int[] iArr, int i, int[] iArr2, int i2) {
    ...
    /* renamed from: b */
    public static boolean m605b(int[] iArr, int[] iArr2) {
        for (int i = 5; i >= 0; i--) {
    ...
    /* renamed from: b */
    public static boolean m603b(long[] jArr) {
        for (int i = 0; i < 3; i++) {
            if (jArr[i] != 0) {
                return false;
            }
    ...
    /* renamed from: b */
    public static long[] m610b() {
        return new long[3];
    }

    /* renamed from: b */
    public static long[] m609b(BigInteger bigInteger) {
        if (bigInteger.signum() < 0 || bigInteger.bitLength() > 192) {
            throw new IllegalArgumentException();
        }
        long[] m610b = m610b();
    ...
    /* renamed from: c */
    public static int m599c(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
    ...
    /* renamed from: c */
    public static BigInteger m601c(int[] iArr) {
        byte[] bArr = new byte[24];
        for (int i = 0; i < 6; i++) {
            int i2 = iArr[i];
            if (i2 != 0) {
                AbstractC12971e.m400a(i2, bArr, (5 - i) << 2);
            }
        }
    ...
    /* renamed from: c */
    public static BigInteger m596c(long[] jArr) {
        byte[] bArr = new byte[24];
        for (int i = 0; i < 3; i++) {
            long j = jArr[i];
            if (j != 0) {
                AbstractC12971e.m399a(j, bArr, (2 - i) << 3);
            }
        }
        return new BigInteger(1, bArr);
    }
    ...
    /* renamed from: c */
    public static void m600c(int[] iArr, int i, int[] iArr2, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        while (true) {
            ...
            long j3 = j2 * j2;
            int i16 = i12 - 1;
            iArr2[i2 + i16] = (i13 << 31) | ((int) (j3 >>> 33));
            i12 = i16 - 1;
            iArr2[i2 + i12] = (int) (j3 >>> 1);
            int i17 = (int) j3;
            if (i15 <= 0) {
                long j4 = j * j;
                iArr2[i2 + 0] = (int) j4;
                long j5 = iArr[i + 1] & 4294967295L;
                long j6 = (((i17 << 31) & 4294967295L) | (j4 >>> 33)) + (j5 * j);
                int i18 = (int) j6;
                ...
                int i34 = i33 >>> 31;
                int i35 = i2 + 11;
                iArr2[i35] = i34 | ((iArr2[i35] + ((int) (j36 >>> 32))) << 1);
                return;
            }
            i13 = i17;
            i14 = i15;
    ...
    /* renamed from: c */
    public static void m598c(int[] iArr, int[] iArr2) {
    ...
    /* renamed from: c */
    public static void m597c(int[] iArr, int[] iArr2, int[] iArr3) {
        int i;
        int i2;
        int i3;
        int i4;
        ...
        for (int i7 = 6; i6 < i7; i7 = 6) {
            ...
            iArr3[i8] = (int) j17;
            int i9 = i6;
            long j18 = (j17 >>> 32) + (j14 * j3) + (iArr3[i2] & 4294967295L);
            iArr3[i6 + 2] = (int) j18;
            long j19 = (j18 >>> 32) + (j14 * j4) + (iArr3[i3] & 4294967295L);
            iArr3[i9 + 3] = (int) j19;
            long j20 = (j19 >>> 32) + (j14 * j5) + (iArr3[i4] & 4294967295L);
            iArr3[i9 + 4] = (int) j20;
            long j21 = (j20 >>> 32) + (j14 * j6) + (iArr3[i5] & 4294967295L);
            iArr3[i9 + 5] = (int) j21;
    ...
    /* renamed from: c */
    public static int[] m602c() {
        return new int[12];
    }

    /* renamed from: d */
    public static int m593d(int[] iArr, int[] iArr2) {
    ...
    /* renamed from: d */
    public static int m592d(int[] iArr, int[] iArr2, int[] iArr3) {
        int i;
        int i2;
        int i3;
        int i4;
    ...
    /* renamed from: d */
    public static void m594d(int[] iArr) {
        iArr[0] = 0;
        iArr[1] = 0;
        iArr[2] = 0;
        iArr[3] = 0;
    ...
    /* renamed from: d */
    public static long[] m595d() {
        return new long[6];
    }

    /* renamed from: e */
    public static int m591e(int[] iArr, int[] iArr2, int[] iArr3) {
        long j = ((iArr[0] & 4294967295L) - (iArr2[0] & 4294967295L)) + 0;
        iArr3[0] = (int) j;
        long j2 = (j >> 32) + ((iArr[1] & 4294967295L) - (iArr2[1] & 4294967295L));
        iArr3[1] = (int) j2;
