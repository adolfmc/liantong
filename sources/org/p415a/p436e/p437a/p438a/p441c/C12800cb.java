 ...
 */
/* renamed from: org.a.e.a.a.c.cb */
/* loaded from: E:\11617560_dexfile_execute.dex */
public class C12800cb extends AbstractC12856e {

    /* renamed from: a */
    protected long[] f26004a;

    public C12800cb() {
        this.f26004a = AbstractC12896h.m554b();
    }

    public C12800cb(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.bitLength() > 239) {
            throw new IllegalArgumentException("x value invalid for SecT239FieldElement");
        }
        this.f26004a = C12799ca.m1096a(bigInteger);
    }

    protected C12800cb(long[] jArr) {
        this.f26004a = jArr;
    }
    ...
    public BigInteger mo893a() {
        return AbstractC12896h.m540c(this.f26004a);
    }
    ...
    public AbstractC12856e mo899a(int i) {
        ...
        C12799ca.m1093a(this.f26004a, i, m554b);
        return new C12800cb(m554b);
    }
    ...
    public AbstractC12856e mo889a(AbstractC12856e abstractC12856e) {
        long[] m554b = AbstractC12896h.m554b();
        C12799ca.m1091a(this.f26004a, ((C12800cb) abstractC12856e).f26004a, m554b);
        return new C12800cb(m554b);
    }
    ...
    public AbstractC12856e mo888a(AbstractC12856e abstractC12856e, AbstractC12856e abstractC12856e2) {
        long[] jArr = this.f26004a;
        long[] jArr2 = ((C12800cb) abstractC12856e).f26004a;
        long[] jArr3 = ((C12800cb) abstractC12856e2).f26004a;
        long[] m539d = AbstractC12896h.m539d();
        C12799ca.m1082f(jArr, m539d);
        C12799ca.m1085d(jArr2, jArr3, m539d);
        long[] m554b = AbstractC12896h.m554b();
        C12799ca.m1088c(m539d, m554b);
        return new C12800cb(m554b);
    }
    ...
    public AbstractC12856e mo882b(AbstractC12856e abstractC12856e, AbstractC12856e abstractC12856e2, AbstractC12856e abstractC12856e3) {
        ...
        long[] jArr2 = ((C12800cb) abstractC12856e).f26004a;
        long[] jArr3 = ((C12800cb) abstractC12856e2).f26004a;
        long[] jArr4 = ((C12800cb) abstractC12856e3).f26004a;
        long[] m539d = AbstractC12896h.m539d();
        C12799ca.m1085d(jArr, jArr2, m539d);
        C12799ca.m1085d(jArr3, jArr4, m539d);
        long[] m554b = AbstractC12896h.m554b();
        C12799ca.m1088c(m539d, m554b);
        return new C12800cb(m554b);
    }
    ...
    public AbstractC12856e mo881c() {
        long[] m554b = AbstractC12896h.m554b();
        C12799ca.m1092a(this.f26004a, m554b);
        return new C12800cb(m554b);
    }
    ...
    public AbstractC12856e mo878c(AbstractC12856e abstractC12856e) {
        long[] m554b = AbstractC12896h.m554b();
        C12799ca.m1087c(this.f26004a, ((C12800cb) abstractC12856e).f26004a, m554b);
        return new C12800cb(m554b);
    }
    ...
    public AbstractC12856e mo874e() {
        long[] m554b = AbstractC12896h.m554b();
        C12799ca.m1084e(this.f26004a, m554b);
        return new C12800cb(m554b);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof C12800cb) {
            return AbstractC12896h.m555a(this.f26004a, ((C12800cb) obj).f26004a);
        }
        return false;
    }
    ...
    public AbstractC12856e mo871f() {
        long[] m554b = AbstractC12896h.m554b();
        C12799ca.m1090b(this.f26004a, m554b);
        return new C12800cb(m554b);
    }
    ...
    public AbstractC12856e mo870g() {
        long[] m554b = AbstractC12896h.m554b();
        C12799ca.m1086d(this.f26004a, m554b);
        return new C12800cb(m554b);
    }

    public int hashCode() {
        return C12957a.m431a(this.f26004a, 0, 4) ^ 23900158;
    }

    @Override // org.p415a.p436e.p437a.AbstractC12856e
    /* renamed from: i */
    public boolean mo896i() {
        return AbstractC12896h.m556a(this.f26004a);
    }

    @Override // org.p415a.p436e.p437a.AbstractC12856e
    /* renamed from: j */
    public boolean mo895j() {
        return AbstractC12896h.m547b(this.f26004a);
    }

    @Override // org.p415a.p436e.p437a.AbstractC12856e
    /* renamed from: k */
    public boolean mo894k() {
        return (this.f26004a[0] & 1) != 0;
    }
}
