 ...
 */
/* renamed from: org.a.b.br */
/* loaded from: E:\11617560_dexfile_execute.dex */
public class C12458br extends AbstractC12576z {

    /* renamed from: e */
    private static final byte[] f25229e = new byte[0];

    public C12458br(boolean z, int i, InterfaceC12554f interfaceC12554f) {
    ...
    void mo1597a(C12567r c12567r) {
        ...
        int i = C0567f.f1819h;
        if (z) {
            c12567r.m1627a(C0567f.f1819h, this.f25521a, f25229e);
            return;
        }
        AbstractC12570t mo1591g = this.f25524d.mo1617h().mo1591g();
        if (this.f25523c) {
            c12567r.m1628a(C0567f.f1819h, this.f25521a);
            c12567r.m1629a(mo1591g.mo1618c());
            c12567r.mo1625a((InterfaceC12554f) mo1591g);
            return;
        }
        if (!mo1591g.mo1611a()) {
            i = 128;
    ...
    public boolean mo1611a() {
        ...
        return this.f25524d.mo1617h().mo1591g().mo1611a();
    }
    ...
    public int mo1618c() {
        ...
        int mo1618c = this.f25524d.mo1617h().mo1591g().mo1618c();
        if (this.f25523c) {
