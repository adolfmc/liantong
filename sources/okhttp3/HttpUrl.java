...
public final class HttpUrl {
    ...
    public final URL m25561deprecated_url() {
        return url();
    }
    ...
    public final URI m25560deprecated_uri() {
        return uri();
    }
    ...
    public final String m25559deprecated_scheme() {
        return this.scheme;
    }
    ...
    public final String m25549deprecated_encodedUsername() {
    ...
    public final String m25562deprecated_username() {
        return this.username;
    }
    ...
    public final String m25545deprecated_encodedPassword() {
    ...
    public final String m25552deprecated_password() {
        return this.password;
    }
    ...
    public final String m25551deprecated_host() {
        return this.host;
    }
    ...
    public final int m25555deprecated_port() {
        return this.port;
    }
    ...
    public final int m25554deprecated_pathSize() {
        return pathSize();
    }
    ...
    public final String m25546deprecated_encodedPath() {
        return encodedPath();
    }
    ...
    public final List<String> m25547deprecated_encodedPathSegments() {
    ...
    public final List<String> m25553deprecated_pathSegments() {
        return this.pathSegments;
    }
    ...
    public final String m25548deprecated_encodedQuery() {
        return encodedQuery();
    }
    ...
    public final String m25556deprecated_query() {
        return query();
    }
    ...
    public final int m25558deprecated_querySize() {
        return querySize();
    }
    ...
    public final Set<String> m25557deprecated_queryParameterNames() {
    ...
    public final String m25544deprecated_encodedFragment() {
    ...
    public final String m25550deprecated_fragment() {
        return this.fragment;
    }
 ...
 */
    ...
    public static final class Builder {
        ...
        public final Builder addQueryParameter(@NotNull String name, @Nullable String str) {
            ...
            list.add(Companion.canonicalize$okhttp$default(HttpUrl.Companion, name, 0, 0, " !\"#$&'(),/:;<=>?@[]\\^`{|}~", false, false, true, false, null, 219, null));
            List<String> list2 = builder.encodedQueryNamesAndValues;
            if (list2 == null) {
                Intrinsics.throwNpe();
            }
            list2.add(str != null ? Companion.canonicalize$okhttp$default(HttpUrl.Companion, str, 0, 0, " !\"#$&'(),/:;<=>?@[]\\^`{|}~", false, false, true, false, null, 219, null) : null);
            return builder;
        }
        ...
        public final Builder addEncodedQueryParameter(@NotNull String encodedName, @Nullable String str) {
            ...
            list.add(Companion.canonicalize$okhttp$default(HttpUrl.Companion, encodedName, 0, 0, " \"'<>#&=", true, false, true, false, null, 211, null));
            List<String> list2 = builder.encodedQueryNamesAndValues;
            if (list2 == null) {
                Intrinsics.throwNpe();
            }
            list2.add(str != null ? Companion.canonicalize$okhttp$default(HttpUrl.Companion, str, 0, 0, " \"'<>#&=", true, false, true, false, null, 211, null) : null);
            return builder;
        }
        ...
        public final Builder removeAllQueryParameters(@NotNull String name) {
            ...
            builder.removeAllCanonicalQueryParameters(Companion.canonicalize$okhttp$default(HttpUrl.Companion, name, 0, 0, " !\"#$&'(),/:;<=>?@[]\\^`{|}~", false, false, true, false, null, 219, null));
            return builder;
        }
        ...
        public final Builder removeAllEncodedQueryParameters(@NotNull String encodedName) {
            ...
            builder.removeAllCanonicalQueryParameters(Companion.canonicalize$okhttp$default(HttpUrl.Companion, encodedName, 0, 0, " \"'<>#&=", true, false, true, false, null, 211, null));
            return builder;
        }
        ...
        public final Builder reencodeForUri$okhttp() {
            ...
            if (list != null) {
                ...
                for (int i2 = 0; i2 < size2; i2++) {
                    ...
                    list.set(i2, str2 != null ? Companion.canonicalize$okhttp$default(HttpUrl.Companion, str2, 0, 0, "\\^`{|}", true, true, true, false, null, 195, null) : null);
                }
            }
            String str3 = builder.encodedFragment;
            builder.encodedFragment = str3 != null ? Companion.canonicalize$okhttp$default(HttpUrl.Companion, str3, 0, 0, " \"#<>\\^`{|}", true, true, false, true, null, 163, null) : null;
            return builder;
        }
        ...
        public final Builder parse$okhttp(@Nullable HttpUrl httpUrl, @NotNull String input) {
            ...
            if (slashCount < 2 && httpUrl != null && !(!Intrinsics.areEqual(httpUrl.scheme(), this.scheme))) {
                        ...
                        switch (charAt) {
                            ...
                            case '@':
                                if (!z3) {
                                    ...
                                    i3 = indexOfLastNonAsciiWhitespace$default;
                                    c = c2;
                                    this.encodedPassword += "%40" + Companion.canonicalize$okhttp$default(HttpUrl.Companion, input, i4, i2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, 240, null);
                                }
                                i4 = i2 + 1;
                                break;
                            default:
                ...
                if (i5 < delimiterOffset) {
                    this.host = hostnames.toCanonicalHost(Companion.percentDecode$okhttp$default(HttpUrl.Companion, input, i4, portColonOffset, false, 4, null));
                    this.port = Companion.parsePort(input, i5, delimiterOffset);
                    if (!(this.port != c4 ? z5 : false)) {
            ...
            if (delimiterOffset3 < i6 && input.charAt(delimiterOffset3) == '?') {
                ...
                this.encodedQueryNamesAndValues = HttpUrl.Companion.toQueryNamesAndValues$okhttp(Companion.canonicalize$okhttp$default(HttpUrl.Companion, input, delimiterOffset3 + 1, delimiterOffset4, " \"'<>#", true, false, true, false, null, 208, null));
 ...
 */
        /* compiled from: HttpUrl.kt */
        @Metadata(m1892bv = {1, 0, 3}, m1891d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0002\b\u0007\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J \u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00042\u0006\u0010\b\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\u0006H\u0002J \u0010\n\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00042\u0006\u0010\b\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\u0006H\u0002J \u0010\u000b\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00042\u0006\u0010\b\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\u0006H\u0002J\u001c\u0010\f\u001a\u00020\u0006*\u00020\u00042\u0006\u0010\b\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\u0006H\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0080T¢\u0006\u0002\n\u0000¨\u0006\r"}, m1890d2 = {"Lokhttp3/HttpUrl$Builder$Companion;", "", "()V", "INVALID_HOST", "", "parsePort", "", "input", "pos", "limit", "portColonOffset", "schemeDelimiterOffset", "slashCount", "okhttp"}, m1889k = 1, m1888mv = {1, 1, 16})
        /* loaded from: E:\11617560_dexfile_execute.dex */
 ...
 */
    ...
    public static final class Companion {
        ...
        public final HttpUrl m25563deprecated_get(@NotNull String url) {
            Intrinsics.checkParameterIsNotNull(url, "url");
            return get(url);
        }
        ...
        public final HttpUrl m25566deprecated_parse(@NotNull String url) {
            Intrinsics.checkParameterIsNotNull(url, "url");
            return parse(url);
        }
        ...
        @Nullable
        /* renamed from: -deprecated_get  reason: not valid java name */
        public final HttpUrl m25565deprecated_get(@NotNull URL url) {
            Intrinsics.checkParameterIsNotNull(url, "url");
            return get(url);
        }
        ...
        @Nullable
        /* renamed from: -deprecated_get  reason: not valid java name */
        public final HttpUrl m25564deprecated_get(@NotNull URI uri) {
