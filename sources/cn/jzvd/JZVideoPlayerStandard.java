...
public class JZVideoPlayerStandard extends JZVideoPlayer {
    ...
    public void init(Context context) {
        super.init(context);
        this.batteryTimeLayout = (LinearLayout) findViewById(C1703R.C1705id.battery_time_layout);
        this.bottomProgressBar = (ProgressBar) findViewById(C1703R.C1705id.bottom_progress);
        this.titleTextView = (TextView) findViewById(C1703R.C1705id.title);
        this.backButton = (ImageView) findViewById(C1703R.C1705id.back);
        this.thumbImageView = (ImageView) findViewById(C1703R.C1705id.thumb);
        this.loadingProgressBar = (ProgressBar) findViewById(C1703R.C1705id.loading);
        this.tinyBackImageView = (ImageView) findViewById(C1703R.C1705id.back_tiny);
        this.batteryLevel = (ImageView) findViewById(C1703R.C1705id.battery_level);
        this.videoCurrentTime = (TextView) findViewById(C1703R.C1705id.video_current_time);
        this.replayTextView = (TextView) findViewById(C1703R.C1705id.replay_text);
        this.clarity = (TextView) findViewById(C1703R.C1705id.clarity);
        this.mRetryBtn = (TextView) findViewById(C1703R.C1705id.retry_btn);
        this.mRetryLayout = (LinearLayout) findViewById(C1703R.C1705id.retry_layout);
    ...
    public void setUp(Object[] objArr, int i, int i2, Object... objArr2) {
        ...
        if (this.currentScreen == 2) {
            this.fullscreenButton.setImageResource(C1703R.C1704drawable.jz_shrink);
            ...
            changeStartButtonSize((int) getResources().getDimension(C1703R.dimen.jz_start_button_w_h_fullscreen));
        } else if (this.currentScreen == 0 || this.currentScreen == 1) {
            this.fullscreenButton.setImageResource(C1703R.C1704drawable.jz_enlarge);
            this.backButton.setVisibility(8);
            this.tinyBackImageView.setVisibility(4);
            changeStartButtonSize((int) getResources().getDimension(C1703R.dimen.jz_start_button_w_h_normal));
    ...
    public int getLayoutId() {
        return C1703R.C1706layout.jz_layout_standard;
    }
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        int id = view.getId();
        if (id == C1703R.C1705id.surface_container) {
        ...
        } else if (id == C1703R.C1705id.bottom_seek_progress) {
            switch (motionEvent.getAction()) {
                case 0:
                    cancelDismissControlViewTimer();
                    break;
    ...
    public void onClick(View view) {
        ...
        if (id == C1703R.C1705id.thumb) {
        ...
        } else if (id == C1703R.C1705id.surface_container) {
            startDismissControlViewTimer();
        } else if (id == C1703R.C1705id.back) {
            backPress();
        } else if (id == C1703R.C1705id.back_tiny) {
            if (JZVideoPlayerManager.getFirstFloor().currentScreen == 1) {
                quitFullscreenOrTinyWindow();
            } else {
                backPress();
            }
        } else if (id == C1703R.C1705id.clarity) {
            final LinearLayout linearLayout = (LinearLayout) ((LayoutInflater) getContext().getSystemService("layout_inflater")).inflate(C1703R.C1706layout.jz_layout_clarity, (ViewGroup) null);
            ...
            for (int i = 0; i < ((LinkedHashMap) this.dataSourceObjects[0]).size(); i++) {
                ...
                TextView textView = (TextView) View.inflate(getContext(), C1703R.C1706layout.jz_layout_clarity_item, null);
        ...
        } else if (id == C1703R.C1705id.retry_btn) {
            if (this.dataSourceObjects == null || JZUtils.getCurrentFromDataSource(this.dataSourceObjects, this.currentUrlMapIndex) == null) {
                Toast.makeText(getContext(), getResources().getString(C1703R.string.no_url), 0).show();
                NBSActionInstrumentation.onClickEventExit();
                return;
    ...
    public void showWifiDialog() {
        ...
        builder.setMessage(getResources().getString(C1703R.string.tips_not_wifi));
        builder.setPositiveButton(getResources().getString(C1703R.string.tips_not_wifi_confirm), new DialogInterface.OnClickListener() { // from class: cn.jzvd.JZVideoPlayerStandard.3
        ...
        builder.setNegativeButton(getResources().getString(C1703R.string.tips_not_wifi_cancel), new DialogInterface.OnClickListener() { // from class: cn.jzvd.JZVideoPlayerStandard.4
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int i) {
                Tracker.onClick(dialogInterface, i);
                dialogInterface.dismiss();
    ...
    public void setSystemTimeAndBattery() {
        this.videoCurrentTime.setText(new SimpleDateFormat(JtDateUtil.dateFormatHM).format(new Date()));
    ...
    public void setBatteryLevel() {
        ...
        if (i < 15) {
            this.batteryLevel.setBackgroundResource(C1703R.C1704drawable.jz_battery_level_10);
        } else if (i >= 15 && i < 40) {
            this.batteryLevel.setBackgroundResource(C1703R.C1704drawable.jz_battery_level_30);
        } else if (i >= 40 && i < 60) {
            this.batteryLevel.setBackgroundResource(C1703R.C1704drawable.jz_battery_level_50);
        } else if (i >= 60 && i < 80) {
            this.batteryLevel.setBackgroundResource(C1703R.C1704drawable.jz_battery_level_70);
        } else if (i >= 80 && i < 95) {
            this.batteryLevel.setBackgroundResource(C1703R.C1704drawable.jz_battery_level_90);
        } else if (i < 95 || i > 100) {
        } else {
            this.batteryLevel.setBackgroundResource(C1703R.C1704drawable.jz_battery_level_100);
        }
    }
    ...
    public void updateStartImage() {
        if (this.currentState == 3) {
            ...
            this.startButton.setImageResource(C1703R.C1704drawable.jz_click_pause_selector);
            ...
            this.startButton.setVisibility(0);
            this.startButton.setImageResource(C1703R.C1704drawable.jz_click_replay_selector);
            this.replayTextView.setVisibility(0);
        } else {
            this.startButton.setImageResource(C1703R.C1704drawable.jz_click_play_selector);
            this.replayTextView.setVisibility(4);
        }
    }
    ...
    public void showProgressDialog(float f, String str, long j, String str2, long j2) {
        ...
        if (this.mProgressDialog == null) {
            View inflate = LayoutInflater.from(getContext()).inflate(C1703R.C1706layout.jz_dialog_progress, (ViewGroup) null);
            this.mDialogProgressBar = (ProgressBar) inflate.findViewById(C1703R.C1705id.duration_progressbar);
            this.mDialogSeekTime = (TextView) inflate.findViewById(C1703R.C1705id.tv_current);
            this.mDialogTotalTime = (TextView) inflate.findViewById(C1703R.C1705id.tv_duration);
            this.mDialogIcon = (ImageView) inflate.findViewById(C1703R.C1705id.duration_image_tip);
        ...
        if (f > 0.0f) {
            this.mDialogIcon.setBackgroundResource(C1703R.C1704drawable.jz_forward_icon);
        } else {
            this.mDialogIcon.setBackgroundResource(C1703R.C1704drawable.jz_backward_icon);
        }
    ...
    public void showVolumeDialog(float f, int i) {
        ...
        if (this.mVolumeDialog == null) {
            View inflate = LayoutInflater.from(getContext()).inflate(C1703R.C1706layout.jz_dialog_volume, (ViewGroup) null);
            this.mDialogVolumeImageView = (ImageView) inflate.findViewById(C1703R.C1705id.volume_image_tip);
            this.mDialogVolumeTextView = (TextView) inflate.findViewById(C1703R.C1705id.tv_volume);
            this.mDialogVolumeProgressBar = (ProgressBar) inflate.findViewById(C1703R.C1705id.volume_progressbar);
        ...
        if (i <= 0) {
            this.mDialogVolumeImageView.setBackgroundResource(C1703R.C1704drawable.jz_close_volume);
        } else {
            this.mDialogVolumeImageView.setBackgroundResource(C1703R.C1704drawable.jz_add_volume);
        }
        if (i > 100) {
            i = 100;
        } else if (i < 0) {
    ...
    public void showBrightnessDialog(int i) {
        ...
        if (this.mBrightnessDialog == null) {
            View inflate = LayoutInflater.from(getContext()).inflate(C1703R.C1706layout.jz_dialog_brightness, (ViewGroup) null);
            this.mDialogBrightnessTextView = (TextView) inflate.findViewById(C1703R.C1705id.tv_brightness);
            this.mDialogBrightnessProgressBar = (ProgressBar) inflate.findViewById(C1703R.C1705id.brightness_progressbar);
    ...
    public Dialog createDialogWithView(View view) {
        Dialog dialog = new Dialog(getContext(), C1703R.C1707style.jz_style_dialog_progress);
