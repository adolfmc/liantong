...
public abstract class JZVideoPlayer extends FrameLayout implements View.OnClickListener, View.OnTouchListener, SeekBar.OnSeekBarChangeListener {
    ...
    public static void startFullscreen(Context context, Class cls, Object[] objArr, int i, Object... objArr2) {
        ...
        View findViewById = viewGroup.findViewById(C1703R.C1705id.jz_fullscreen_id);
        if (findViewById != null) {
            viewGroup.removeView(findViewById);
        }
        try {
            JZVideoPlayer jZVideoPlayer = (JZVideoPlayer) cls.getConstructor(Context.class).newInstance(context);
            jZVideoPlayer.setId(C1703R.C1705id.jz_fullscreen_id);
    ...
    public void init(Context context) {
        ...
        this.startButton = (ImageView) findViewById(C1703R.C1705id.start);
        this.fullscreenButton = (ImageView) findViewById(C1703R.C1705id.fullscreen);
        this.progressBar = (SeekBar) findViewById(C1703R.C1705id.bottom_seek_progress);
        this.currentTimeTextView = (TextView) findViewById(C1703R.C1705id.current);
        this.totalTimeTextView = (TextView) findViewById(C1703R.C1705id.total);
        this.bottomContainer = (ViewGroup) findViewById(C1703R.C1705id.layout_bottom);
        this.textureViewContainer = (ViewGroup) findViewById(C1703R.C1705id.surface_container);
        this.topContainer = (ViewGroup) findViewById(C1703R.C1705id.layout_top);
    ...
    public void onClick(View view) {
        ...
        } else if (id == C1703R.C1705id.fullscreen) {
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (view.getId() == C1703R.C1705id.surface_container) {
    ...
    public void clearFullscreenLayout() {
        ...
        View findViewById = viewGroup.findViewById(C1703R.C1705id.jz_fullscreen_id);
        View findViewById2 = viewGroup.findViewById(C1703R.C1705id.jz_tiny_id);
        if (findViewById != null) {
            viewGroup.removeView(findViewById);
        }
    ...
    public void clearFloatScreen() {
        ...
        showSupportActionBar(getContext());
        ViewGroup viewGroup = (ViewGroup) JZUtils.scanForActivity(getContext()).findViewById(16908290);
        JZVideoPlayer jZVideoPlayer = (JZVideoPlayer) viewGroup.findViewById(C1703R.C1705id.jz_fullscreen_id);
        JZVideoPlayer jZVideoPlayer2 = (JZVideoPlayer) viewGroup.findViewById(C1703R.C1705id.jz_tiny_id);
    ...
    public void startWindowTiny() {
        ...
        ViewGroup viewGroup = (ViewGroup) JZUtils.scanForActivity(getContext()).findViewById(16908290);
        View findViewById = viewGroup.findViewById(C1703R.C1705id.jz_tiny_id);
        if (findViewById != null) {
            viewGroup.removeView(findViewById);
        }
        this.textureViewContainer.removeView(JZMediaManager.textureView);
        try {
            JZVideoPlayer jZVideoPlayer = (JZVideoPlayer) getClass().getConstructor(Context.class).newInstance(getContext());
            jZVideoPlayer.setId(C1703R.C1705id.jz_tiny_id);
