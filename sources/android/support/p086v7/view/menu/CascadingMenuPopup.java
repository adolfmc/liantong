...
import android.support.p086v7.widget.MenuItemHoverListener;
import android.support.p086v7.widget.MenuPopupWindow;
...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    private static final int ITEM_LAYOUT = C1276R.C1280layout.abc_cascading_menu_item_layout;
    ...
    private final MenuItemHoverListener mMenuItemHoverListener = new MenuItemHoverListener() { // from class: android.support.v7.view.menu.CascadingMenuPopup.3
        @Override // android.support.p086v7.widget.MenuItemHoverListener
 ...
 */
    ...
    @Override // android.support.p086v7.view.menu.MenuPopup
    ...
    public CascadingMenuPopup(@NonNull Context context, @NonNull View view, @AttrRes int i, @StyleRes int i2, boolean z) {
        ...
        this.mMenuMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C1276R.dimen.abc_config_prefDialogWidth));
    ...
    private void showMenu(@NonNull MenuBuilder menuBuilder) {
        ...
        if (cascadingMenuInfo == null && this.mShowTitle && menuBuilder.getHeaderTitle() != null) {
            FrameLayout frameLayout = (FrameLayout) from.inflate(C1276R.C1280layout.abc_popup_menu_header_item_layout, (ViewGroup) listView, false);
