...
import android.support.p086v7.util.ThreadUtil;
 ...
 */
    ...
    /* loaded from: E:\10201592_dexfile_execute.dex */
    class C12991 implements ThreadUtil.MainThreadCallback<T> {
        ...
        private Runnable mMainThreadRunnable = new Runnable() { // from class: android.support.v7.util.MessageThreadUtil.1.1
            ...
            public void run() {
                SyncQueueItem next = C12991.this.mQueue.next();
                while (next != null) {
                    switch (next.what) {
                        case 1:
                            C12991.this.val$callback.updateItemCount(next.arg1, next.arg2);
                            break;
                        case 2:
                            C12991.this.val$callback.addTile(next.arg1, (TileList.Tile) next.data);
                            break;
                        case 3:
                            C12991.this.val$callback.removeTile(next.arg1, next.arg2);
                            break;
                        default:
                            Log.e("ThreadUtil", "Unsupported message, what=" + next.what);
                            break;
                    }
                    next = C12991.this.mQueue.next();
                }
            }
        };

        C12991(ThreadUtil.MainThreadCallback mainThreadCallback) {
            this.val$callback = mainThreadCallback;
        }

        @Override // android.support.p086v7.util.ThreadUtil.MainThreadCallback
    ...
    @Override // android.support.p086v7.util.ThreadUtil
    public ThreadUtil.MainThreadCallback<T> getMainThreadProxy(ThreadUtil.MainThreadCallback<T> mainThreadCallback) {
        return new C12991(mainThreadCallback);
    }
 ...
 */
    ...
    /* loaded from: E:\10201592_dexfile_execute.dex */
    class C13012 implements ThreadUtil.BackgroundCallback<T> {
        ...
        private Runnable mBackgroundRunnable = new Runnable() { // from class: android.support.v7.util.MessageThreadUtil.2.1
            ...
            public void run() {
                while (true) {
                    SyncQueueItem next = C13012.this.mQueue.next();
                    if (next != null) {
                        switch (next.what) {
                            case 1:
                                C13012.this.mQueue.removeMessages(1);
                                C13012.this.val$callback.refresh(next.arg1);
                                break;
                            case 2:
                                C13012.this.mQueue.removeMessages(2);
                                C13012.this.mQueue.removeMessages(3);
                                C13012.this.val$callback.updateRange(next.arg1, next.arg2, next.arg3, next.arg4, next.arg5);
                                break;
                            case 3:
                                C13012.this.val$callback.loadTile(next.arg1, next.arg2);
                                break;
                            case 4:
                                C13012.this.val$callback.recycleTile((TileList.Tile) next.data);
                                break;
                            default:
                                Log.e("ThreadUtil", "Unsupported message, what=" + next.what);
                                break;
                        ...
                        C13012.this.mBackgroundRunning.set(false);
                        return;
                    }
                }
            }
        ...
        C13012(ThreadUtil.BackgroundCallback backgroundCallback) {
            this.val$callback = backgroundCallback;
        }

        @Override // android.support.p086v7.util.ThreadUtil.BackgroundCallback
    ...
    public ThreadUtil.BackgroundCallback<T> getBackgroundProxy(ThreadUtil.BackgroundCallback<T> backgroundCallback) {
        return new C13012(backgroundCallback);
    }
