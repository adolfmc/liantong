 ...
 */
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C1276R.attr.alertDialogCenterButtons, typedValue, true);
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, C1276R.styleable.AlertDialog, C1276R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = obtainStyledAttributes.getResourceId(C1276R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = obtainStyledAttributes.getResourceId(C1276R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = obtainStyledAttributes.getResourceId(C1276R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = obtainStyledAttributes.getResourceId(C1276R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = obtainStyledAttributes.getResourceId(C1276R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = obtainStyledAttributes.getResourceId(C1276R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = obtainStyledAttributes.getBoolean(C1276R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = obtainStyledAttributes.getDimensionPixelSize(C1276R.styleable.AlertDialog_buttonIconDimen, 0);
    ...
    private void setupView() {
        ...
        View findViewById2;
        View findViewById3 = this.mWindow.findViewById(C1276R.C1279id.parentPanel);
        View findViewById4 = findViewById3.findViewById(C1276R.C1279id.topPanel);
        View findViewById5 = findViewById3.findViewById(C1276R.C1279id.contentPanel);
        View findViewById6 = findViewById3.findViewById(C1276R.C1279id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) findViewById3.findViewById(C1276R.C1279id.customPanel);
        setupCustomContent(viewGroup);
        View findViewById7 = viewGroup.findViewById(C1276R.C1279id.topPanel);
        View findViewById8 = viewGroup.findViewById(C1276R.C1279id.contentPanel);
        View findViewById9 = viewGroup.findViewById(C1276R.C1279id.buttonPanel);
        ...
        if (!z3 && resolvePanel2 != null && (findViewById2 = resolvePanel2.findViewById(C1276R.C1279id.textSpacerNoButtons)) != null) {
        ...
        if (z2) {
            ...
            if (this.mMessage != null || this.mListView != null) {
                view = resolvePanel.findViewById(C1276R.C1279id.titleDividerNoCustom);
            }
            if (view != null) {
                view.setVisibility(0);
            }
        } else if (resolvePanel2 != null && (findViewById = resolvePanel2.findViewById(C1276R.C1279id.textSpacerNoTitle)) != null) {
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        final View findViewById = this.mWindow.findViewById(C1276R.C1279id.scrollIndicatorUp);
        View findViewById2 = this.mWindow.findViewById(C1276R.C1279id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (z) {
            FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C1276R.C1279id.custom);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C1276R.C1279id.title_template).setVisibility(8);
            return;
        }
        this.mIconView = (ImageView) this.mWindow.findViewById(16908294);
        if ((!TextUtils.isEmpty(this.mTitle)) && this.mShowTitle) {
            this.mTitleView = (TextView) this.mWindow.findViewById(C1276R.C1279id.alertTitle);
    ...
    private void setupContent(ViewGroup viewGroup) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C1276R.C1279id.scrollView);
 ...
 */
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1276R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = obtainStyledAttributes.getDimensionPixelOffset(C1276R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = obtainStyledAttributes.getDimensionPixelOffset(C1276R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
