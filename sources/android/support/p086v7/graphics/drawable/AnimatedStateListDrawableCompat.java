...
import android.support.p086v7.graphics.drawable.StateListDrawable;
...
public class AnimatedStateListDrawableCompat extends StateListDrawable {
    ...
    @Override // android.support.p086v7.graphics.drawable.StateListDrawable, android.support.p086v7.graphics.drawable.DrawableContainer, android.graphics.drawable.Drawable
    public boolean isStateful() {
        return true;
    }

    @Override // android.support.p086v7.graphics.drawable.StateListDrawable
    ...
    @Override // android.support.p086v7.graphics.drawable.DrawableContainer, android.graphics.drawable.Drawable.Callback
    ...
    public void inflate(@NonNull Context context, @NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        TypedArray obtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, C1276R.styleable.AnimatedStateListDrawableCompat);
        setVisible(obtainAttributes.getBoolean(C1276R.styleable.AnimatedStateListDrawableCompat_android_visible, true), true);
 ...
 */
    ...
    public static class AnimatableTransition extends Transition {
        ...
        /* renamed from: mA */
        private final Animatable f2486mA;

        AnimatableTransition(Animatable animatable) {
            super();
            this.f2486mA = animatable;
        }

        @Override // android.support.p086v7.graphics.drawable.AnimatedStateListDrawableCompat.Transition
        public void start() {
            this.f2486mA.start();
        }
 ...
 */
    ...
    private void updateStateFromTypedArray(TypedArray typedArray) {
        ...
        animatedStateListState.setVariablePadding(typedArray.getBoolean(C1276R.styleable.AnimatedStateListDrawableCompat_android_variablePadding, animatedStateListState.mVariablePadding));
        animatedStateListState.setConstantSize(typedArray.getBoolean(C1276R.styleable.AnimatedStateListDrawableCompat_android_constantSize, animatedStateListState.mConstantSize));
        animatedStateListState.setEnterFadeDuration(typedArray.getInt(C1276R.styleable.AnimatedStateListDrawableCompat_android_enterFadeDuration, animatedStateListState.mEnterFadeDuration));
        animatedStateListState.setExitFadeDuration(typedArray.getInt(C1276R.styleable.AnimatedStateListDrawableCompat_android_exitFadeDuration, animatedStateListState.mExitFadeDuration));
        setDither(typedArray.getBoolean(C1276R.styleable.AnimatedStateListDrawableCompat_android_dither, animatedStateListState.mDither));
    }
    ...
    private int parseTransition(@NonNull Context context, @NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        int next;
        TypedArray obtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, C1276R.styleable.AnimatedStateListDrawableTransition);
        int resourceId = obtainAttributes.getResourceId(C1276R.styleable.AnimatedStateListDrawableTransition_android_fromId, -1);
        int resourceId2 = obtainAttributes.getResourceId(C1276R.styleable.AnimatedStateListDrawableTransition_android_toId, -1);
        int resourceId3 = obtainAttributes.getResourceId(C1276R.styleable.AnimatedStateListDrawableTransition_android_drawable, -1);
        Drawable drawable = resourceId3 > 0 ? AppCompatResources.getDrawable(context, resourceId3) : null;
        boolean z = obtainAttributes.getBoolean(C1276R.styleable.AnimatedStateListDrawableTransition_android_reversible, false);
        obtainAttributes.recycle();
        if (drawable == null) {
            do {
    ...
    private int parseItem(@NonNull Context context, @NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        int next;
        TypedArray obtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, C1276R.styleable.AnimatedStateListDrawableItem);
        int resourceId = obtainAttributes.getResourceId(C1276R.styleable.AnimatedStateListDrawableItem_android_id, 0);
        int resourceId2 = obtainAttributes.getResourceId(C1276R.styleable.AnimatedStateListDrawableItem_android_drawable, -1);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // android.support.p086v7.graphics.drawable.StateListDrawable, android.support.p086v7.graphics.drawable.DrawableContainer
 ...
 */
    ...
    public static class AnimatedStateListState extends StateListDrawable.StateListState {
        ...
        @Override // android.support.p086v7.graphics.drawable.StateListDrawable.StateListState, android.support.p086v7.graphics.drawable.DrawableContainer.DrawableContainerState
        void mutate() {
            this.mTransitions = this.mTransitions.m24459clone();
            this.mStateIds = this.mStateIds.m24460clone();
        }
        ...
        @Override // android.support.p086v7.graphics.drawable.StateListDrawable.StateListState, android.graphics.drawable.Drawable.ConstantState
        @NonNull
