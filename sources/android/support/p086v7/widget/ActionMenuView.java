 ...
 */
    ...
    */
    private void onMeasureExactFormat(int r30, int r31) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p086v7.widget.ActionMenuView.onMeasureExactFormat(int, int):void");
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // android.support.p086v7.widget.LinearLayoutCompat, android.view.ViewGroup
    ...
    @Override // android.support.p086v7.view.menu.MenuBuilder.ItemInvoker
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
