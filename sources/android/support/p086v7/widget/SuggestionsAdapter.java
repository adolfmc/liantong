...
import android.support.p083v4.widget.ResourceCursorAdapter;
...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    @Override // android.support.p083v4.widget.CursorAdapter, android.widget.BaseAdapter, android.widget.Adapter
    ...
    @Override // android.support.p083v4.widget.CursorAdapter, android.support.p083v4.widget.CursorFilter.CursorFilterClient
    ...
    @Override // android.support.p083v4.widget.ResourceCursorAdapter, android.support.p083v4.widget.CursorAdapter
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        View newView = super.newView(context, cursor, viewGroup);
        newView.setTag(new ChildViewCache(newView));
        ((ImageView) newView.findViewById(C1276R.C1279id.edit_query)).setImageResource(this.mCommitIconResId);
        return newView;
    }
 ...
 */
    ...
    public static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C1276R.C1279id.edit_query);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C1276R.attr.textColorSearchUrl, typedValue, true);
    ...
    @Override // android.support.p083v4.widget.CursorAdapter, android.widget.Adapter
    ...
    @Override // android.support.p083v4.widget.CursorAdapter, android.widget.BaseAdapter, android.widget.SpinnerAdapter
