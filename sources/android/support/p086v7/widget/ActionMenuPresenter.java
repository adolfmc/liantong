...
import android.support.p086v7.view.menu.ActionMenuItemView;
import android.support.p086v7.view.menu.BaseMenuPresenter;
...
public class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public ActionMenuPresenter(Context context) {
        super(context, C1276R.C1280layout.abc_action_menu_layout, C1276R.C1280layout.abc_action_menu_item_layout);
        this.mActionButtonGroups = new SparseBooleanArray();
        this.mPopupPresenterCallback = new PopupPresenterCallback();
    }

    @Override // android.support.p086v7.view.menu.BaseMenuPresenter, android.support.p086v7.view.menu.MenuPresenter
    ...
    @Override // android.support.p086v7.view.menu.BaseMenuPresenter
        ...
        while (i15 < i) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                if (z5) {
                    ...
                    z5 = actionMenuPresenter.mStrictWidthLimit ? z6 & (i14 >= 0) : z6 & (i14 + i13 > 0);
                } else {
                    i4 = i;
                }
                if (z5 && groupId2 != 0) {
    ...
    @Override // android.support.p083v4.view.ActionProvider.SubUiVisibilityListener
 ...
 */
    ...
    public class OverflowMenuButton extends AppCompatImageView implements ActionMenuView.ActionMenuChildView {
        ...
        @Override // android.support.p086v7.widget.ActionMenuView.ActionMenuChildView
        ...
        public OverflowMenuButton(Context context) {
            super(context, null, C1276R.attr.actionOverflowButtonStyle);
 ...
 */
    ...
    public class OverflowPopup extends MenuPopupHelper {
        public OverflowPopup(Context context, MenuBuilder menuBuilder, View view, boolean z) {
            super(context, menuBuilder, view, z, C1276R.attr.actionOverflowMenuStyle);
            setGravity(8388613);
            setPresenterCallback(ActionMenuPresenter.this.mPopupPresenterCallback);
        }

        @Override // android.support.p086v7.view.menu.MenuPopupHelper
 ...
 */
    ...
    public class ActionButtonSubmenu extends MenuPopupHelper {
        public ActionButtonSubmenu(Context context, SubMenuBuilder subMenuBuilder, View view) {
            super(context, subMenuBuilder, view, false, C1276R.attr.actionOverflowMenuStyle);
 ...
 */
    ...
    class ActionMenuPopupCallback extends ActionMenuItemView.PopupCallback {
        ...
        @Override // android.support.p086v7.view.menu.ActionMenuItemView.PopupCallback
        public ShowableListMenu getPopup() {
