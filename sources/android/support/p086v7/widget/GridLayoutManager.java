...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    @Override // android.support.p086v7.widget.LinearLayoutManager
    ...
    */
    void layoutChunk(android.support.p086v7.widget.RecyclerView.Recycler r19, android.support.p086v7.widget.RecyclerView.State r20, android.support.p086v7.widget.LinearLayoutManager.LayoutState r21, android.support.p086v7.widget.LinearLayoutManager.LayoutChunkResult r22) {
        /*
            Method dump skipped, instructions count: 586
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p086v7.widget.GridLayoutManager.layoutChunk(android.support.v7.widget.RecyclerView$Recycler, android.support.v7.widget.RecyclerView$State, android.support.v7.widget.LinearLayoutManager$LayoutState, android.support.v7.widget.LinearLayoutManager$LayoutChunkResult):void");
    }
 ...
 */
    ...
    public View onFocusSearchFailed(View view, int i, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        while (true) {
            ...
            int spanGroupIndex2 = getSpanGroupIndex(recycler2, state2, i3);
