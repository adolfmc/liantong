...
import android.support.p083v4.widget.CursorAdapter;
 ...
 */
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1276R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C1276R.styleable.SearchView, i, 0);
        LayoutInflater.from(context).inflate(obtainStyledAttributes.getResourceId(C1276R.styleable.SearchView_layout, C1276R.C1280layout.abc_search_view), (ViewGroup) this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C1276R.C1279id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C1276R.C1279id.search_edit_frame);
        this.mSearchPlate = findViewById(C1276R.C1279id.search_plate);
        this.mSubmitArea = findViewById(C1276R.C1279id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C1276R.C1279id.search_button);
        this.mGoButton = (ImageView) findViewById(C1276R.C1279id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C1276R.C1279id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C1276R.C1279id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C1276R.C1279id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, obtainStyledAttributes.getDrawable(C1276R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, obtainStyledAttributes.getDrawable(C1276R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(obtainStyledAttributes.getDrawable(C1276R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(obtainStyledAttributes.getDrawable(C1276R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(obtainStyledAttributes.getDrawable(C1276R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(obtainStyledAttributes.getDrawable(C1276R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(obtainStyledAttributes.getDrawable(C1276R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = obtainStyledAttributes.getDrawable(C1276R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C1276R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = obtainStyledAttributes.getResourceId(C1276R.styleable.SearchView_suggestionRowLayout, C1276R.C1280layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = obtainStyledAttributes.getResourceId(C1276R.styleable.SearchView_commitIcon, 0);
        ...
        setIconifiedByDefault(obtainStyledAttributes.getBoolean(C1276R.styleable.SearchView_iconifiedByDefault, true));
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C1276R.styleable.SearchView_android_maxWidth, -1);
        if (dimensionPixelSize != -1) {
            setMaxWidth(dimensionPixelSize);
        }
        this.mDefaultQueryHint = obtainStyledAttributes.getText(C1276R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = obtainStyledAttributes.getText(C1276R.styleable.SearchView_queryHint);
        int i2 = obtainStyledAttributes.getInt(C1276R.styleable.SearchView_android_imeOptions, -1);
        if (i2 != -1) {
            setImeOptions(i2);
        }
        int i3 = obtainStyledAttributes.getInt(C1276R.styleable.SearchView_android_inputType, -1);
        if (i3 != -1) {
            setInputType(i3);
        }
        setFocusable(obtainStyledAttributes.getBoolean(C1276R.styleable.SearchView_android_focusable, true));
    ...
    @Override // android.support.p086v7.widget.LinearLayoutCompat, android.view.View
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // android.support.p086v7.widget.LinearLayoutCompat, android.view.ViewGroup, android.view.View
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C1276R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C1276R.dimen.abc_search_view_preferred_height);
    }
    ...
    @Override // android.support.p086v7.view.CollapsibleActionView
 ...
 */
    ...
    void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int dimensionPixelSize = this.mIconifiedByDefault ? resources.getDimensionPixelSize(C1276R.dimen.abc_dropdownitem_icon_width) + resources.getDimensionPixelSize(C1276R.dimen.abc_dropdownitem_text_padding_left) : 0;
 ...
 */
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeSet) {
            this(context, attributeSet, C1276R.attr.autoCompleteTextViewStyle);
        }
        ...
        @Override // android.support.p086v7.widget.AppCompatAutoCompleteTextView, android.widget.TextView, android.view.View
