...
import android.support.p086v7.view.menu.ShowableListMenu;
import android.support.p086v7.widget.ActivityChooserModel;
...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1276R.styleable.ActivityChooserView, i, 0);
        this.mInitialActivityCount = obtainStyledAttributes.getInt(C1276R.styleable.ActivityChooserView_initialActivityCount, 4);
        Drawable drawable = obtainStyledAttributes.getDrawable(C1276R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        obtainStyledAttributes.recycle();
        LayoutInflater.from(getContext()).inflate(C1276R.C1280layout.abc_activity_chooser_view, (ViewGroup) this, true);
        this.mCallbacks = new Callbacks();
        this.mActivityChooserContent = findViewById(C1276R.C1279id.activity_chooser_view_content);
        this.mActivityChooserContentBackground = this.mActivityChooserContent.getBackground();
        this.mDefaultActivityButton = (FrameLayout) findViewById(C1276R.C1279id.default_activity_button);
        this.mDefaultActivityButton.setOnClickListener(this.mCallbacks);
        this.mDefaultActivityButton.setOnLongClickListener(this.mCallbacks);
        this.mDefaultActivityButtonImage = (ImageView) this.mDefaultActivityButton.findViewById(C1276R.C1279id.image);
        FrameLayout frameLayout = (FrameLayout) findViewById(C1276R.C1279id.expand_activities_button);
        ...
        frameLayout.setOnTouchListener(new ForwardingListener(frameLayout) { // from class: android.support.v7.widget.ActivityChooserView.4
            @Override // android.support.p086v7.widget.ForwardingListener
        ...
        this.mExpandActivityOverflowButtonImage = (ImageView) frameLayout.findViewById(C1276R.C1279id.image);
        ...
        this.mListPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C1276R.dimen.abc_config_prefDialogWidth));
    }

    @Override // android.support.p086v7.widget.ActivityChooserModel.ActivityChooserModelClient
    ...
    void showPopupUnchecked(int i) {
        ...
        listPopupWindow.getListView().setContentDescription(getContext().getString(C1276R.string.abc_activitychooserview_choose_application));
 ...
 */
    ...
    public class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            switch (getItemViewType(i)) {
                case 0:
                    if (view == null || view.getId() != C1276R.C1279id.list_item) {
                        view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C1276R.C1280layout.abc_activity_chooser_view_list_item, viewGroup, false);
                    }
                    PackageManager packageManager = ActivityChooserView.this.getContext().getPackageManager();
                    ResolveInfo resolveInfo = (ResolveInfo) getItem(i);
                    ((ImageView) view.findViewById(C1276R.C1279id.icon)).setImageDrawable(resolveInfo.loadIcon(packageManager));
                    ((TextView) view.findViewById(C1276R.C1279id.title)).setText(resolveInfo.loadLabel(packageManager));
                ...
                case 1:
                    if (view == null || view.getId() != 1) {
                        View inflate = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C1276R.C1280layout.abc_activity_chooser_view_list_item, viewGroup, false);
                        inflate.setId(1);
                        ((TextView) inflate.findViewById(C1276R.C1279id.title)).setText(ActivityChooserView.this.getContext().getString(C1276R.string.abc_activity_chooser_view_see_all));
                        return inflate;
                    }
                    return view;
                default:
