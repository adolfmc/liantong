...
public class ActionBarOverlayLayout extends ViewGroup implements NestedScrollingParent, DecorContentParent {
    ...
    static final int[] ATTRS = {C1276R.attr.actionBarSize, 16842841};
 ...
 */
    ...
    @Override // android.support.p086v7.widget.DecorContentParent
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C1276R.C1279id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C1276R.C1279id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C1276R.C1279id.action_bar));
        }
    }
