...
public abstract class AbsActionBarView extends ViewGroup {
    ...
    public AbsActionBarView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (context.getTheme().resolveAttribute(C1276R.attr.actionBarPopupTheme, typedValue, true) && typedValue.resourceId != 0) {
    ...
    protected void onConfigurationChanged(Configuration configuration) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(null, C1276R.styleable.ActionBar, C1276R.attr.actionBarStyle, 0);
        setContentHeight(obtainStyledAttributes.getLayoutDimension(C1276R.styleable.ActionBar_height, 0));
 ...
 */
    ...
    public class VisibilityAnimListener implements ViewPropertyAnimatorListener {
        ...
        @Override // android.support.p083v4.view.ViewPropertyAnimatorListener
