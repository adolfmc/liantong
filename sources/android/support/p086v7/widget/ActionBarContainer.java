...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1276R.styleable.ActionBar);
        this.mBackground = obtainStyledAttributes.getDrawable(C1276R.styleable.ActionBar_background);
        this.mStackedBackground = obtainStyledAttributes.getDrawable(C1276R.styleable.ActionBar_backgroundStacked);
        this.mHeight = obtainStyledAttributes.getDimensionPixelSize(C1276R.styleable.ActionBar_height, -1);
        if (getId() == C1276R.C1279id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = obtainStyledAttributes.getDrawable(C1276R.styleable.ActionBar_backgroundSplit);
        }
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C1276R.C1279id.action_bar);
        this.mContextView = findViewById(C1276R.C1279id.action_context_bar);
    }
