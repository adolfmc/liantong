...
import android.support.p083v4.widget.ListViewAutoScrollHelper;
...
public class DropDownListView extends ListView {
    ...
    public DropDownListView(Context context, boolean z) {
        super(context, null, C1276R.attr.dropDownListViewStyle);
    ...
    */
    public boolean onForwardedEvent(android.view.MotionEvent r8, int r9) {
        ...
        L6a:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p086v7.widget.DropDownListView.onForwardedEvent(android.view.MotionEvent, int):boolean");
    }
