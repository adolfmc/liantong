...
public class AppCompatTextView extends TextView implements TintableBackgroundView, AutoSizeableTextView {
    ...
    @Override // android.widget.TextView
    public void setFirstBaselineToTopHeight(@IntRange(from = 0) @InterfaceC0839Px int i) {
    ...
    @Override // android.widget.TextView
    public void setLastBaselineToBottomHeight(@IntRange(from = 0) @InterfaceC0839Px int i) {
        if (Build.VERSION.SDK_INT >= 28) {
    ...
    @Override // android.widget.TextView
    public void setLineHeight(@IntRange(from = 0) @InterfaceC0839Px int i) {
