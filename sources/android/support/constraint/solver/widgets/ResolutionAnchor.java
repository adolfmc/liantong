    ...
    public void resolve() {
        ...
        if (this.type == 1 && ((resolutionAnchor7 = this.target) == null || resolutionAnchor7.state == 1)) {
            ...
            if (z) {
                ...
                resolutionAnchor10.resolvedOffset = resolutionAnchor10.target.resolvedOffset + f4 + (f5 * f2);
                ...
                resolutionAnchor11.resolvedOffset = (resolutionAnchor11.target.resolvedOffset - f4) - (f5 * (1.0f - f2));
            }
            didResolve();
