 ...
 */
    ...
    public SolverVariable createObjectVariable(Object obj) {
        ...
        if (obj instanceof ConstraintAnchor) {
            ...
            if (solverVariable.f2450id == -1 || solverVariable.f2450id > this.mVariablesID || this.mCache.mIndexedVariables[solverVariable.f2450id] == null) {
                if (solverVariable.f2450id != -1) {
                    solverVariable.reset();
                }
                this.mVariablesID++;
                this.mNumColumns++;
                solverVariable.f2450id = this.mVariablesID;
    ...
    public SolverVariable createSlackVariable() {
        ...
        this.mVariablesID++;
        this.mNumColumns++;
        acquireSolverVariable.f2450id = this.mVariablesID;
    ...
    private final int optimize(Row row, boolean z) {
        ...
        while (!z2) {
            ...
            if (row.getKey() != null) {
                this.mAlreadyTestedCandidates[row.getKey().f2450id] = true;
            }
            SolverVariable pivotCandidate = row.getPivotCandidate(this, this.mAlreadyTestedCandidates);
            if (pivotCandidate != null) {
                if (this.mAlreadyTestedCandidates[pivotCandidate.f2450id]) {
                    return i2;
                }
                this.mAlreadyTestedCandidates[pivotCandidate.f2450id] = true;
            }
            if (pivotCandidate != null) {
