...
import android.support.p083v4.text.PrecomputedTextCompat;
 ...
 */
    ...
    public static void setFirstBaselineToTopHeight(@NonNull TextView textView, @IntRange(from = 0) @InterfaceC0839Px int i) {
        int i2;
    ...
    public static void setLastBaselineToBottomHeight(@NonNull TextView textView, @IntRange(from = 0) @InterfaceC0839Px int i) {
        int i2;
        Preconditions.checkArgumentNonnegative(i);
        Paint.FontMetricsInt fontMetricsInt = textView.getPaint().getFontMetricsInt();
        if (Build.VERSION.SDK_INT < 16 || textView.getIncludeFontPadding()) {
    ...
    public static void setLineHeight(@NonNull TextView textView, @IntRange(from = 0) @InterfaceC0839Px int i) {
        Preconditions.checkArgumentNonnegative(i);
