 ...
 */
    ...
    public static abstract class Callback {
        ...
        public void onViewPositionChanged(@NonNull View view, int i, int i2, @InterfaceC0839Px int i3, @InterfaceC0839Px int i4) {
        }
    ...
    */
    public boolean shouldInterceptTouchEvent(@android.support.annotation.NonNull android.view.MotionEvent r17) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p083v4.widget.ViewDragHelper.shouldInterceptTouchEvent(android.view.MotionEvent):boolean");
    }
