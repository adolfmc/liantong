...
public final class ColorUtils {
    ...
    public static void RGBToHSL(@IntRange(from = 0, m22209to = 255) int i, @IntRange(from = 0, m22209to = 255) int i2, @IntRange(from = 0, m22209to = 255) int i3, @NonNull float[] fArr) {
        float f;
        float abs;
        float f2 = i / 255.0f;
        float f3 = i2 / 255.0f;
    ...
    public static void RGBToLAB(@IntRange(from = 0, m22209to = 255) int i, @IntRange(from = 0, m22209to = 255) int i2, @IntRange(from = 0, m22209to = 255) int i3, @NonNull double[] dArr) {
    ...
    public static void RGBToXYZ(@IntRange(from = 0, m22209to = 255) int i, @IntRange(from = 0, m22209to = 255) int i2, @IntRange(from = 0, m22209to = 255) int i3, @NonNull double[] dArr) {
        if (dArr.length != 3) {
    ...
    public static void XYZToLAB(@FloatRange(from = 0.0d, m22210to = 95.047d) double d, @FloatRange(from = 0.0d, m22210to = 100.0d) double d2, @FloatRange(from = 0.0d, m22210to = 108.883d) double d3, @NonNull double[] dArr) {
        if (dArr.length != 3) {
    ...
    public static void LABToXYZ(@FloatRange(from = 0.0d, m22210to = 100.0d) double d, @FloatRange(from = -128.0d, m22210to = 127.0d) double d2, @FloatRange(from = -128.0d, m22210to = 127.0d) double d3, @NonNull double[] dArr) {
    ...
    @ColorInt
    public static int XYZToColor(@FloatRange(from = 0.0d, m22210to = 95.047d) double d, @FloatRange(from = 0.0d, m22210to = 100.0d) double d2, @FloatRange(from = 0.0d, m22210to = 108.883d) double d3) {
    ...
    @ColorInt
    public static int LABToColor(@FloatRange(from = 0.0d, m22210to = 100.0d) double d, @FloatRange(from = -128.0d, m22210to = 127.0d) double d2, @FloatRange(from = -128.0d, m22210to = 127.0d) double d3) {
        double[] tempDouble3Array = getTempDouble3Array();
    ...
    @ColorInt
    public static int blendARGB(@ColorInt int i, @ColorInt int i2, @FloatRange(from = 0.0d, m22210to = 1.0d) float f) {
        float f2 = 1.0f - f;
        return Color.argb((int) ((Color.alpha(i) * f2) + (Color.alpha(i2) * f)), (int) ((Color.red(i) * f2) + (Color.red(i2) * f)), (int) ((Color.green(i) * f2) + (Color.green(i2) * f)), (int) ((Color.blue(i) * f2) + (Color.blue(i2) * f)));
    }

    public static void blendHSL(@NonNull float[] fArr, @NonNull float[] fArr2, @FloatRange(from = 0.0d, m22210to = 1.0d) float f, @NonNull float[] fArr3) {
        if (fArr3.length != 3) {
    ...
    public static void blendLAB(@NonNull double[] dArr, @NonNull double[] dArr2, @FloatRange(from = 0.0d, m22210to = 1.0d) double d, @NonNull double[] dArr3) {
        if (dArr3.length != 3) {
