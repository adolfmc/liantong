 ...
 */
    ...
    */
    private static void extract(java.lang.String r8, int r9, android.support.p083v4.graphics.PathParser.ExtractFloatResult r10) {
        /*
            r0 = 0
        ...
        L41:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p083v4.graphics.PathParser.extract(java.lang.String, int, android.support.v4.graphics.PathParser$ExtractFloatResult):void");
    }
            ...
            while (i3 < fArr2.length) {
                ...
                switch (c2) {
                    ...
                    case 'a':
                        ...
                        float f35 = f12;
                        i2 = i3;
                        drawArc(path, f12, f13, f30, f31, f32, f33, f34, fArr2[i3 + 3] != 0.0f ? true : z, fArr2[i3 + 4] != 0.0f ? true : z);
                        f12 = f35 + fArr2[i26];
                        f13 += fArr2[i27];
                        f9 = f13;
                        f8 = f12;
