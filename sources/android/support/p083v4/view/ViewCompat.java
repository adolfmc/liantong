...
import android.support.p083v4.view.accessibility.AccessibilityNodeProviderCompat;
 ...
 */
    ...
    public static void setPaddingRelative(@NonNull View view, @InterfaceC0839Px int i, @InterfaceC0839Px int i2, @InterfaceC0839Px int i3, @InterfaceC0839Px int i4) {
        if (Build.VERSION.SDK_INT >= 17) {
    ...
    @Deprecated
    public static void setAlpha(View view, @FloatRange(from = 0.0d, m22210to = 1.0d) float f) {
        view.setAlpha(f);
    }
    ...
    public static void addOnUnhandledKeyEventListener(@NonNull View view, @NonNull OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
        if (Build.VERSION.SDK_INT >= 28) {
            Map map = (Map) view.getTag(C0846R.C0849id.tag_unhandled_key_listeners);
            if (map == null) {
                map = new ArrayMap();
                view.setTag(C0846R.C0849id.tag_unhandled_key_listeners, map);
            }
        ...
        ArrayList arrayList = (ArrayList) view.getTag(C0846R.C0849id.tag_unhandled_key_listeners);
        if (arrayList == null) {
            arrayList = new ArrayList();
            view.setTag(C0846R.C0849id.tag_unhandled_key_listeners, arrayList);
        }
 ...
 */
    ...
    public static boolean dispatchUnhandledKeyEventBeforeHierarchy(View view, KeyEvent keyEvent) {
        ...
        return UnhandledKeyEventManager.m22204at(view).preDispatch(keyEvent);
    }
    ...
    public static boolean dispatchUnhandledKeyEventBeforeCallback(View view, KeyEvent keyEvent) {
        ...
        return UnhandledKeyEventManager.m22204at(view).dispatch(view, keyEvent);
    }
 ...
 */
    ...
    static class UnhandledKeyEventManager {
        ...
        /* renamed from: at */
        static UnhandledKeyEventManager m22204at(View view) {
            UnhandledKeyEventManager unhandledKeyEventManager = (UnhandledKeyEventManager) view.getTag(C0846R.C0849id.tag_unhandled_key_event_manager);
            if (unhandledKeyEventManager == null) {
                UnhandledKeyEventManager unhandledKeyEventManager2 = new UnhandledKeyEventManager();
                view.setTag(C0846R.C0849id.tag_unhandled_key_event_manager, unhandledKeyEventManager2);
