 ...
 */
    ...
    public static final class ReceiverRecord {
        ...
        final IntentFilter f27849filter;
        final BroadcastReceiver receiver;

        ReceiverRecord(IntentFilter intentFilter, BroadcastReceiver broadcastReceiver) {
            this.f27849filter = intentFilter;
    ...
    public void unregisterReceiver(@NonNull BroadcastReceiver broadcastReceiver) {
        synchronized (this.mReceivers) {
            ...
            for (int size = remove.size() - 1; size >= 0; size--) {
                ...
                for (int i = 0; i < receiverRecord.f27849filter.countActions(); i++) {
                    String action = receiverRecord.f27849filter.getAction(i);
        ...
        synchronized (this.mReceivers) {
            ...
            if (arrayList3 != null) {
                ...
                while (i2 < arrayList3.size()) {
                    ...
                    if (z) {
                        Log.v("LocalBroadcastManager", "Matching against filter " + receiverRecord.f27849filter);
                    }
                    if (!receiverRecord.broadcasting) {
                        ...
                        int match = receiverRecord.f27849filter.match(action, resolveTypeIfNeeded, scheme, data, categories, "LocalBroadcastManager");
                        if (match >= 0) {
                            if (z) {
