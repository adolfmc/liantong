...
import android.support.p083v4.widget.ExploreByTouchHelper;
...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate {
    ...
    public Chip(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0884R.attr.chipStyle);
    }
    ...
    public Chip(Context context, AttributeSet attributeSet, int i) {
        ...
        ChipDrawable createFromAttributes = ChipDrawable.createFromAttributes(context, attributeSet, i, C0884R.C0890style.Widget_MaterialComponents_Chip_Action);
 ...
 */
    ...
    public class ChipTouchHelper extends ExploreByTouchHelper {
        ...
        @Override // android.support.p083v4.widget.ExploreByTouchHelper
        ...
        public void onPopulateNodeForVirtualView(int i, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            if (Chip.this.hasCloseIcon()) {
                ...
                if (closeIconContentDescription != null) {
                    ...
                    int i2 = C0884R.string.mtrl_chip_close_icon_content_description;
