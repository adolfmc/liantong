...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C0884R.C0889layout.design_bottom_navigation_item, (ViewGroup) this, true);
        setBackgroundResource(C0884R.C0886drawable.design_bottom_navigation_item_background);
        this.defaultMargin = resources.getDimensionPixelSize(C0884R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C0884R.C0887id.icon);
        this.smallLabel = (TextView) findViewById(C0884R.C0887id.smallLabel);
        this.largeLabel = (TextView) findViewById(C0884R.C0887id.largeLabel);
    ...
    @Override // android.view.View, android.support.p086v7.view.menu.MenuView.ItemView
