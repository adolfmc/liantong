...
import android.support.p083v4.widget.Space;
...
public final class IndicatorViewController {
    ...
    public IndicatorViewController(TextInputLayout textInputLayout) {
        ...
        this.captionTranslationYPx = this.context.getResources().getDimensionPixelSize(C0884R.dimen.design_textinput_caption_translate_y);
    }
    ...
    public void setErrorEnabled(boolean z) {
        ...
        if (z) {
            ...
            this.errorView.setId(C0884R.C0887id.textinput_error);
    ...
    public void setHelperTextEnabled(boolean z) {
        ...
        if (z) {
            ...
            this.helperTextView.setId(C0884R.C0887id.textinput_helper_text);
            Typeface typeface = this.typeface;
            if (typeface != null) {
