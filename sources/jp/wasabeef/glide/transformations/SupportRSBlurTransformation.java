...
public class SupportRSBlurTransformation extends BitmapTransformation {
    ...
    /* renamed from: ID */
    private static final String f24870ID = "jp.wasabeef.glide.transformations.SupportRSBlurTransformation.1";
    ...
    @Override // jp.wasabeef.glide.transformations.BitmapTransformation, com.bumptech.glide.load.Key
    public int hashCode() {
        return f24870ID.hashCode() + (this.radius * 1000) + (this.sampling * 10);
    }

    @Override // jp.wasabeef.glide.transformations.BitmapTransformation, com.bumptech.glide.load.Key
    public void updateDiskCacheKey(@NonNull MessageDigest messageDigest) {
        messageDigest.update((f24870ID + this.radius + this.sampling).getBytes(CHARSET));
    }
}
