...
import com.tydic.softphone.tydic_tracker.app.TYUtil;
...
public class TyDB {
    ...
    public JSONArray FindAllBreakdown() throws JSONException {
        ...
        while (query.moveToNext()) {
            query.getString(query.getColumnIndex("ses_id"));
            String string = query.getString(query.getColumnIndex("class_name"));
            String string2 = query.getString(query.getColumnIndex("method_name"));
            String string3 = query.getString(query.getColumnIndex("lineNum"));
            String string4 = query.getString(query.getColumnIndex("track_details"));
            Integer.parseInt(query.getString(query.getColumnIndex("is_thread_break")));
            query.getString(query.getColumnIndex("timestamp"));
            query.getString(query.getColumnIndex("collect_time"));
            query.getString(query.getColumnIndex("target_name"));
            query.getString(query.getColumnIndex("crash_name"));
            ...
            jSONObject.put("class_name", string);
            jSONObject.put("method_name", string2);
            jSONObject.put("lineNum", string3);
            jSONObject.put("track_details", string4);
            jSONArray.put(jSONObject);
        }
        return jSONArray;
    }
