...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f17692CR = 13;

    /* renamed from: LF */
    private static final byte f17693LF = 10;
    private byte[] buf;
    private final Charset charset;
    private int end;

    /* renamed from: in */
    private final InputStream f17694in;
    private int pos;
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f17694in;
        byte[] bArr = this.buf;
