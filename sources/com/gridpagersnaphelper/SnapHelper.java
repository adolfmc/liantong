...
public abstract class SnapHelper extends RecyclerView.OnFlingListener {
    ...
    private final RecyclerView.OnScrollListener mScrollListener = new RecyclerView.OnScrollListener() { // from class: com.gridpagersnaphelper.SnapHelper.1
    ...
    @Override // android.support.p086v7.widget.RecyclerView.OnFlingListener
    ...
    protected LinearSmoothScroller createSnapScroller(RecyclerView.LayoutManager layoutManager) {
        if (layoutManager instanceof RecyclerView.SmoothScroller.ScrollVectorProvider) {
            return new LinearSmoothScroller(this.mRecyclerView.getContext()) { // from class: com.gridpagersnaphelper.SnapHelper.2
