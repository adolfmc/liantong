 ...
 */
    ...
    @Override // com.nineoldandroids.animation.Animator
    /* renamed from: clone */
    public ValueAnimator mo24477clone() {
        ValueAnimator valueAnimator = (ValueAnimator) super.mo24477clone();
        ArrayList<AnimatorUpdateListener> arrayList = this.mUpdateListeners;
        if (arrayList != null) {
        ...
        if (propertyValuesHolderArr != null) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                PropertyValuesHolder mo24481clone = propertyValuesHolderArr[i2].mo24481clone();
                valueAnimator.mValues[i2] = mo24481clone;
                valueAnimator.mValuesMap.put(mo24481clone.getPropertyName(), mo24481clone);
            }
        }
        return valueAnimator;
    }
