...
public final class AnimatorSet extends Animator {
    ...
    public void start() {
        ...
        if (this.mStartDelay <= 0) {
            ...
            this.mDelayAnim.addListener(new C68081(arrayList));
    ...
    /* loaded from: E:\11480076_dexfile_execute.dex.fixout.dex */
    public class C68081 extends AnimatorListenerAdapter {
        boolean canceled = false;
        final /* synthetic */ ArrayList val$nodesToStart;

        C68081(ArrayList arrayList) {
    ...
    @Override // com.nineoldandroids.animation.Animator
    /* renamed from: clone */
    public AnimatorSet mo24477clone() {
        AnimatorSet animatorSet = (AnimatorSet) super.mo24477clone();
        ...
        while (it.hasNext()) {
            Node next = it.next();
            Node m24478clone = next.m24478clone();
            hashMap.put(next, m24478clone);
            animatorSet.mNodes.add(m24478clone);
            animatorSet.mNodeMap.put(m24478clone.animation, m24478clone);
            ArrayList arrayList = null;
            m24478clone.dependencies = null;
            m24478clone.tmpDependencies = null;
            m24478clone.nodeDependents = null;
            m24478clone.nodeDependencies = null;
            ArrayList<Animator.AnimatorListener> listeners = m24478clone.animation.getListeners();
            if (listeners != null) {
 ...
 */
    ...
    public static class Node implements Cloneable {
        ...
        /* renamed from: clone */
        public Node m24478clone() {
            try {
                Node node = (Node) super.clone();
                node.animation = this.animation.mo24477clone();
                return node;
