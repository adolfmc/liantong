...
public abstract class GenerateFragmentActivityWrapper extends FragmentActivity implements InterfaceC3956a {
    ...
    @Override // com.bytedance.pangle.wrapper.InterfaceC3956a
    ...
    @Override // android.support.p083v4.app.FragmentActivity
    public void setEnterSharedElementCallback(android.support.p083v4.app.SharedElementCallback sharedElementCallback) {
        this.mOriginActivity.setEnterSharedElementCallback(sharedElementCallback);
    }

    @Override // android.support.p083v4.app.FragmentActivity
    public void setExitSharedElementCallback(android.support.p083v4.app.SharedElementCallback sharedElementCallback) {
        this.mOriginActivity.setExitSharedElementCallback(sharedElementCallback);
    }

    @Override // android.support.p083v4.app.ComponentActivity, android.support.p083v4.view.KeyEventDispatcher.Component
    public boolean superDispatchKeyEvent(KeyEvent keyEvent) {
        return this.mOriginActivity.superDispatchKeyEvent(keyEvent);
    }

    @Override // android.support.p083v4.app.FragmentActivity, android.arch.lifecycle.ViewModelStoreOwner
    ...
    @Override // android.support.p083v4.app.FragmentActivity
    public void onAttachFragment(android.support.p083v4.app.Fragment fragment) {
        this.mOriginActivity.onAttachFragment(fragment);
    }

    @Override // android.support.p083v4.app.FragmentActivity
    public void startActivityFromFragment(android.support.p083v4.app.Fragment fragment, Intent intent, int i) {
        this.mOriginActivity.startActivityFromFragment(fragment, intent, i);
    }

    @Override // android.support.p083v4.app.FragmentActivity
    public void startActivityFromFragment(android.support.p083v4.app.Fragment fragment, Intent intent, int i, Bundle bundle) {
        this.mOriginActivity.startActivityFromFragment(fragment, intent, i, bundle);
    }

    @Override // android.support.p083v4.app.FragmentActivity
    public void startIntentSenderFromFragment(android.support.p083v4.app.Fragment fragment, IntentSender intentSender, int i, Intent intent, int i2, int i3, int i4, Bundle bundle) {
        this.mOriginActivity.startIntentSenderFromFragment(fragment, intentSender, i, intent, i2, i3, i4, bundle);
    }

    @Override // android.support.p083v4.app.ComponentActivity
    ...
    @Override // android.support.p083v4.app.FragmentActivity
    public android.support.p083v4.app.LoaderManager getSupportLoaderManager() {
