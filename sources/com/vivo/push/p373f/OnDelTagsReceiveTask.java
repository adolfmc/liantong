...
final class OnDelTagsReceiveTask extends OnReceiveTask {
    /* JADX INFO: Access modifiers changed from: package-private */
    public OnDelTagsReceiveTask(PushCommand pushCommand) {
        super(pushCommand);
    }
    ...
    public final void mo5492a(PushCommand pushCommand) {
        ...
        LogUtil.m5342c("OnDelTagsTask", "doTask,删除成功的标签 = " + m5768d + " 删除失败的= " + m5767e + " 错误码= " + i);
        ...
        if (arrayList.size() > 0 || arrayList3.size() > 0) {
            LogUtil.m5342c("OnDelTagsTask", "doTask1,删除成功的别名 = " + arrayList + " 删除失败的别名= " + arrayList3 + " 错误码= " + i);
            if (arrayList.size() > 0) {
                PushClientManager.m5648a();
                PushClientManager.m5623b(arrayList);
            }
            PushClientManager.m5648a().m5636a(onTagsReceiveCommand.m5770h(), i);
            PushClientThread.m5481b(new RunnableC10952m(this, i, arrayList, arrayList3, h));
        }
        if (arrayList2.size() > 0 || arrayList4.size() > 0) {
            LogUtil.m5342c("OnDelTagsTask", "doTask1,删除成功的标签 = " + arrayList + " 删除失败的标签= " + arrayList3 + " 错误码= " + i);
            if (arrayList2.size() > 0) {
                PushClientManager.m5648a().m5619c(arrayList2);
            }
            PushClientManager.m5648a().m5636a(onTagsReceiveCommand.m5770h(), i);
            PushClientThread.m5481b(new RunnableC10953n(this, i, arrayList2, arrayList4, h));
        }
    }
}
