...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{482}, "UA");
            add(new int[]{484}, "MD");
            add(new int[]{485}, JtDateUtil.f9701AM);
            add(new int[]{486}, "GE");
            add(new int[]{487}, "KZ");
            add(new int[]{489}, "HK");
            ...
            add(new int[]{520}, "GR");
            add(new int[]{DetectionAuthentic.GENERATED_START_RECORD}, "LB");
            add(new int[]{DetectionAuthentic.GENERATED_FAILED}, "CY");
            add(new int[]{DetectionAuthentic.GENERATED_STOP_RECORD}, "MK");
            add(new int[]{DetectionAuthentic.DETECT_LOG}, "MT");
            add(new int[]{539}, "IE");
