...
public final class Detector {
    ...
    public DetectorResult detect() throws NotFoundException {
        ...
        if (i * 4 >= i2 * 7 || i2 * 4 >= i * 7) {
            ...
            sampleGrid = sampleGrid(this.image, resultPoint2, resultPoint12, resultPoint11, correctTopRightRectangular, (transitions3 & 1) == 1 ? transitions3 + 1 : transitions3, (transitions4 & 1) == 1 ? transitions4 + 1 : transitions4);
        } else {
            ...
            sampleGrid = sampleGrid(this.image, resultPoint13, resultPoint12, resultPoint11, correctTopRightRectangular, i3, i3);
            resultPoint2 = resultPoint13;
        }
 ...
 */
    ...
    public static final class ResultPointsAndTransitions {
        ...
        /* renamed from: to */
        private final ResultPoint f10509to;
        private final int transitions;

        private ResultPointsAndTransitions(ResultPoint resultPoint, ResultPoint resultPoint2, int i) {
            this.from = resultPoint;
            this.f10509to = resultPoint2;
            this.transitions = i;
        }
        ...
        public String toString() {
            return this.from + "/" + this.f10509to + '/' + this.transitions;
        }
    }
