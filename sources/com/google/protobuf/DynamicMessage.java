...
public final class DynamicMessage extends AbstractMessage {
    ...
    public int getSerializedSize() {
        ...
        if (this.type.getOptions().getMessageSetWireFormat()) {
            serializedSize = this.fields.getMessageSetSerializedSize() + this.unknownFields.getSerializedSizeAsMessageSet();
        } else {
            serializedSize = this.fields.getSerializedSize() + this.unknownFields.getSerializedSize();
        }
 ...
 */
    ...
    public static final class Builder extends AbstractMessage.Builder<Builder> {
        ...
        private void ensureIsMutable() {
            if (this.fields.isImmutable()) {
                this.fields = this.fields.m24471clone();
            }
        }
