 ...
 */
    ...
    public FlatBufferBuilder(int i, ByteBufferFactory byteBufferFactory) {
        ...
        this.f10463bb = byteBufferFactory.newByteBuffer(i);
    }
    ...
    public FlatBufferBuilder init(ByteBuffer byteBuffer, ByteBufferFactory byteBufferFactory) {
        this.bb_factory = byteBufferFactory;
        this.f10463bb = byteBuffer;
        this.f10463bb.clear();
        this.f10463bb.order(ByteOrder.LITTLE_ENDIAN);
        this.minalign = 1;
        this.space = this.f10463bb.capacity();
        this.vtable_in_use = 0;
        this.nested = false;
        this.finished = false;
        this.object_start = 0;
 ...
 */
    ...
    public int offset() {
        return this.f10463bb.capacity() - this.space;
    }

    public void pad(int i) {
        for (int i2 = 0; i2 < i; i2++) {
            ByteBuffer byteBuffer = this.f10463bb;
            int i3 = this.space - 1;
            this.space = i3;
    ...
    public void prep(int i, int i2) {
        ...
        int i3 = ((~((this.f10463bb.capacity() - this.space) + i2)) + 1) & (i - 1);
        while (this.space < i3 + i + i2) {
            int capacity = this.f10463bb.capacity();
            this.f10463bb = growByteBuffer(this.f10463bb, this.bb_factory);
            this.space += this.f10463bb.capacity() - capacity;
        }
        pad(i3);
    }
    ...
    public ByteBuffer createUnintializedVector(int i, int i2, int i3) {
        ...
        ByteBuffer order = this.f10463bb.slice().order(ByteOrder.LITTLE_ENDIAN);
        order.limit(i4);
        return order;
    }
    ...
    public <T extends Table> int createSortedVectorOfTables(T t, int[] iArr) {
        t.sortTables(iArr, this.f10463bb);
    ...
    public int createString(ByteBuffer byteBuffer) {
        ...
        ByteBuffer byteBuffer2 = this.f10463bb;
        int i = this.space - remaining;
        this.space = i;
        byteBuffer2.position(i);
        this.f10463bb.put(byteBuffer);
        return endVector();
    }
    ...
    public int endObject() {
        ...
        loop2: while (true) {
            ...
            int capacity = this.f10463bb.capacity() - this.vtables[i4];
            int i5 = this.space;
            short s = this.f10463bb.getShort(capacity);
            if (s == this.f10463bb.getShort(i5)) {
                for (int i6 = 2; i6 < s; i6 += 2) {
                    if (this.f10463bb.getShort(capacity + i6) != this.f10463bb.getShort(i5 + i6)) {
                        break;
                    }
                }
                i = this.vtables[i4];
        ...
        if (i != 0) {
            this.space = this.f10463bb.capacity() - offset;
            this.f10463bb.putInt(this.space, i - offset);
        } else {
    ...
    public void required(int i, int i2) {
        int capacity = this.f10463bb.capacity() - i;
        if (this.f10463bb.getShort((capacity - this.f10463bb.getInt(capacity)) + i2) != 0) {
            return;
        }
    ...
    protected void finish(int i, boolean z) {
        ...
        addOffset(i);
        if (z) {
            addInt(this.f10463bb.capacity() - this.space);
        }
        this.f10463bb.position(this.space);
        this.finished = true;
    }
    ...
    public byte[] sizedByteArray(int i, int i2) {
        ...
        this.f10463bb.position(i);
        this.f10463bb.get(bArr);
        return bArr;
    }

    public byte[] sizedByteArray() {
        return sizedByteArray(this.space, this.f10463bb.capacity() - this.space);
    }

    public InputStream sizedInputStream() {
        finished();
        ByteBuffer duplicate = this.f10463bb.duplicate();
        duplicate.position(this.space);
        duplicate.limit(this.f10463bb.capacity());
