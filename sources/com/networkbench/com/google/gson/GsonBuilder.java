...
public final class GsonBuilder {
    ...
    public GsonBuilder registerTypeAdapter(Type type, Object obj) {
        ...
        if (z || (obj instanceof JsonDeserializer)) {
            this.factories.add(C6669b.m8653b(TypeToken.get(type), obj));
        }
        if (obj instanceof TypeAdapter) {
            this.factories.add(C6736m.m8585a(TypeToken.get(type), (TypeAdapter) obj));
        }
        return this;
    }
    ...
    public GsonBuilder registerTypeHierarchyAdapter(Class<?> cls, Object obj) {
        ...
        if ((obj instanceof JsonDeserializer) || z) {
            this.hierarchyFactories.add(0, C6669b.m8654a(cls, obj));
        }
        if (obj instanceof TypeAdapter) {
            this.factories.add(C6736m.m8582b(cls, (TypeAdapter) obj));
        }
        return this;
    }
    ...
    private void addTypeAdaptersForDate(String str, int i, int i2, List<TypeAdapterFactory> list) {
        ...
        if (str != null && !"".equals(str.trim())) {
            c6668a = new C6668a(str);
        } else if (i == 2 || i2 == 2) {
            return;
        } else {
            c6668a = new C6668a(i, i2);
        }
        list.add(C6669b.m8655a(TypeToken.get(Date.class), c6668a));
        list.add(C6669b.m8655a(TypeToken.get(Timestamp.class), c6668a));
        list.add(C6669b.m8655a(TypeToken.get(java.sql.Date.class), c6668a));
    }
}
