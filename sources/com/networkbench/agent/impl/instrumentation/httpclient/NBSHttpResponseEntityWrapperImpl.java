...
public final class NBSHttpResponseEntityWrapperImpl extends HttpEntityWrapper implements NBSStreamCompleteListener {
    ...
    public InputStream getContent() throws IOException, IllegalStateException {
        ...
        try {
            this.contentStream = new NBSCountingInputStream(this.impl.getContent(), this.impl instanceof HttpEntityWrapper ? true ^ ((HttpEntityWrapper) this.impl).isChunked() : true);
    ...
    /* renamed from: a */
    private void m9868a(NBSTransactionState nBSTransactionState) {
        try {
