...
public class Config {
    ...
    private Config(Context context, Builder builder) {
        ...
        if (TextUtils.isEmpty(builder.mAESKey)) {
            this.mAESKey = C11197bl.m4718a(context);
        } else {
    ...
    public static Config defaultConfig(Context context) {
        return getBuilder().setEventEncrypted(true).setAESKey(C11197bl.m4718a(context)).setMaxFileLength(1048576L).setEventUploadSwitchOpen(false).setEventUploadFrequency(86400L).setPerfUploadSwitchOpen(false).setPerfUploadFrequency(86400L).build(context);
    }
