...
import com.gmrz.asm.p198fp.akselector.FpAkSelector;
 ...
 */
/* renamed from: com.gmrz.asm.fp.descriptor.FpAuthenticatorDescriptor */
...
public class FpAuthenticatorDescriptor implements IAuthenticatorDescriptor {
  ...
  E:\10762272_dexfile_execute.dex.fixout.dex
 */
    /* renamed from: com.gmrz.asm.fp.descriptor.FpAuthenticatorDescriptor$UAFDescriptor */
    /* loaded from: E:\10762272_dexfile_execute.dex */
    ...
    public FpAuthenticatorDescriptor(Context context) {
        ...
        aAIDInfo.aaid = AAID.FINGER_ECC.name;
        if (Configurator.isEnableNewAAID(context)) {
            aAIDInfo.aaid = AAID.FINGER_ECC_NEW.name;
        }
        aAIDInfo.label = "keystore_label";
    ...
    /* renamed from: com.gmrz.asm.fp.descriptor.FpAuthenticatorDescriptor$OSTPDescriptor */
    ...
    public class OSTPDescriptor implements IAuthenticatorDescriptor.IOSTPDescriptor {
        ...
        public String getVersion() {
            try {
                return FpAuthenticatorDescriptor.this.mContext.getPackageManager().getPackageInfo(FpAuthenticatorDescriptor.this.mContext.getPackageName(), 0).versionName;
            } catch (Exception e) {
                e.printStackTrace();
                return "";
            }
