...
import com.gmrz.asm.p198fp.akselector.FpAttestationAkSelector;
 ...
 */
/* renamed from: com.gmrz.asm.fp.descriptor.FpAttestationAuthenticatorDescriptor */
/* loaded from: E:\10762272_dexfile_execute.dex */
public class FpAttestationAuthenticatorDescriptor implements IAuthenticatorDescriptor {
    public static final String AUTHENTICATOR_LABEL = "keystore_attestation_label";
  ...
  E:\10762272_dexfile_execute.dex.fixout.dex
 */
    /* renamed from: com.gmrz.asm.fp.descriptor.FpAttestationAuthenticatorDescriptor$UAFDescriptor */
    /* loaded from: E:\10762272_dexfile_execute.dex */
    ...
    public FpAttestationAuthenticatorDescriptor(Context context) {
        this.mContext = context;
        IAuthenticatorDescriptor.AAIDInfo aAIDInfo = new IAuthenticatorDescriptor.AAIDInfo();
        aAIDInfo.aaid = AAID.FINGER_HKA_ECC.name;
        aAIDInfo.label = "keystore_attestation_label";
    ...
    public Class<? extends IAKSelector> getAuthenticatorSelectorClass() {
        return FpAttestationAkSelector.class;
    }
    ...
    @Override // com.android.client.asm.sdk.IAuthenticatorDescriptor
    public int getTitle() {
        return C4439R.string.fp_title_ecdsa;
    }
    ...
    /* renamed from: com.gmrz.asm.fp.descriptor.FpAttestationAuthenticatorDescriptor$OSTPDescriptor */
    ...
    public class OSTPDescriptor implements IAuthenticatorDescriptor.IOSTPDescriptor {
        ...
        public String getVersion() {
            try {
                return FpAttestationAuthenticatorDescriptor.this.mContext.getPackageManager().getPackageInfo(FpAttestationAuthenticatorDescriptor.this.mContext.getPackageName(), 0).versionName;
            } catch (Exception e) {
                e.printStackTrace();
                return "";
            }
