...
/* renamed from: com.gmrz.asm.fp.authenticator.kernel.ecc.FpSoftwareAttestationAuthenticatorKernel */
/* loaded from: E:\10762272_dexfile_execute.dex.fixout.dex */
public class FpSoftwareAttestationAuthenticatorKernel extends KSAuthenticatorKernel implements IAuthenticatorKernel.IExtAuthenticatorKernel {
    private static final String TAG = "ECC-SKA-Kernel";
    private static final List<Extension> extensions = new ArrayList();

    /* renamed from: fc */
    private static byte[] f10357fc;
    private static boolean mIsRegistrationOp;
    private static Activity sCallerActivity;

    public FpSoftwareAttestationAuthenticatorKernel(Context context, IMatcher iMatcher) throws AKException {
    ...
    public String performInitJni(boolean z) {
        return AuthKernel.initJni(mContext, z, this, AAID.FINGER_SKA_ECC);
    }
    ...
    protected IMatcher.RESULT fpSignData(byte[] bArr, byte[] bArr2, Vector<byte[]> vector) throws Exception {
        ...
        byte[] signDataUsingAuthenticatedCrypto = signDataUsingAuthenticatedCrypto(bArr2, authenticatedSignature);
    ...
    protected byte[] generateKeypairUsingFpKeyStore() throws Exception {
        ...
        if (Build.VERSION.SDK_INT < 24) {
            ...
            generateKeyPairECDSA = CryptoStore.generateKeyPairECDSA(mContext, uuid, f10357fc);
        }
    ...
    public void extInit(AKProcessor.AKRequestParams aKRequestParams) {
        ...
        f10357fc = aKRequestParams.finalChallenge;
    }
