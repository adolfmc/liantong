 ...
 */
    ...
    private void initStyles(Context context) {
        ...
        context.getTheme().resolveAttribute(C9756R.attr.cropImageStyle, typedValue, true);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(typedValue.resourceId, C9756R.styleable.CropImageView);
        try {
            this.showThirds = obtainStyledAttributes.getBoolean(C9756R.styleable.CropImageView_showThirds, false);
            this.showCircle = obtainStyledAttributes.getBoolean(C9756R.styleable.CropImageView_showCircle, false);
            this.highlightColor = obtainStyledAttributes.getColor(C9756R.styleable.CropImageView_highlightColor, DEFAULT_HIGHLIGHT_COLOR);
            this.handleMode = HandleMode.values()[obtainStyledAttributes.getInt(C9756R.styleable.CropImageView_showHandles, 0)];
        } finally {
