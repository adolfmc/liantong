...
/* renamed from: com.ss.android.socialbase.downloader.impls.IndependentProcessDownloadHandler */
...
public class IndependentProcessDownloadHandler implements IDownloadProxy, IDownloadServiceConnectionListener {
    ...
    public void startForeground(int i, Notification notification) {
        if (this.aidlService == null) {
            Logger.m6460w(TAG, "startForeground, aidlService is null");
            return;
        }
        String str = TAG;
        Logger.m6469i(str, "aidlService.startForeground, id = " + i);
        try {
    ...
    public void stopForeground(boolean z, boolean z2) {
        if (this.aidlService == null) {
            Logger.m6460w(TAG, "stopForeground, aidlService is null");
            return;
        }
        Logger.m6469i(TAG, "aidlService.stopForeground");
        try {
    ...
    public boolean isServiceForeground() {
        if (this.aidlService == null) {
            Logger.m6460w(TAG, "isServiceForeground, aidlService is null");
            return false;
        }
        Logger.m6469i(TAG, "aidlService.isServiceForeground");
        try {
    ...
    @Override // com.p319ss.android.socialbase.downloader.downloader.IDownloadServiceConnectionListener
