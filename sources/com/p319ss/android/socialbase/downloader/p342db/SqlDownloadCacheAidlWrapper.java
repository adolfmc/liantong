...
import com.p319ss.android.socialbase.downloader.downloader.SqlDownloadCacheService;
...
/* renamed from: com.ss.android.socialbase.downloader.db.SqlDownloadCacheAidlWrapper */
 ...
 */
    /* renamed from: com.ss.android.socialbase.downloader.db.SqlDownloadCacheAidlWrapper$OnMainProcessRebindErrorListener */
    ...
    public boolean bindMainProcessDelayed() {
        if (Build.VERSION.SDK_INT < 26 && !sIsMainProcessAlive) {
            if (sBindMainProcessTimes > 5) {
                Logger.m6460w(TAG, "bindMainProcess: bind too many times!!! ");
                return false;
            }
            long currentTimeMillis = System.currentTimeMillis();
            if (currentTimeMillis - sLastBindMainProcessTimeMills < 15000) {
                Logger.m6460w(TAG, "bindMainProcess: time too short since last bind!!! ");
                return false;
            }
