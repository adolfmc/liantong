...
import com.p319ss.android.socialbase.downloader.downloader.IDownloadStartCallback;
...
public class DownloadTask {
    ...
    public void addListenerToDownloadingSameTask() {
        Logger.m6475d("DownloadTask", "same task just tryDownloading, so add listener in last task instead of tryDownload");
        DownloadInfo downloadInfo = this.downloadInfo;
