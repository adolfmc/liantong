...
public class PackageManagerCompat {
    ...
    public static String getAppPackageName(Context context) {
        ...
        try {
            ...
            Logger.m15045w("PackageUtils", "Failed to get Package managers Package Info");
            return "";
        }
    }
    ...
    private static Bundle getBundleFromApp(Context context) {
        ...
        try {
            ...
            Logger.m15044w("PackageUtils", "NameNotFoundException:", e);
            return bundle;
        }
    }
    ...
    private static Bundle getBundleFromKit(Context context) {
        ...
        if (context == null) {
            Logger.m15047v("PackageUtils", "the kitContext is null");
            return Bundle.EMPTY;
        } else if (context.getApplicationInfo() == null) {
            Logger.m15047v("PackageUtils", "the kit applicationInfo is null");
            return Bundle.EMPTY;
        } else {
    ...
    public static String getMetaDataFromKit(Context context, String str, String str2) {
        try {
            ...
            Logger.m15047v("PackageUtils", "the kit metaData is runtimeException");
            return str2;
        }
    }
