...
public class AssetsUtil {
    ...
    public static String[] list(final Context context, final String str) {
        if (context == null) {
            Logger.m15045w("AssetsUtil", "context is null");
            return new String[0];
        }
        ...
        try {
            ...
            Logger.m15044w("AssetsUtil", "get local config files from sp task interrupted", e);
            return new String[0];
        } catch (TimeoutException unused) {
            Logger.m15045w("AssetsUtil", "get local config files from sp task timed out");
            return new String[0];
        } catch (ExecutionException e2) {
            Logger.m15044w("AssetsUtil", "get local config files from sp task failed", e2);
            return new String[0];
        } catch (Exception unused2) {
            Logger.m15045w("AssetsUtil", "get local config files from sp task occur unknown Exception");
            return new String[0];
        } finally {
    ...
    public static InputStream open(Context context, String str) throws IOException {
        ...
        try {
            ...
            Logger.m15051e("AssetsUtil", "AssetManager has been destroyed", e);
            return null;
        }
    }
}
