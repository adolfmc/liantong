...
public class CountryCodeBean {
    ...
    private void getProductCountryCode() {
        ...
        String str = TAG;
        Logger.m15049i(str, "countryCode by ro.product.locale.region is: " + this.countryCode);
        if (TextUtils.isEmpty(this.countryCode) || "UNKNOWN".equals(this.countryCode)) {
            ...
            if (!TextUtils.isEmpty(property) && (lastIndexOf = property.lastIndexOf("-")) != -1) {
                ...
                String str2 = TAG;
                Logger.m15049i(str2, "countryCode by ro.product.locale is: " + this.countryCode);
            }
        }
    ...
    private void getRegionSettingCountryCode() {
        ...
        String str = TAG;
        Logger.m15049i(str, "countryCode by system's region setting is: " + this.countryCode);
    ...
    private void getSimCountryCode(Context context, boolean z) {
        ...
        if (telephonyManager != null) {
            ...
            Logger.m15049i(str, sb.toString());
        }
        checkCodeLenth();
    }
    ...
    private void getVendorCountryCode() {
        ...
        String str2 = TAG;
        Logger.m15049i(str2, "countryCode by ro.hw.country is: " + this.countryCode);
        if (SPECIAL_COUNTRYCODE_EU.equalsIgnoreCase(this.countryCode) || SPECIAL_COUNTRYCODE_LA.equalsIgnoreCase(this.countryCode)) {
            ...
            Logger.m15049i(TAG, "special country of UK to map GB.");
    ...
    private void init(Context context, boolean z) {
        ...
        try {
            ...
            if (isCodeValidate()) {
                Logger.m15049i(TAG, "get issue_country code from VENDOR_COUNTRY");
                return;
            }
            getSimCountryCode(context);
            if (isCodeValidate()) {
                Logger.m15049i(TAG, "get issue_country code from SIM_COUNTRY");
                return;
            }
            getLocaleCountryCode();
            if (isCodeValidate()) {
                Logger.m15049i(TAG, "get issue_country code from LOCALE_INFO");
            }
        } catch (Exception unused) {
            Logger.m15045w(TAG, "get CountryCode error");
        }
    }
