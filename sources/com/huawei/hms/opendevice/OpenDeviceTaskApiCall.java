...
public class OpenDeviceTaskApiCall extends TaskApiCall<OpenDeviceHmsClient, OdidResult> {
    ...
    public void doExecute(OpenDeviceHmsClient openDeviceHmsClient, ResponseErrorCode responseErrorCode, String str, TaskCompletionSource<OdidResult> taskCompletionSource) {
        ...
        HiAnalyticsClient.reportExit(openDeviceHmsClient.getContext(), getUri(), getTransactionId(), responseErrorCode.getStatusCode(), responseErrorCode.getErrorCode(), 61100100);
        if (responseErrorCode.getErrorCode() == 0) {
            HMSLog.m14110i("OpenDeviceTaskApiCall", "onResult, success");
        ...
        HMSLog.m14110i("OpenDeviceTaskApiCall", "onResult, returnCode: " + responseErrorCode.getErrorCode());
