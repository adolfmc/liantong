...
public class IPCTransport implements DatagramTransport {
    ...
    private int syncCall(ApiClient apiClient, IAIDLCallback iAIDLCallback) {
        if (apiClient instanceof InnerApiClient) {
            ...
            try {
                ...
                if (aidlApiClient.getService() == null) {
                    HMSLog.m14112e(TAG, "HuaweiApiClient is not binded to service yet.");
                    return 907135001;
                }
                aidlApiClient.getService().asyncCall(dataBuffer, iAIDLCallback);
                return 0;
            } catch (Exception e) {
                HMSLog.m14112e(TAG, "sync call ex:" + e);
                return 907135001;
            }
        }
        if (apiClient instanceof AidlApiClient) {
            ...
            try {
                ...
                HMSLog.m14112e(TAG, "sync call ex:" + e2);
            }
        }
        return 907135001;
    }
    ...
    public final void post(ApiClient apiClient, DatagramTransport.InterfaceC5073a interfaceC5073a) {
        send(apiClient, interfaceC5073a);
    }

    @Override // com.huawei.hms.support.api.transport.DatagramTransport
    public final void send(ApiClient apiClient, DatagramTransport.InterfaceC5073a interfaceC5073a) {
        int syncCall = syncCall(apiClient, new IPCCallback(this.mResponseClass, interfaceC5073a));
        if (syncCall != 0) {
            interfaceC5073a.mo14135a(syncCall, null);
        }
    }
