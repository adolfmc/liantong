...
public class SafeParcelWriter {
    ...
    /* renamed from: a */
    private static void m15093a(Parcel parcel, int i, int i2) {
        if (i2 >= 65535) {
    ...
    /* renamed from: b */
    private static void m15091b(Parcel parcel, int i) {
    ...
    public static void writeBigDecimal(Parcel parcel, int i, BigDecimal bigDecimal, boolean z) {
        ...
        int m15094a = m15094a(parcel, i);
        parcel.writeByteArray(bigDecimal.unscaledValue().toByteArray());
        parcel.writeInt(bigDecimal.scale());
        m15091b(parcel, m15094a);
    }
    ...
    public static <P extends Parcelable> void writeTypedArray(Parcel parcel, int i, P[] pArr, int i2, boolean z) {
        ...
        int m15094a = m15094a(parcel, i);
        parcel.writeInt(m15094a);
        int length = pArr.length;
        for (int i3 = 0; i3 < length; i3++) {
            if (pArr[i3] != null) {
                m15092a(parcel, pArr[i3], i2);
            } else {
                parcel.writeInt(0);
            }
        }
    ...
    /* renamed from: a */
    private static int m15094a(Parcel parcel, int i) {
        parcel.writeInt(i | (-65536));
        parcel.writeInt(0);
    ...
    /* renamed from: a */
    private static <P extends Parcelable> void m15092a(Parcel parcel, P p, int i) {
        int dataPosition = parcel.dataPosition();
        parcel.writeInt(1);
