 ...
 */
    ...
    /* renamed from: a */
    private static void m15096a(Parcel parcel, int i, int i2, int i3) {
        if (i2 == i3) {
            return;
        }
    ...
    /* renamed from: a */
    private static boolean m15099a(int i, int i2) {
        long j = i + i2;
        return j > 2147483647L || j < -2147483648L;
    }

    /* renamed from: b */
    private static void m15095b(Parcel parcel, int i, int i2) {
    ...
    public static BigDecimal createBigDecimal(Parcel parcel, int i) {
        ...
        m15097a(parcel, readSize, dataPosition);
    ...
    public static Parcel[] createParcelArray(Parcel parcel, int i) {
        ...
        for (int i2 = 0; i2 < readInt; i2++) {
            ...
            if (readInt2 == 0) {
                ...
                m15097a(parcel, readInt2, dataPosition2);
                Parcel obtain = Parcel.obtain();
    ...
    public static SparseArray<Parcel> createParcelSparseArray(Parcel parcel, int i) {
        ...
        for (int i2 = 0; i2 < readInt; i2++) {
            ...
            if (readInt3 == 0) {
                ...
                int dataPosition2 = parcel.dataPosition();
                m15097a(parcel, readInt3, dataPosition2);
                Parcel obtain = Parcel.obtain();
    ...
    /* renamed from: a */
    private static void m15097a(Parcel parcel, int i, int i2) {
        if (i < 0 || m15099a(i, i2)) {
    ...
    /* renamed from: a */
    private static void m15098a(Parcel parcel, int i) {
        if (i > 1024) {
