...
public class PushPreferences {
    ...
    /* renamed from: a */
    protected SharedPreferences f10889a;
    ...
    public PushPreferences(Context context, String str) {
        if (context != null) {
            ...
            SharedPreferences m15339b = m15339b(context, str);
            this.f10889a = m15339b;
            if (m15339b == null) {
                HMSLog.m14109w(TAG, "get new sharedPreferences failed,start to get from context. ");
                this.f10889a = context.getSharedPreferences(str, 0);
                return;
            }
            return;
        }
    ...
    /* renamed from: a */
    private File m15340a(Context context, String str) {
        File file;
        try {
            if (Build.VERSION.SDK_INT >= 24) {
            ...
            HMSLog.m14112e(TAG, "get failed error." + e.getMessage());
            return null;
        }
    }

    /* renamed from: b */
    private SharedPreferences m15339b(Context context, String str) {
        File m15340a = m15340a(context, str);
        if (m15340a == null) {
            return null;
        }
        try {
            ...
            return (SharedPreferences) declaredConstructor.newInstance(m15340a, 0);
        } catch (Exception e) {
            HMSLog.m14112e(TAG, "get SharedPreferences error." + e.getMessage());
            return null;
        }
    }

    public boolean clear() {
        SharedPreferences sharedPreferences = this.f10889a;
    ...
    public boolean removeKey(String str) {
        ...
        SharedPreferences sharedPreferences = this.f10889a;
        if (sharedPreferences == null || !sharedPreferences.contains(str) || (edit = this.f10889a.edit()) == null) {
            return false;
        }
    ...
    public boolean write(ContentValues contentValues) {
        if (this.f10889a == null || contentValues == null) {
            return false;
        }
        boolean z = true;
    ...
    public boolean removeKey(String[] strArr) {
        ...
        for (String str : strArr) {
            if (this.f10889a.contains(str)) {
                this.f10889a.edit().remove(str);
            }
        }
        this.f10889a.edit().commit();
        return true;
    }
}
