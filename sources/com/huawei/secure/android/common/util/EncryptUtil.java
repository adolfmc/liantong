...
public class EncryptUtil {
    ...
    /* renamed from: a */
    private static final String f12130a = "EncryptUtil";

    /* renamed from: b */
    private static final String f12131b = "RSA";
    ...
    */
    public static byte[] generateSecureRandom(int r3) {
        /*
            ...
            goto L15
        Ld:
            java.lang.String r0 = com.huawei.secure.android.common.util.EncryptUtil.f12130a
            java.lang.String r1 = "getSecureRandomBytes: NoSuchAlgorithmException"
            com.huawei.secure.android.common.util.LogsUtil.m13819e(r0, r1)
        L14:
            r0 = 0
        L15:
            if (r0 != 0) goto L1d
        ...
        L21:
            ...
            com.huawei.secure.android.common.util.LogsUtil.m13819e(r0, r3)
            goto L44
        L3d:
            java.lang.String r3 = com.huawei.secure.android.common.util.EncryptUtil.f12130a
            java.lang.String r0 = "getSecureRandomBytes getInstance: NoSuchAlgorithmException"
            com.huawei.secure.android.common.util.LogsUtil.m13819e(r3, r0)
        L44:
            r3 = 0
            byte[] r3 = new byte[r3]
            return r3
    ...
    public static PrivateKey getPrivateKey(String str) {
        try {
            try {
                ...
                String str2 = f12130a;
                LogsUtil.m13814e(str2, "load Key Exception:" + e.getMessage(), true);
                return null;
            }
        } catch (IllegalArgumentException unused) {
            LogsUtil.m13814e(f12130a, "base64 decode IllegalArgumentException", true);
            return null;
        } catch (Exception unused2) {
            LogsUtil.m13814e(f12130a, "base64 decode Exception", true);
            return null;
        }
    }
