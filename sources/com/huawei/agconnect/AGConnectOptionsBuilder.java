...
public final class AGConnectOptionsBuilder {
    ...
    public AGConnectOptions build(Context context) {
        return new C4771b(context, this.packageName, this.routePolicy, this.inputStream, this.customConfigMap, this.customServices, null);
    }

    public AGConnectOptions build(Context context, String str) {
        return new C4771b(context, this.packageName, this.routePolicy, this.inputStream, this.customConfigMap, this.customServices, str);
    }
