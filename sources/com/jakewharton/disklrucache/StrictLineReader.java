...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f12192CR = 13;

    /* renamed from: LF */
    private static final byte f12193LF = 10;
    private byte[] buf;
    private final Charset charset;
    private int end;

    /* renamed from: in */
    private final InputStream f12194in;
    private int pos;
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f12194in;
        byte[] bArr = this.buf;
