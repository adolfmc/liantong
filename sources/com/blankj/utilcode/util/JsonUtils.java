        ...
        try {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                ...
                if (charAt == '{') {
                    ...
                    return !(jSONObject instanceof JSONObject) ? jSONObject.toString(i) : NBSJSONObjectInstrumentation.toString(jSONObject, i);
                } else if (charAt == '[') {
                    JSONArray jSONArray = new JSONArray(str);
                    return !(jSONArray instanceof JSONArray) ? jSONArray.toString(i) : NBSJSONArrayInstrumentation.toString(jSONArray, i);
