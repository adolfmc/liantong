    ...
    public SpanUtils setClickSpan(@ColorInt final int i, final boolean z, final View.OnClickListener onClickListener) {
        ...
        this.clickSpan = new ClickableSpan() { // from class: com.blankj.utilcode.util.SpanUtils.1
            ...
            public void onClick(@NonNull View view) {
                ...
                if (view == null) {
                    NullPointerException nullPointerException = new NullPointerException("Argument 'widget' of type View (#0 out of 1, zero-based) is marked by @android.support.annotation.NonNull but got null for it");
 ...
 */
    ...
    public static class ShadowSpan extends CharacterStyle implements UpdateAppearance {
        ...
        /* renamed from: dx */
        private float f8229dx;

        /* renamed from: dy */
        private float f8230dy;
        ...
        @Override // android.text.style.CharacterStyle
        public void updateDrawState(TextPaint textPaint) {
            textPaint.setShadowLayer(this.radius, this.f8229dx, this.f8230dy, this.shadowColor);
        }
    }
