 ...
 */
    ...
    public static <T> T[] newArray(T... tArr) {
        ...
        throw new NullPointerException("Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.newArray() marked by @android.support.annotation.NonNull");
    }
    ...
    public static long[] newLongArray(long... jArr) {
        ...
        throw new NullPointerException("Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.newLongArray() marked by @android.support.annotation.NonNull");
    }
    ...
    public static int[] newIntArray(int... iArr) {
        ...
        throw new NullPointerException("Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.newIntArray() marked by @android.support.annotation.NonNull");
    }
    ...
    public static short[] newShortArray(short... sArr) {
        ...
        throw new NullPointerException("Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.newShortArray() marked by @android.support.annotation.NonNull");
    }
    ...
    public static char[] newCharArray(char... cArr) {
        ...
        throw new NullPointerException("Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.newCharArray() marked by @android.support.annotation.NonNull");
    }
    ...
    public static byte[] newByteArray(byte... bArr) {
        ...
        throw new NullPointerException("Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.newByteArray() marked by @android.support.annotation.NonNull");
    }
    ...
    public static double[] newDoubleArray(double... dArr) {
        ...
        throw new NullPointerException("Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.newDoubleArray() marked by @android.support.annotation.NonNull");
    }
    ...
    public static float[] newFloatArray(float... fArr) {
        ...
        throw new NullPointerException("Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.newFloatArray() marked by @android.support.annotation.NonNull");
    }
    ...
    public static boolean[] newBooleanArray(boolean... zArr) {
        ...
        throw new NullPointerException("Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.newBooleanArray() marked by @android.support.annotation.NonNull");
    }
    ...
    @Nullable
    private static Object realSubArray(@Nullable Object obj, int i, int i2) {
        if (obj == null) {
            return null;
        }
        if (i < 0) {
    ...
    public static <T> T[] add(@Nullable T[] tArr, @Nullable T t) {
        ...
        throw new NullPointerException("Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.add() marked by @android.support.annotation.NonNull");
    }
    ...
    private static Object realAddOne(@Nullable Object obj, @Nullable Object obj2, Class cls) {
        ...
        if (obj != null) {
            i = getLength(obj);
            newInstance = Array.newInstance(obj.getClass().getComponentType(), i + 1);
        ...
        throw new NullPointerException("Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.realAddOne() marked by @android.support.annotation.NonNull");
    }
    ...
    @Nullable
    private static Object realAddArr(@Nullable Object obj, int i, @Nullable Object obj2, Class cls) {
        if (obj == null && obj2 == null) {
            return null;
        }
        int length = getLength(obj);
    ...
    @NonNull
    private static Object realAdd(@Nullable Object obj, int i, @Nullable Object obj2, Class cls) {
        if (obj == null) {
            if (i != 0) {
            ...
            throw new NullPointerException("Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.realAdd() marked by @android.support.annotation.NonNull");
        }
    ...
    @NonNull
    private static Object remove(@NonNull Object obj, int i) {
        if (obj == null) {
            throw new NullPointerException("Argument 'array' of type Object (#0 out of 2, zero-based) is marked by @android.support.annotation.NonNull but got null for it");
        }
        int length = getLength(obj);
        if (i < 0 || i >= length) {
            throw new IndexOutOfBoundsException("Index: " + i + ", Length: " + length);
        ...
        throw new NullPointerException("Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.remove() marked by @android.support.annotation.NonNull");
    }
    ...
    public static <T> List<T> asList(@Nullable T... tArr) {
        if (tArr == null || tArr.length == 0) {
            ...
            throw new NullPointerException("Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.asList() marked by @android.support.annotation.NonNull");
        }
    ...
    public static <T> List<T> asUnmodifiableList(@Nullable T... tArr) {
        ...
        throw new NullPointerException("Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.asUnmodifiableList() marked by @android.support.annotation.NonNull");
    }
    ...
    public static String toString(@Nullable Object obj) {
        ...
        if (obj instanceof Object[]) {
            ...
            throw new NullPointerException("Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.toString() marked by @android.support.annotation.NonNull");
        } else if (obj instanceof boolean[]) {
