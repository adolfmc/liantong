...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f8237ix = readShort();
        this.header.currentFrame.f8238iy = readShort();
        this.header.currentFrame.f8236iw = readShort();
        this.header.currentFrame.f8235ih = readShort();
        int read = read();
