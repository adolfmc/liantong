 ...
 */
    ...
    static final class StreamReader implements Reader {
        ...
        /* renamed from: is */
        private final InputStream f8250is;

        StreamReader(InputStream inputStream) {
            this.f8250is = inputStream;
        }

        @Override // com.bumptech.glide.load.resource.bitmap.DefaultImageHeaderParser.Reader
        public int getUInt16() throws IOException {
            return ((this.f8250is.read() << 8) & 65280) | (this.f8250is.read() & 255);
        }

        @Override // com.bumptech.glide.load.resource.bitmap.DefaultImageHeaderParser.Reader
        public short getUInt8() throws IOException {
            return (short) (this.f8250is.read() & 255);
        }
        ...
        public long skip(long j) throws IOException {
            ...
            long j2 = j;
            while (j2 > 0) {
                long skip = this.f8250is.skip(j2);
                if (skip > 0) {
                    j2 -= skip;
                } else if (this.f8250is.read() == -1) {
                    break;
                } else {
                    j2--;
                }
        ...
        public int read(byte[] bArr, int i) throws IOException {
            int i2 = i;
            while (i2 > 0) {
                int read = this.f8250is.read(bArr, i - i2, i2);
                if (read == -1) {
                    break;
                }
                i2 -= read;
