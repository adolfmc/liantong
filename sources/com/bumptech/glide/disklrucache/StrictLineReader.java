...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f8232CR = 13;

    /* renamed from: LF */
    private static final byte f8233LF = 10;
    private byte[] buf;
    private final Charset charset;
    private int end;

    /* renamed from: in */
    private final InputStream f8234in;
    private int pos;
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f8234in;
        byte[] bArr = this.buf;
