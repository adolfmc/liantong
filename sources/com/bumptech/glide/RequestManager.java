...
public class RequestManager implements ModelTypes<RequestBuilder<Drawable>>, LifecycleListener {
    ...
    protected synchronized void setRequestOptions(@NonNull RequestOptions requestOptions) {
        this.requestOptions = requestOptions.mo24465clone().autoClone();
    }
    ...
    public RequestBuilder<Bitmap> asBitmap() {
        return mo7976as(Bitmap.class).apply((BaseRequestOptions<?>) DECODE_TYPE_BITMAP);
    }

    @CheckResult
    @NonNull
    public RequestBuilder<GifDrawable> asGif() {
        return mo7976as(GifDrawable.class).apply((BaseRequestOptions<?>) DECODE_TYPE_GIF);
    }

    @CheckResult
    @NonNull
    public RequestBuilder<Drawable> asDrawable() {
        return mo7976as(Drawable.class);
    }
    ...
    public RequestBuilder<File> downloadOnly() {
        return mo7976as(File.class).apply((BaseRequestOptions<?>) DOWNLOAD_ONLY_OPTIONS);
    }
    ...
    public RequestBuilder<File> asFile() {
        return mo7976as(File.class).apply((BaseRequestOptions<?>) RequestOptions.skipMemoryCacheOf(true));
    }

    @CheckResult
    @NonNull
    /* renamed from: as */
    public <ResourceType> RequestBuilder<ResourceType> mo7976as(@NonNull Class<ResourceType> cls) {
