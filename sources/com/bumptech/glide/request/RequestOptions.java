...
public class RequestOptions extends BaseRequestOptions<RequestOptions> {
    ...
    @CheckResult
    @NonNull
    public static RequestOptions sizeMultiplierOf(@FloatRange(from = 0.0d, m22210to = 1.0d) float f) {
    ...
    @CheckResult
    @NonNull
    public static RequestOptions encodeQualityOf(@IntRange(from = 0, m22209to = 100) int i) {
