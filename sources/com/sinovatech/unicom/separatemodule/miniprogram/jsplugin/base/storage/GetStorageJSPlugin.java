...
@Route(path = "/MsJSPlugin/getStorage")
/* loaded from: E:\11480076_dexfile_execute.dex.fixout.dex */
public class GetStorageJSPlugin extends StorageJSPlugin {
    ...
    public String onExecSync() throws Exception {
        Object obj = "";
        try {
            String str = JSStorageBox.get(getStoragePrefixId(), this.parameterJO.getString("key"));
    ...
    public void onExec() throws Exception {
        ...
        try {
            ...
            String str = JSStorageBox.get(getStoragePrefixId(), string);
            if (!TextUtils.isEmpty(str)) {
