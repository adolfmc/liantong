...
@Route(path = "/MsJSPlugin/accelerometer")
@NBSInstrumented
/* loaded from: E:\11480076_dexfile_execute.dex.fixout.dex */
public class AccelerometerJSPlugin extends BaseJSPlugin {
        ...
        try {
            ...
            if ("start".equals(string)) {
                if (this.mSensorManager == null || this.mSensor == null) {
                    ...
                    this.webFragment.addLifeListener("/MsJSPlugin/accelerometer", new BaseWebFragment.LifeListener() { // from class: com.sinovatech.unicom.separatemodule.miniprogram.jsplugin.base.sensor.AccelerometerJSPlugin.1
                        @Override // com.sinovatech.unicom.separatemodule.miniprogram.web.BaseWebFragment.LifeListener
                        public void onDestory() {
                            AccelerometerJSPlugin.this.stop();
                        }
                    });
                }
        ...
        public void onSensorChanged(SensorEvent sensorEvent) {
            try {
                if (sensorEvent.sensor.getType() == 1) {
                    ...
                    jSONObject.put("y", f2);
                    jSONObject.put("z", f3);
                    AccelerometerJSPlugin.this.webFragment.postEventToJS(MsJSEvent.onAccelerometerSensorChanged, jSONObject);
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
