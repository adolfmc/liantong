...
public class MyJCameraView extends FrameLayout implements SurfaceHolder.Callback, CameraInterface.CameraOpenOverCallback, CameraView {
 ...
 */
    ...
    /* JADX WARN: Type inference failed for: r1v2, types: [com.sinovatech.unicom.separatemodule.huotijiance.MyJCameraView$1] */
    @Override // android.view.SurfaceHolder.Callback
    public void surfaceCreated(SurfaceHolder surfaceHolder) {
        LogUtil.m16331i("JCameraView SurfaceCreated");
        new Thread() { // from class: com.sinovatech.unicom.separatemodule.huotijiance.MyJCameraView.1
    ...
    private void setFocusViewWidthAnimation(float f, float f2) {
        this.machine.foucs(f, f2, new CameraInterface.FocusCallback() { // from class: com.sinovatech.unicom.separatemodule.huotijiance.MyJCameraView.2
            @Override // com.cjt2325.cameralibrary.CameraInterface.FocusCallback
            public void focusSuccess() {
                MyJCameraView.this.mFoucsView.setVisibility(4);
            }
        });
    }
    ...
    public void playVideo(Bitmap bitmap, String str) {
        ...
        try {
            ...
            this.mMediaPlayer.setOnVideoSizeChangedListener(new MediaPlayer.OnVideoSizeChangedListener() { // from class: com.sinovatech.unicom.separatemodule.huotijiance.MyJCameraView.3
                @Override // android.media.MediaPlayer.OnVideoSizeChangedListener
                public void onVideoSizeChanged(MediaPlayer mediaPlayer, int i, int i2) {
                    MyJCameraView myJCameraView = MyJCameraView.this;
                    myJCameraView.updateVideoViewSize(myJCameraView.mMediaPlayer.getVideoWidth(), MyJCameraView.this.mMediaPlayer.getVideoHeight());
                }
            });
            this.mMediaPlayer.setOnPreparedListener(new MediaPlayer.OnPreparedListener() { // from class: com.sinovatech.unicom.separatemodule.huotijiance.MyJCameraView.4
                @Override // android.media.MediaPlayer.OnPreparedListener
                public void onPrepared(MediaPlayer mediaPlayer) {
                    MyJCameraView.this.mMediaPlayer.start();
                }
            });
