    ...
    public BaseViewHolder addOnClickListener(@IdRes int... iArr) {
        for (int i : iArr) {
            ...
            if (view != null) {
                ...
                view.setOnClickListener(new View.OnClickListener() { // from class: com.sinovatech.unicom.separatemodule.audience.quickrecycler.BaseViewHolder.1
    ...
    public BaseViewHolder addOnLongClickListener(@IdRes int... iArr) {
        for (int i : iArr) {
            ...
            if (view != null) {
                ...
                view.setOnLongClickListener(new View.OnLongClickListener() { // from class: com.sinovatech.unicom.separatemodule.audience.quickrecycler.BaseViewHolder.2
                    @Override // android.view.View.OnLongClickListener
                    public boolean onLongClick(View view2) {
                        NBSActionInstrumentation.onLongClickEventEnter(view2, this);
                        boolean z = BaseViewHolder.this.adapter.getOnItemChildLongClickListener() != null && BaseViewHolder.this.adapter.getOnItemChildLongClickListener().onItemChildLongClick(BaseViewHolder.this.adapter, view2, BaseViewHolder.this.getClickPosition());
