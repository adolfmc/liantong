...
public class ConsecutiveScrollerLayout2 extends ViewGroup implements NestedScrollingChild2, NestedScrollingParent2, ScrollingView {
    ...
    static final Interpolator sQuinticInterpolator = new Interpolator() { // from class: com.sinovatech.unicom.basic.view.decklayout.ConsecutiveScrollerLayout2.1
 ...
 */
    ...
    public ConsecutiveScrollerLayout2(Context context) {
        this(context, null);
    }

    public ConsecutiveScrollerLayout2(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public ConsecutiveScrollerLayout2(Context context, AttributeSet attributeSet, int i) {
        ...
        this.topMargin = UIUtils.dip2px(8.0f);
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i6 = 0; i6 < size; i6++) {
            ...
            if (view instanceof ConsecutiveViewPager) {
                view.layout(childLeft, i5 - this.topMargin, view.getMeasuredWidth() + childLeft, measuredHeight - this.topMargin);
                measuredHeight -= this.topMargin;
                this.mScrollRange += view.getHeight() - this.topMargin;
            } else {
    ...
    public class BounceRunnable implements Runnable {
        ...
        BounceRunnable(float f, int i) {
            ...
            ConsecutiveScrollerLayout2.this.mHandler.postDelayed(this, this.mFrameDelay);
        }

        @Override // java.lang.Runnable
        public void run() {
            int i;
            if (ConsecutiveScrollerLayout2.this.animationRunnable == this) {
                ...
                if (Math.abs(f) >= 1.0f) {
                    ...
                    this.mOffset += f;
                    int scrollY = ConsecutiveScrollerLayout2.this.getScrollY();
                    ConsecutiveScrollerLayout2.this.moveSpinnerInfinitely(this.mOffset);
                    if (scrollY != ConsecutiveScrollerLayout2.this.mSecondScrollY) {
                        ConsecutiveScrollerLayout2 consecutiveScrollerLayout2 = ConsecutiveScrollerLayout2.this;
                        consecutiveScrollerLayout2.scrollChange(consecutiveScrollerLayout2.mSecondScrollY, scrollY);
                    }
                    ConsecutiveScrollerLayout2.this.mHandler.postDelayed(this, this.mFrameDelay);
                    return;
                }
                ConsecutiveScrollerLayout2 consecutiveScrollerLayout22 = ConsecutiveScrollerLayout2.this;
                consecutiveScrollerLayout22.animationRunnable = null;
                int scrollY2 = consecutiveScrollerLayout22.getScrollY();
                ConsecutiveScrollerLayout2 consecutiveScrollerLayout23 = ConsecutiveScrollerLayout2.this;
                consecutiveScrollerLayout23.animSpinner(scrollY2, this.mSmoothDistance, 0, consecutiveScrollerLayout23.mReboundInterpolator, Math.min(Math.max(UIUtils.px2dp(Math.abs(scrollY2 - this.mSmoothDistance)), 30), 100) * 10);
            }
        }
    }
    ...
    protected ValueAnimator animSpinner(int i, int i2, int i3, Interpolator interpolator, int i4) {
        if (i != i2) {
            ...
            this.reboundAnimator.addListener(new AnimatorListenerAdapter() { // from class: com.sinovatech.unicom.basic.view.decklayout.ConsecutiveScrollerLayout2.2
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
                    if (animator == null || animator.getDuration() != 0) {
                        ConsecutiveScrollerLayout2 consecutiveScrollerLayout2 = ConsecutiveScrollerLayout2.this;
                        consecutiveScrollerLayout2.reboundAnimator = null;
                        consecutiveScrollerLayout2.checkTargetsScroll(false, false);
                    }
                }
            });
            this.reboundAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.sinovatech.unicom.basic.view.decklayout.-$$Lambda$ConsecutiveScrollerLayout2$IJNIDPZB02AOEhIaRa2HWp9MJ2c
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    ConsecutiveScrollerLayout2.lambda$animSpinner$0(ConsecutiveScrollerLayout2.this, valueAnimator2);
                }
            });
    ...
    public static /* synthetic */ void lambda$animSpinner$0(ConsecutiveScrollerLayout2 consecutiveScrollerLayout2, ValueAnimator valueAnimator) {
        int intValue = ((Integer) valueAnimator.getAnimatedValue()).intValue();
        int computeVerticalScrollOffset = consecutiveScrollerLayout2.computeVerticalScrollOffset();
        consecutiveScrollerLayout2.scrollSelf(intValue);
        consecutiveScrollerLayout2.mSecondScrollY = consecutiveScrollerLayout2.computeVerticalScrollOffset();
        int i = consecutiveScrollerLayout2.mSecondScrollY;
        if (computeVerticalScrollOffset != i) {
            consecutiveScrollerLayout2.scrollChange(i, computeVerticalScrollOffset);
        }
    }
    ...
    private void scrollChild(View view, int i) {
        ...
        if (startInterceptRequestLayout) {
            ...
            recyclerView.postDelayed(new Runnable() { // from class: com.sinovatech.unicom.basic.view.decklayout.ConsecutiveScrollerLayout2.3
                @Override // java.lang.Runnable
                public void run() {
    ...
    public void checkLayoutChange() {
        postDelayed(new Runnable() { // from class: com.sinovatech.unicom.basic.view.decklayout.ConsecutiveScrollerLayout2.4
            @Override // java.lang.Runnable
            public void run() {
                ConsecutiveScrollerLayout2.this.checkLayoutChange(false, true);
            }
        }, 20L);
    }
    ...
    private List<View> getEffectiveChildren() {
        ArrayList arrayList = new ArrayList();
        int childCount = getChildCount();
        MsLogUtil.m7979d("测试consec", childCount + "  count");
        for (int i = 0; i < childCount; i++) {
            View childAt = getChildAt(i);
            MsLogUtil.m7979d("测试consec", childAt.getClass().getSimpleName());
    ...
    public boolean isScrollBottom() {
        List<View> effectiveChildren = getEffectiveChildren();
        int size = effectiveChildren.size();
        MsLogUtil.m7979d("isScrollBottom", "  :======================");
        Iterator<View> it = effectiveChildren.iterator();
        while (it.hasNext()) {
            MsLogUtil.m7979d("isScrollBottom", "  :" + it.next().getClass().getSimpleName());
        }
        if (size > 0) {
    ...
    */
    public void smoothScrollToChildWithOffset(android.view.View r8, int r9) {
        ...
        L70:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.sinovatech.unicom.basic.view.decklayout.ConsecutiveScrollerLayout2.smoothScrollToChildWithOffset(android.view.View, int):void");
    }
