...
public class SwipePanel extends FrameLayout {
    ...
    public static boolean isAdViewPager;
 ...
 */
    ...
    public SwipePanel(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C9718R.styleable.SwipePanel);
    ...
    private void animClose(final int i) {
        ...
        if (fArr[i] > 0.0f) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.sinovatech.unicom.basic.view.SwipePanel.1
