...
public class RecentHeaderView extends InternalAbstract {
    ...
    public RecentHeaderView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mTitleText = (TextView) LayoutInflater.from(context).inflate(2131493404, this).findViewById(2131297191);
    }
