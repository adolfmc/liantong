...
@NBSInstrumented
/* renamed from: com.sinovatech.unicom.basic.ui.view.DashIndicatorView2 */
/* loaded from: E:\11480076_dexfile_execute.dex.fixout.dex */
public class DashIndicatorView2 extends BaseIndicatorView {
    private float corner;
    private float maxWidth;
    private float minWidth;
    private float sliderHeight;

    public DashIndicatorView2(Context context) {
        this(context, null);
    }

    public DashIndicatorView2(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public DashIndicatorView2(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        this.corner = UIUtils.dip2px(2.0f);
        this.mPaint.setColor(this.normalColor);
        this.sliderHeight = UIUtils.dip2px(3.0f);
    }
    ...
    public DashIndicatorView2 setSliderHeight(int i) {
        this.sliderHeight = i;
        return this;
    }
}
