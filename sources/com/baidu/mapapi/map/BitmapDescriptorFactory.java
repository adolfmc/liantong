...
public class BitmapDescriptorFactory {
    ...
    /* renamed from: a */
    static final /* synthetic */ boolean f5992a = !BitmapDescriptorFactory.class.desiredAssertionStatus();

    /* renamed from: b */
    private static final String f5993b = "BaiduMapSDK-" + BitmapDescriptorFactory.class.getSimpleName();
    ...
    public static BitmapDescriptor fromAsset(String str) {
        ...
        try {
            Bitmap m18473a = C2888a.m18473a(str, context);
            BitmapDescriptor fromBitmap = fromBitmap(m18473a);
            if (!f5992a && m18473a == null) {
    ...
    */
    public static com.baidu.mapapi.map.BitmapDescriptor fromAssetWithDpi(java.lang.String r9) {
        /*
            ...
            return r1
        L8:
            android.graphics.Bitmap r9 = com.baidu.mapsdkplatform.comapi.commonutils.C2888a.m18473a(r9, r0)     // Catch: java.lang.Exception -> L63
            if (r9 != 0) goto Lf
            return r1
        Lf:
    ...
    public static BitmapDescriptor fromViewWithDpi(View view, int i) {
        ...
        Bitmap drawingCache = view.getDrawingCache();
        if (drawingCache == null) {
            Log.e(f5993b, "Get bitmap failed");
            return null;
        }
        if (i <= 0) {
            i = SysOSUtil.getDensityDpi();
