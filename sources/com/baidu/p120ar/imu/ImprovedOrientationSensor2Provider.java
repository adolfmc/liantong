 ...
 */
/* renamed from: com.baidu.ar.imu.ImprovedOrientationSensor2Provider */
...
public class ImprovedOrientationSensor2Provider extends OrientationProvider {
    ...
    private static final String TAG = "ImprovedOrientationSensor2Provider";
    ...
    protected void transformMatrix() {
        if (!this.mInitMFlag) {
            if (getRMOfProjectionCoord(this.mInitOrientationRotationMatrix.matrix, this.currentOrientationRotationMatrix.matrix)) {
                this.mInitMFlag = true;
                toFinalRotationMatrix(this.mFinalOrientationRotationMatrix.matrix, this.currentOrientationRotationMatrix.matrix, this.mInitOrientationRotationMatrix.matrix);
                rotateFinalRotationMatrix(this.mFinalRotatedOrientationRotationMatrix.matrix, this.mFinalOrientationRotationMatrix.matrix);
                return;
            }
            return;
        }
