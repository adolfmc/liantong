 ...
 */
/* renamed from: com.baidu.ar.auth.AuthTipTextImage */
/* loaded from: E:\10201592_dexfile_execute.dex */
class AuthTipTextImage {
    AuthTipTextImage() {
    }

    public static Bitmap createTipImage(Context context) {
        ...
        ARLog.m20421d("createBitmap", "w: " + createBitmap.getWidth() + " h: " + createBitmap.getHeight() + " bc: " + createBitmap.getByteCount());
        return createBitmap;
    }
}
