 ...
 */
/* renamed from: com.baidu.ar.arplay.core.renderer.IARPRenderer */
...
public interface IARPRenderer {
    ...
    void createInputSource(PixelRotation pixelRotation, SourceInternalTexType sourceInternalTexType);

    void createPixelReaderByPreFilterID(PixelReadParams pixelReadParams, PixelReadListener pixelReadListener);

    void createSyncInputSource(PixelRotation pixelRotation, SourceInternalTexType sourceInternalTexType);
