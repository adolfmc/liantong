 ...
 */
    ...
    public static void copyStream(InputStream inputStream, File file) throws IOException {
        ...
        try {
            fileOutputStream = FileUtil.openFileOutputStream(file);
        } catch (Throwable th) {
            th = th;
    ...
    public static void copyStream(InputStream inputStream, OutputStream outputStream, final Cancelable cancelable) throws IOException {
        copyStream(inputStream, outputStream, 0L, new Operation() { // from class: com.baidu.minivideo.arface.utils.IoUtil.1
            @Override // com.baidu.minivideo.arface.utils.IoUtil.ProgressListener
            public void progress(long j, long j2) {
            }

            @Override // com.baidu.minivideo.arface.utils.IoUtil.Cancelable
    ...
    public static void copyStream(InputStream inputStream, OutputStream outputStream, long j, final ProgressListener progressListener) throws IOException {
        copyStream(inputStream, outputStream, j, new Operation() { // from class: com.baidu.minivideo.arface.utils.IoUtil.2
            @Override // com.baidu.minivideo.arface.utils.IoUtil.Cancelable
            public boolean isCancelled() {
                return false;
            }
