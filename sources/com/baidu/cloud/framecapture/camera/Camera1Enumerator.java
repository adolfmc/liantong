...
public class Camera1Enumerator implements CameraEnumerator {
    ...
    @Override // com.baidu.cloud.framecapture.camera.CameraEnumerator
    public String[] getDeviceNames() {
        ...
        for (int i = 0; i < Camera.getNumberOfCameras(); i++) {
            ...
            if (deviceName != null) {
                ...
                Logging.m20092d("Camera1Enumerator", "Index: " + i + ". " + deviceName);
            } else {
                Logging.m20091e("Camera1Enumerator", "Index: " + i + ". Failed to query camera name.");
            }
        }
    ...
    private static Camera.CameraInfo getCameraInfo(int i) {
        ...
        try {
            ...
            Logging.m20090e("Camera1Enumerator", "getCameraInfo failed on index " + i, e);
            return null;
        }
    }
    ...
    private static List<CameraEnumerationAndroid.CaptureFormat> enumerateFormats(int i) {
        int i2;
        Logging.m20092d("Camera1Enumerator", "Get supported formats for camera index " + i + ".");
        long elapsedRealtime = SystemClock.elapsedRealtime();
        Camera camera = null;
        try {
            try {
                Logging.m20092d("Camera1Enumerator", "Opening camera with index " + i);
                ...
                if (parameters != null) {
                    try {
                        ...
                        Logging.m20090e("Camera1Enumerator", "getSupportedFormats() failed on camera index " + i, e);
                    }
                }
                long elapsedRealtime2 = SystemClock.elapsedRealtime();
                Logging.m20092d("Camera1Enumerator", "Get supported formats for camera index " + i + " done. Time spent: " + (elapsedRealtime2 - elapsedRealtime) + " ms.");
                return arrayList;
            } catch (RuntimeException e2) {
                Logging.m20090e("Camera1Enumerator", "Open camera failed on camera index " + i, e2);
    ...
    public static int getCameraIndex(String str) {
        Logging.m20092d("Camera1Enumerator", "getCameraIndex: " + str);
        for (int i = 0; i < Camera.getNumberOfCameras(); i++) {
