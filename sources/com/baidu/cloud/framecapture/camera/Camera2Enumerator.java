...
public class Camera2Enumerator implements CameraEnumerator {
    ...
    public String[] getDeviceNames() {
        try {
            ...
            Logging.m20091e("Camera2Enumerator", "Camera access exception: " + e);
            return new String[0];
        }
    }
    ...
    static List<CameraEnumerationAndroid.CaptureFormat> getSupportedFormats(CameraManager cameraManager, String str) {
        ...
        synchronized (cachedSupportedFormats) {
            ...
            Logging.m20092d("Camera2Enumerator", "Get supported formats for camera index " + str + ".");
            ...
            try {
                ...
                for (Size size : supportedSizes) {
                    ...
                    Logging.m20092d("Camera2Enumerator", "Format: " + size.width + "x" + size.height + "@" + round);
                }
                cachedSupportedFormats.put(str, arrayList);
                long elapsedRealtime2 = SystemClock.elapsedRealtime();
                Logging.m20092d("Camera2Enumerator", "Get supported formats for camera index " + str + " done. Time spent: " + (elapsedRealtime2 - elapsedRealtime) + " ms.");
                return arrayList;
            } catch (Exception e) {
                Logging.m20091e("Camera2Enumerator", "getCameraCharacteristics(): " + e);
