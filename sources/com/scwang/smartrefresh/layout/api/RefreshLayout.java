...
public interface RefreshLayout {
    ...
    RefreshLayout setDragRate(@FloatRange(from = 0.0d, m22210to = 1.0d) float f);
    ...
    RefreshLayout setFooterMaxDragRate(@FloatRange(from = 1.0d, m22210to = 10.0d) float f);

    RefreshLayout setFooterTriggerRate(@FloatRange(from = 0.0d, m22210to = 1.0d) float f);

    RefreshLayout setHeaderHeight(float f);

    RefreshLayout setHeaderInsetStart(float f);

    RefreshLayout setHeaderMaxDragRate(@FloatRange(from = 1.0d, m22210to = 10.0d) float f);

    RefreshLayout setHeaderTriggerRate(@FloatRange(from = 0.0d, m22210to = 1.0d) float f);
