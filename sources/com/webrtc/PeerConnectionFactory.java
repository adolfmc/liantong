...
import com.webrtc.NativeLibrary;
 ...
 */
    ...
    public static class InitializationOptions {
        ...
        public static class Builder {
            ...
            private String nativeLibraryName = "bdcloud_rtc";
 ...
 */
    ...
    public static void initialize(InitializationOptions initializationOptions) {
        ...
        Logging.m5305d(TAG, "PeerConnectionFactory was initialized without an injected Loggable. Any existing Loggable will be deleted.");
    ...
    private static void printStackTrace(@Nullable ThreadInfo threadInfo, boolean z) {
        ...
        if (stackTrace.length > 0) {
            Logging.m5301w(TAG, name + " stacktrace:");
            for (StackTraceElement stackTraceElement : stackTrace) {
                Logging.m5301w(TAG, stackTraceElement.toString());
            }
        }
        if (z) {
            Logging.m5301w(TAG, "*** *** *** *** *** *** *** *** *** *** *** *** *** *** *** ***");
            Logging.m5301w(TAG, "pid: " + Process.myPid() + ", tid: " + threadInfo.tid + ", name: " + name + "  >>> WebRTC <<<");
    ...
    private void onNetworkThreadReady() {
        ...
        Logging.m5305d(TAG, "onNetworkThreadReady");
    }
    ...
    private void onWorkerThreadReady() {
        ...
        Logging.m5305d(TAG, "onWorkerThreadReady");
    }
    ...
    private void onSignalingThreadReady() {
        ...
        Logging.m5305d(TAG, "onSignalingThreadReady");
    }
}
