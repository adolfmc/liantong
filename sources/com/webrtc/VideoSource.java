 ...
 */
    ...
    public VideoSource(long j) {
        ...
        this.capturerObserver = new CapturerObserver() { // from class: com.webrtc.VideoSource.1
    ...
    public void setVideoProcessor(@Nullable VideoProcessor videoProcessor) {
        synchronized (this.videoProcessorLock) {
            ...
            if (videoProcessor != null) {
                videoProcessor.setSink(new VideoSink() { // from class: com.webrtc.-$$Lambda$VideoSource$bxi16ayihGdVxLyId-BNUgWmCWY
                    @Override // com.webrtc.VideoSink
                    public final void onFrame(VideoFrame videoFrame) {
                        r0.runWithReference(new Runnable() { // from class: com.webrtc.-$$Lambda$VideoSource$BymMbxdBlPHalh33x_kkCHNglxg
