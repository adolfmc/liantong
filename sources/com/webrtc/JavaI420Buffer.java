...
public class JavaI420Buffer implements VideoFrame.I420Buffer {
    ...
    public static JavaI420Buffer allocate(int i, int i2) {
        ...
        return new JavaI420Buffer(i, i2, slice, i, slice2, i4, nativeAllocateByteBuffer.slice(), i4, new Runnable() { // from class: com.webrtc.-$$Lambda$JavaI420Buffer$jHrLNzsin80jRnIHUgoap1EfVqE
    ...
    public static VideoFrame.Buffer cropAndScaleI420(final VideoFrame.I420Buffer i420Buffer, int i, int i2, int i3, int i4, int i5, int i6) {
        if (i3 == i5 && i4 == i6) {
            ...
            return wrap(i5, i6, slice, strideY, slice2, strideU, slice3, strideV, new Runnable() { // from class: com.webrtc.-$$Lambda$CpZn_N_Na9X3Hvag2FGfjgkAfnU
                @Override // java.lang.Runnable
                public final void run() {
