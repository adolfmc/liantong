...
public class SurfaceViewRenderer extends SurfaceView implements SurfaceHolder.Callback, RendererCommon.RendererEvents, VideoSink {
    ...
    private boolean bIgnoreLayoutAspectRatio;
    ...
    public void setUserId(String str) {
        ...
        if (surfaceEglRenderer != null) {
            surfaceEglRenderer.setUserId(str);
        }
    }
    ...
    public void setScalingType(RendererCommon.ScalingType scalingType) {
        ...
        this.bIgnoreLayoutAspectRatio = scalingType == RendererCommon.ScalingType.SCALE_ASPECT_FILL_WITHOUT_CROP || scalingType == RendererCommon.ScalingType.SCALE_ASPECT_FIT;
        this.eglRenderer.setVideoScaleType(scalingType);
        requestLayout();
    }
    ...
    public void setScalingType(RendererCommon.ScalingType scalingType, RendererCommon.ScalingType scalingType2) {
        ...
        this.bIgnoreLayoutAspectRatio = scalingType == RendererCommon.ScalingType.SCALE_ASPECT_FILL_WITHOUT_CROP || scalingType2 == RendererCommon.ScalingType.SCALE_ASPECT_FILL_WITHOUT_CROP || scalingType == RendererCommon.ScalingType.SCALE_ASPECT_FIT || scalingType2 == RendererCommon.ScalingType.SCALE_ASPECT_FIT;
        this.eglRenderer.setVideoScaleType(scalingType);
        requestLayout();
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ThreadUtils.checkIsOnMainThread();
        this.mLayoutAspectRatio = (i3 - i) / (i4 - i2);
        if (!this.bIgnoreLayoutAspectRatio) {
            this.eglRenderer.setLayoutAspectRatio(this.mLayoutAspectRatio);
        } else {
    ...
    public void surfaceChanged(SurfaceHolder surfaceHolder, int i, int i2, int i3) {
        Logging.m5305d(TAG, "width=" + i2 + ", height=" + i3);
    }
    ...
    public void onFrameResolutionChanged(final int i, int i2, int i3) {
        ...
        postOrRun(new Runnable() { // from class: com.webrtc.-$$Lambda$SurfaceViewRenderer$vOPlOf_WPK7rHJPqBBKpP04lC34
    ...
    private void logD(String str) {
        Logging.m5305d(TAG, this.userId + "/" + this.resourceName + ": " + str);
    }
}
