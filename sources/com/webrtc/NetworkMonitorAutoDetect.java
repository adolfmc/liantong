 ...
 */
    ...
    class SimpleNetworkCallback extends ConnectivityManager.NetworkCallback {
        ...
        public void onAvailable(Network network) {
            Logging.m5305d(NetworkMonitorAutoDetect.TAG, "Network becomes available: " + network.toString());
            onNetworkChanged(network);
        }

        @Override // android.net.ConnectivityManager.NetworkCallback
        public void onCapabilitiesChanged(Network network, NetworkCapabilities networkCapabilities) {
            Logging.m5305d(NetworkMonitorAutoDetect.TAG, "capabilities changed: " + networkCapabilities.toString());
            onNetworkChanged(network);
        }

        @Override // android.net.ConnectivityManager.NetworkCallback
        public void onLinkPropertiesChanged(Network network, LinkProperties linkProperties) {
            Logging.m5305d(NetworkMonitorAutoDetect.TAG, "link properties changed");
            onNetworkChanged(network);
        }

        @Override // android.net.ConnectivityManager.NetworkCallback
        public void onLosing(Network network, int i) {
            Logging.m5305d(NetworkMonitorAutoDetect.TAG, "Network " + network.toString() + " is about to lose in " + i + "ms");
        }

        @Override // android.net.ConnectivityManager.NetworkCallback
        public void onLost(Network network) {
            Logging.m5305d(NetworkMonitorAutoDetect.TAG, "Network " + network.toString() + " is disconnected");
    ...
    public static class ConnectivityManagerDelegate {
        ...
        NetworkState getNetworkState(@Nullable Network network) {
            ...
            if (networkInfo == null) {
                Logging.m5301w(NetworkMonitorAutoDetect.TAG, "Couldn't retrieve information from network " + network.toString());
                return new NetworkState(false, -1, -1, -1, -1);
        ...
        public NetworkChangeDetector.NetworkInformation networkToInfo(@Nullable Network network) {
            ...
            if (linkProperties == null) {
                Logging.m5301w(NetworkMonitorAutoDetect.TAG, "Detected unknown network: " + network.toString());
                return null;
            } else if (linkProperties.getInterfaceName() == null) {
                Logging.m5301w(NetworkMonitorAutoDetect.TAG, "Null interface name for network " + network.toString());
                return null;
            } else {
                ...
                if (connectionType == NetworkChangeDetector.ConnectionType.CONNECTION_UNKNOWN || connectionType == NetworkChangeDetector.ConnectionType.CONNECTION_UNKNOWN_CELLULAR) {
                    Logging.m5305d(NetworkMonitorAutoDetect.TAG, "Network " + network.toString() + " connection type is " + connectionType + " because it has type " + networkState.getNetworkType() + " and subtype " + networkState.getNetworkSubType());
                }
        ...
        public void releaseCallback(ConnectivityManager.NetworkCallback networkCallback) {
            if (supportNetworkCallback()) {
                Logging.m5305d(NetworkMonitorAutoDetect.TAG, "Unregister network callback");
    ...
    public static class WifiDirectManagerDelegate extends BroadcastReceiver {
        ...
        WifiDirectManagerDelegate(NetworkChangeDetector.Observer observer, Context context) {
            ...
            if (Build.VERSION.SDK_INT > 28) {
                ...
                wifiP2pManager.requestGroupInfo(wifiP2pManager.initialize(context, context.getMainLooper(), null), new WifiP2pManager.GroupInfoListener() { // from class: com.webrtc.-$$Lambda$NetworkMonitorAutoDetect$WifiDirectManagerDelegate$N4X1zQGVllTyAQKFQFlx_4nzmhY
        ...
        public void onWifiP2pGroupChange(@Nullable WifiP2pGroup wifiP2pGroup) {
            ...
            try {
                ...
                Logging.m5303e(NetworkMonitorAutoDetect.TAG, "Unable to get WifiP2p network interface", e);
            }
        }
    ...
    public NetworkMonitorAutoDetect(NetworkChangeDetector.Observer observer, Context context) {
        ...
        if (this.connectivityManagerDelegate.supportNetworkCallback()) {
            ...
            try {
                ...
                Logging.m5301w(TAG, "Unable to obtain permission to request a cellular network.");
    ...
    private void registerReceiver() {
        ...
        try {
            this.context.getApplicationContext().registerReceiver(this, this.intentFilter);
        } catch (Exception e) {
            Logging.m5304e(TAG, "register receiver fault: " + e.getStackTrace());
        }
    }
    ...
    private void unregisterReceiver() {
        if (this.isRegistered) {
            ...
            try {
                ...
                Logging.m5304e(TAG, "unregister receiver fault: " + e.getStackTrace());
            }
        }
    }
    ...
    private void connectionTypeChanged(NetworkState networkState) {
        ...
        Logging.m5305d(TAG, "Network connectivity changed, type is: " + this.connectionType);
