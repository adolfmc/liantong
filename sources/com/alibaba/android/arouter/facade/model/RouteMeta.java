...
public class RouteMeta {
    ...
    public String getGroup() {
        return this.f27850group;
    }

    public RouteMeta setGroup(String str) {
        this.f27850group = str;
        return this;
    }
    ...
    public String toString() {
        return "RouteMeta{type=" + this.type + ", rawType=" + this.rawType + ", destination=" + this.destination + ", path='" + this.path + "', group='" + this.f27850group + "', priority=" + this.priority + ", extra=" + this.extra + ", paramsType=" + this.paramsType + ", name='" + this.name + "'}";
    }
}
