...
public class DownloadTask extends IdentifiedTask implements Comparable<DownloadTask> {
    ...
    public DownloadTask(String str, Uri uri, int i, int i2, int i3, int i4, int i5, boolean z, int i6, Map<String, List<String>> map, @Nullable String str2, boolean z2, boolean z3, Boolean bool, @Nullable Integer num, @Nullable Boolean bool2) {
            ...
            if (bool != null) {
                if (bool.booleanValue()) {
                    ...
                    if (!Util.isEmpty(str2)) {
                        Util.m13738w("DownloadTask", "Discard filename[" + str3 + "] because you set filenameFromResponse=true");
                        str3 = null;
                    }
        ...
        this.f12212id = OkDownload.with().breakpointStore().findOrCreateId(this);
    }
    ...
    public BreakpointInfo getInfo() {
        if (this.info == null) {
            this.info = OkDownload.with().breakpointStore().get(this.f12212id);
        }
        return this.info;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DownloadTask) {
            ...
            if (downloadTask.f12212id == this.f12212id) {
                return true;
            }
    ...
    public String toString() {
        return super.toString() + "@" + this.f12212id + "@" + this.url + "@" + this.directoryFile.toString() + "/" + this.filenameHolder.get();
    }
