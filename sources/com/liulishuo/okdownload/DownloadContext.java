...
public class DownloadContext {
    ...
    public void start(@Nullable final DownloadListener downloadListener, boolean z) {
        ...
        Util.m13741d(TAG, "start finish " + z + " " + (SystemClock.uptimeMillis() - uptimeMillis) + "ms");
    }
    ...
    public static class QueueAttachListener extends DownloadListener2 {
        ...
        public void taskEnd(@NonNull DownloadTask downloadTask, @NonNull EndCause endCause, @Nullable Exception exc) {
            ...
            if (decrementAndGet <= 0) {
                ...
                Util.m13741d(DownloadContext.TAG, "taskEnd and remainCount " + decrementAndGet);
            }
        }
    }
