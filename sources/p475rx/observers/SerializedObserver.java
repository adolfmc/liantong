...
public class SerializedObserver<T> implements Observer<T> {
    ...
    /* renamed from: nl */
    private final NotificationLite<T> f27639nl = NotificationLite.instance();
 ...
 */
    ...
    */
    public void onNext(T r10) {
        ...
        L1b:
            rx.internal.operators.NotificationLite<T> r1 = r9.f27639nl     // Catch: java.lang.Throwable -> L7c
        ...
        L46:
            ...
            goto L6d
        L4d:
            rx.internal.operators.NotificationLite<T> r7 = r9.f27639nl     // Catch: java.lang.Throwable -> L5d
        ...
        L5d:
            ...
            java.lang.Throwable r10 = p475rx.exceptions.OnErrorThrowable.addValueAsLastCause(r1, r10)
            r0.onError(r10)
            return
        L6d:
            int r2 = r2 + 1
        ...
        L73:
            ...
            r9.terminated = r0
            rx.Observer<? super T> r0 = r9.actual
            p475rx.exceptions.Exceptions.throwOrReport(r1, r0, r10)
            return
        L7c:
            r10 = move-exception
            monitor-exit(r9)     // Catch: java.lang.Throwable -> L7c
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: p475rx.observers.SerializedObserver.onNext(java.lang.Object):void");
    }
    ...
    public void onError(Throwable th) {
        ...
        synchronized (this) {
            ...
            if (this.emitting) {
                ...
                fastList.add(this.f27639nl.error(th));
                return;
            }
            this.emitting = true;
    ...
    public void onCompleted() {
        ...
        synchronized (this) {
            ...
            if (this.emitting) {
                ...
                fastList.add(this.f27639nl.completed());
                return;
            }
            this.emitting = true;
