...
import p475rx.internal.util.SynchronizedQueue;
 ...
 */
    ...
    public static final class PublishSubscriber<T> extends Subscriber<T> implements Subscription {
        ...
        /* renamed from: nl */
        final NotificationLite<T> f27598nl;
        ...
        public PublishSubscriber(AtomicReference<PublishSubscriber<T>> atomicReference) {
            ...
            this.f27598nl = NotificationLite.instance();
        ...
        public void onNext(T t) {
            if (!this.queue.offer(this.f27598nl.next(t))) {
        ...
        public void onError(Throwable th) {
            if (this.terminalEvent == null) {
                this.terminalEvent = this.f27598nl.error(th);
                dispatch();
            }
        }
        ...
        public void onCompleted() {
            if (this.terminalEvent == null) {
                this.terminalEvent = this.f27598nl.completed();
                dispatch();
            }
        }
        ...
        boolean checkTerminated(Object obj, boolean z) {
            int i = 0;
            if (obj != null) {
                if (!this.f27598nl.isCompleted(obj)) {
                    Throwable error = this.f27598nl.getError(obj);
        ...
        */
        void dispatch() {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: p475rx.internal.operators.OperatorPublish.PublishSubscriber.dispatch():void");
        }
    }
