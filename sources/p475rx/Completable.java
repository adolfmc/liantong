...
import p475rx.internal.operators.CompletableOnSubscribeConcat;
import p475rx.internal.operators.CompletableOnSubscribeConcatArray;
import p475rx.internal.operators.CompletableOnSubscribeConcatIterable;
import p475rx.internal.operators.CompletableOnSubscribeMerge;
import p475rx.internal.operators.CompletableOnSubscribeMergeArray;
import p475rx.internal.operators.CompletableOnSubscribeMergeDelayErrorArray;
import p475rx.internal.operators.CompletableOnSubscribeMergeDelayErrorIterable;
import p475rx.internal.operators.CompletableOnSubscribeMergeIterable;
import p475rx.internal.operators.CompletableOnSubscribeTimeout;
import p475rx.internal.util.SubscriptionList;
import p475rx.internal.util.UtilityFunctions;
import p475rx.plugins.RxJavaErrorHandler;
            ...
            public void call(CompletableSubscriber completableSubscriber) {
                try {
                    ...
                    try {
                        ...
                        completable.subscribe(new C137431(new AtomicBoolean(), call, completableSubscriber));
                    } catch (Throwable th2) {
                        try {
                            action1.call(call);
 ...
 */
            ...
            /* loaded from: E:\9227576_dexfile_execute.dex */
            public class C137431 implements CompletableSubscriber {

                /* renamed from: d */
                Subscription f27573d;
                final /* synthetic */ AtomicBoolean val$once;
                final /* synthetic */ Object val$resource;
                final /* synthetic */ CompletableSubscriber val$s;

                C137431(AtomicBoolean atomicBoolean, Object obj, CompletableSubscriber completableSubscriber) {
    ...
    public final Completable compose(CompletableTransformer completableTransformer) {
        return (Completable) m118to(completableTransformer);
    }
    ...
    protected final Completable doOnLifecycle(Action1<? super Subscription> action1, Action1<? super Throwable> action12, Action0 action0, Action0 action02, Action0 action03) {
        ...
        return create(new C1375117(action0, action02, action12, action1, action03));
    }
 ...
 */
    ...
    /* loaded from: E:\9227576_dexfile_execute.dex */
    public class C1375117 implements CompletableOnSubscribe {
        ...
        C1375117(Action0 action0, Action0 action02, Action1 action1, Action1 action12, Action0 action03) {
        ...
        public void call(final CompletableSubscriber completableSubscriber) {
            Completable.this.subscribe(new CompletableSubscriber() { // from class: rx.Completable.17.1
                ...
                public void onCompleted() {
                    try {
                        C1375117.this.val$onComplete.call();
                        completableSubscriber.onCompleted();
                        try {
                            C1375117.this.val$onAfterComplete.call();
                        } catch (Throwable th) {
                            Completable.ERROR_HANDLER.handleError(th);
                        }
                    } catch (Throwable th2) {
                ...
                public void onError(Throwable th) {
                    try {
                        C1375117.this.val$onError.call(th);
                    } catch (Throwable th2) {
                        th = new CompositeException(Arrays.asList(th, th2));
                    }
                    completableSubscriber.onError(th);
    ...
    /* renamed from: to */
    public final <U> U m118to(Func1<? super Completable, U> func1) {
 ...
 */
    ...
    /* loaded from: E:\9227576_dexfile_execute.dex */
    class C1378033 implements CompletableOnSubscribe {
        final /* synthetic */ Scheduler val$scheduler;

        C1378033(Scheduler scheduler) {
            ...
            Completable.this.subscribe(new CompletableSubscriber() { // from class: rx.Completable.33.1
                ...
                public void onSubscribe(final Subscription subscription) {
                    completableSubscriber.onSubscribe(Subscriptions.create(new Action0() { // from class: rx.Completable.33.1.1
                        @Override // p475rx.functions.Action0
                        public void call() {
                            final Scheduler.Worker createWorker = C1378033.this.val$scheduler.createWorker();
    ...
    public final Completable unsubscribeOn(Scheduler scheduler) {
        requireNonNull(scheduler);
        return create(new C1378033(scheduler));
    }
}
