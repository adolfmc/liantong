...
public final class Buffer {
    ...
    @NotNull
    public static final String readUtf8Line(@NotNull okio.Buffer readUtf8Line, long j) {
    ...
    public static final <T> T seek(@NotNull okio.Buffer seek, long j, @NotNull Function2<? super Segment, ? super Long, ? extends T> lambda) {
    ...
    public static final int selectPrefix(@NotNull okio.Buffer selectPrefix, @NotNull Options options, boolean z) {
        int i;
        int i2;
    ...
    @NotNull
    public static final okio.Buffer commonCopyTo(@NotNull okio.Buffer commonCopyTo, @NotNull okio.Buffer out, long j, long j2) {
    ...
    public static final long commonCompleteSegmentByteCount(@NotNull okio.Buffer commonCompleteSegmentByteCount) {
    ...
    public static final byte commonReadByte(@NotNull okio.Buffer commonReadByte) {
    ...
    public static final short commonReadShort(@NotNull okio.Buffer commonReadShort) {
    ...
    public static final int commonReadInt(@NotNull okio.Buffer commonReadInt) {
    ...
    public static final long commonReadLong(@NotNull okio.Buffer commonReadLong) {
    ...
    public static final byte commonGet(@NotNull okio.Buffer commonGet, long j) {
    ...
    public static final void commonClear(@NotNull okio.Buffer commonClear) {
        Intrinsics.checkParameterIsNotNull(commonClear, "$this$commonClear");
        commonClear.skip(commonClear.size());
    }

    public static final void commonSkip(@NotNull okio.Buffer commonSkip, long j) {
    ...
    public static /* synthetic */ okio.Buffer commonWrite$default(okio.Buffer commonWrite, ByteString byteString, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
    ...
    @NotNull
    public static final okio.Buffer commonWrite(@NotNull okio.Buffer commonWrite, @NotNull ByteString byteString, int i, int i2) {
        Intrinsics.checkParameterIsNotNull(commonWrite, "$this$commonWrite");
        Intrinsics.checkParameterIsNotNull(byteString, "byteString");
        byteString.write$okio(commonWrite, i, i2);
        return commonWrite;
    ...
    @NotNull
    public static final okio.Buffer commonWriteDecimalLong(@NotNull okio.Buffer commonWriteDecimalLong, long j) {
    ...
    @NotNull
    public static final okio.Buffer commonWriteHexadecimalUnsignedLong(@NotNull okio.Buffer commonWriteHexadecimalUnsignedLong, long j) {
    ...
    @NotNull
    public static final Segment commonWritableSegment(@NotNull okio.Buffer commonWritableSegment, int i) {
    ...
    @NotNull
    public static final okio.Buffer commonWrite(@NotNull okio.Buffer commonWrite, @NotNull byte[] source) {
        Intrinsics.checkParameterIsNotNull(commonWrite, "$this$commonWrite");
    ...
    @NotNull
    public static final okio.Buffer commonWrite(@NotNull okio.Buffer commonWrite, @NotNull byte[] source, int i, int i2) {
        Intrinsics.checkParameterIsNotNull(commonWrite, "$this$commonWrite");
        Intrinsics.checkParameterIsNotNull(source, "source");
        long j = i2;
    ...
    @NotNull
    public static final byte[] commonReadByteArray(@NotNull okio.Buffer commonReadByteArray) {
    ...
    @NotNull
    public static final byte[] commonReadByteArray(@NotNull okio.Buffer commonReadByteArray, long j) {
        Intrinsics.checkParameterIsNotNull(commonReadByteArray, "$this$commonReadByteArray");
    ...
    public static final int commonRead(@NotNull okio.Buffer commonRead, @NotNull byte[] sink) {
        Intrinsics.checkParameterIsNotNull(commonRead, "$this$commonRead");
        Intrinsics.checkParameterIsNotNull(sink, "sink");
        return commonRead.read(sink, 0, sink.length);
    }

    public static final void commonReadFully(@NotNull okio.Buffer commonReadFully, @NotNull byte[] sink) {
    ...
    public static final int commonRead(@NotNull okio.Buffer commonRead, @NotNull byte[] sink, int i, int i2) {
        Intrinsics.checkParameterIsNotNull(commonRead, "$this$commonRead");
        Intrinsics.checkParameterIsNotNull(sink, "sink");
    ...
    /* JADX WARN: Removed duplicated region for block: B:114:0x00d0 A[EDGE_INSN: B:114:0x00d0->B:106:0x00d0 ?: BREAK  , SYNTHETIC] */
    /*
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:97:0x00be A[EDGE_INSN: B:97:0x00be->B:91:0x00be ?: BREAK  , SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    @NotNull
    public static final ByteString commonReadByteString(@NotNull okio.Buffer commonReadByteString) {
    ...
    @NotNull
    public static final ByteString commonReadByteString(@NotNull okio.Buffer commonReadByteString, long j) {
        Intrinsics.checkParameterIsNotNull(commonReadByteString, "$this$commonReadByteString");
        if (!(j >= 0 && j <= ((long) Integer.MAX_VALUE))) {
            throw new IllegalArgumentException(("byteCount: " + j).toString());
    ...
    public static final int commonSelect(@NotNull okio.Buffer commonSelect, @NotNull Options options) {
    ...
    public static final void commonReadFully(@NotNull okio.Buffer commonReadFully, @NotNull okio.Buffer sink, long j) {
        Intrinsics.checkParameterIsNotNull(commonReadFully, "$this$commonReadFully");
        Intrinsics.checkParameterIsNotNull(sink, "sink");
    ...
    public static final long commonReadAll(@NotNull okio.Buffer commonReadAll, @NotNull Sink sink) {
    ...
    @NotNull
    public static final String commonReadUtf8(@NotNull okio.Buffer commonReadUtf8, long j) {
    ...
    @Nullable
    public static final String commonReadUtf8Line(@NotNull okio.Buffer commonReadUtf8Line) {
    ...
    @NotNull
    public static final String commonReadUtf8LineStrict(@NotNull okio.Buffer commonReadUtf8LineStrict, long j) {
    ...
    public static final int commonReadUtf8CodePoint(@NotNull okio.Buffer commonReadUtf8CodePoint) {
        int i;
        int i2;
        int i3;
    ...
    @NotNull
    public static final okio.Buffer commonWriteUtf8(@NotNull okio.Buffer commonWriteUtf8, @NotNull String string, int i, int i2) {
    ...
    @NotNull
    public static final okio.Buffer commonWriteUtf8CodePoint(@NotNull okio.Buffer commonWriteUtf8CodePoint, int i) {
    ...
    public static final long commonWriteAll(@NotNull okio.Buffer commonWriteAll, @NotNull Source source) {
    ...
    @NotNull
    public static final okio.Buffer commonWrite(@NotNull okio.Buffer commonWrite, @NotNull Source source, long j) {
        Intrinsics.checkParameterIsNotNull(commonWrite, "$this$commonWrite");
        Intrinsics.checkParameterIsNotNull(source, "source");
        while (j > 0) {
    ...
    @NotNull
    public static final okio.Buffer commonWriteByte(@NotNull okio.Buffer commonWriteByte, int i) {
    ...
    @NotNull
    public static final okio.Buffer commonWriteShort(@NotNull okio.Buffer commonWriteShort, int i) {
    ...
    @NotNull
    public static final okio.Buffer commonWriteInt(@NotNull okio.Buffer commonWriteInt, int i) {
    ...
    @NotNull
    public static final okio.Buffer commonWriteLong(@NotNull okio.Buffer commonWriteLong, long j) {
    ...
    public static final void commonWrite(@NotNull okio.Buffer commonWrite, @NotNull okio.Buffer source, long j) {
        Segment segment;
        Segment segment2;
        Intrinsics.checkParameterIsNotNull(commonWrite, "$this$commonWrite");
        Intrinsics.checkParameterIsNotNull(source, "source");
    ...
    public static final long commonRead(@NotNull okio.Buffer commonRead, @NotNull okio.Buffer sink, long j) {
        Intrinsics.checkParameterIsNotNull(commonRead, "$this$commonRead");
        Intrinsics.checkParameterIsNotNull(sink, "sink");
        if (!(j >= 0)) {
    ...
    public static final long commonIndexOf(@NotNull okio.Buffer commonIndexOf, byte b, long j, long j2) {
        Segment segment;
        int i;
    ...
    public static final long commonIndexOf(@NotNull okio.Buffer commonIndexOf, @NotNull ByteString bytes, long j) {
        long j2 = j;
        Intrinsics.checkParameterIsNotNull(commonIndexOf, "$this$commonIndexOf");
        Intrinsics.checkParameterIsNotNull(bytes, "bytes");
        boolean z = true;
    ...
    public static final boolean commonRangeEquals(@NotNull okio.Buffer commonRangeEquals, long j, @NotNull ByteString bytes, int i, int i2) {
    ...
    public static final boolean commonEquals(@NotNull okio.Buffer commonEquals, @Nullable Object obj) {
    ...
    public static final int commonHashCode(@NotNull okio.Buffer commonHashCode) {
    ...
    @NotNull
    public static final okio.Buffer commonCopy(@NotNull okio.Buffer commonCopy) {
    ...
    @NotNull
    public static final ByteString commonSnapshot(@NotNull okio.Buffer commonSnapshot) {
    ...
    @NotNull
    public static final ByteString commonSnapshot(@NotNull okio.Buffer commonSnapshot, int i) {
        Intrinsics.checkParameterIsNotNull(commonSnapshot, "$this$commonSnapshot");
        if (i == 0) {
    ...
    public static final long commonIndexOfElement(@NotNull okio.Buffer commonIndexOfElement, @NotNull ByteString targetBytes, long j) {
        int i;
        int i2;
