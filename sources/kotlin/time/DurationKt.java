...
public final class DurationKt {
    ...
    private static final double m25487timesmvk6XK0(int i, double d) {
        return Duration.m25469timesimpl(d, i);
    }
    ...
    private static final double m25486timeskIfJnKk(double d, double d2) {
        return Duration.m25468timesimpl(d2, d);
    }
    ...
    public static final double toDuration(double d, @NotNull TimeUnit unit) {
        Intrinsics.checkParameterIsNotNull(unit, "unit");
        return Duration.m25442constructorimpl(DurationUnitKt.convertDurationUnit(d, unit, TimeUnit.NANOSECONDS));
    }
}
