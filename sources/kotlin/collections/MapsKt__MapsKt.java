...
public class MapsKt__MapsKt extends MapsJVM {
    ...
    @InlineOnly
    private static final <K, V> Map<K, V> buildMap(@Inference Function1<? super Map<K, V>, Unit> function1) {
    ...
    @ExperimentalStdlibApi
    @InlineOnly
    private static final <K, V> Map<K, V> buildMap(int i, @Inference Function1<? super Map<K, V>, Unit> function1) {
    ...
    @SinceKotlin(version = "1.3")
    @InlineOnly
    private static final Object ifEmpty(Map map, Functions functions) {
        return map.isEmpty() ? functions.invoke() : map;
    }
    ...
    @InlineOnly
    private static final <K, V> Tuples<K, V> toPair(@NotNull Map.Entry<? extends K, ? extends V> entry) {
        return new Tuples<>(entry.getKey(), entry.getValue());
    }

    @InlineOnly
    private static final <K, V> V getOrElse(@NotNull Map<K, ? extends V> map, K k, Functions<? extends V> functions) {
        V v = map.get(k);
        return v != null ? v : functions.invoke();
    }

    public static final <K, V> V getOrElseNullable(@NotNull Map<K, ? extends V> getOrElseNullable, K k, @NotNull Functions<? extends V> defaultValue) {
    ...
    public static final <K, V> V getOrPut(@NotNull Map<K, V> getOrPut, K k, @NotNull Functions<? extends V> defaultValue) {
    ...
    public static final <K, V> void putAll(@NotNull Map<? super K, ? super V> putAll, @NotNull Tuples<? extends K, ? extends V>[] pairs) {
    ...
    public static final <K, V> void putAll(@NotNull Map<? super K, ? super V> putAll, @NotNull Iterable<? extends Tuples<? extends K, ? extends V>> pairs) {
        Intrinsics.checkParameterIsNotNull(putAll, "$this$putAll");
        Intrinsics.checkParameterIsNotNull(pairs, "pairs");
        for (Tuples<? extends K, ? extends V> tuples : pairs) {
            putAll.put((K) tuples.component1(), (V) tuples.component2());
    ...
    public static final <K, V> void putAll(@NotNull Map<? super K, ? super V> putAll, @NotNull Sequence<? extends Tuples<? extends K, ? extends V>> pairs) {
        Intrinsics.checkParameterIsNotNull(putAll, "$this$putAll");
        Intrinsics.checkParameterIsNotNull(pairs, "pairs");
        for (Tuples<? extends K, ? extends V> tuples : pairs) {
            putAll.put((K) tuples.component1(), (V) tuples.component2());
    ...
    @NotNull
    public static final <K, V> Map<K, V> filter(@NotNull Map<? extends K, ? extends V> filter2, @NotNull Function1<? super Map.Entry<? extends K, ? extends V>, Boolean> predicate) {
        Intrinsics.checkParameterIsNotNull(filter2, "$this$filter");
        Intrinsics.checkParameterIsNotNull(predicate, "predicate");
        LinkedHashMap linkedHashMap = new LinkedHashMap();
        for (Map.Entry<? extends K, ? extends V> entry : filter2.entrySet()) {
            if (predicate.invoke(entry).booleanValue()) {
                linkedHashMap.put(entry.getKey(), entry.getValue());
            }
        }
    ...
    @NotNull
    public static final <K, V> Map<K, V> toMap(@NotNull Iterable<? extends Tuples<? extends K, ? extends V>> toMap) {
    ...
    @NotNull
    public static final <K, V, M extends Map<? super K, ? super V>> M toMap(@NotNull Iterable<? extends Tuples<? extends K, ? extends V>> toMap, @NotNull M destination) {
        Intrinsics.checkParameterIsNotNull(toMap, "$this$toMap");
        Intrinsics.checkParameterIsNotNull(destination, "destination");
    ...
    @NotNull
    public static final <K, V> Map<K, V> toMap(@NotNull Tuples<? extends K, ? extends V>[] toMap) {
        Intrinsics.checkParameterIsNotNull(toMap, "$this$toMap");
        switch (toMap.length) {
            case 0:
                return MapsKt.emptyMap();
    ...
    @NotNull
    public static final <K, V, M extends Map<? super K, ? super V>> M toMap(@NotNull Tuples<? extends K, ? extends V>[] toMap, @NotNull M destination) {
        Intrinsics.checkParameterIsNotNull(toMap, "$this$toMap");
        Intrinsics.checkParameterIsNotNull(destination, "destination");
        MapsKt.putAll(destination, toMap);
        return destination;
    ...
    @NotNull
    public static final <K, V> Map<K, V> toMap(@NotNull Sequence<? extends Tuples<? extends K, ? extends V>> toMap) {
        Intrinsics.checkParameterIsNotNull(toMap, "$this$toMap");
        return MapsKt.optimizeReadOnlyMap(MapsKt.toMap(toMap, new LinkedHashMap()));
    }

    @NotNull
    public static final <K, V, M extends Map<? super K, ? super V>> M toMap(@NotNull Sequence<? extends Tuples<? extends K, ? extends V>> toMap, @NotNull M destination) {
        Intrinsics.checkParameterIsNotNull(toMap, "$this$toMap");
        Intrinsics.checkParameterIsNotNull(destination, "destination");
        MapsKt.putAll(destination, toMap);
        return destination;
    ...
    @NotNull
    public static final <K, V> Map<K, V> plus(@NotNull Map<? extends K, ? extends V> plus, @NotNull Tuples<? extends K, ? extends V> pair) {
    ...
    @NotNull
    public static final <K, V> Map<K, V> plus(@NotNull Map<? extends K, ? extends V> plus, @NotNull Iterable<? extends Tuples<? extends K, ? extends V>> pairs) {
        Intrinsics.checkParameterIsNotNull(plus, "$this$plus");
        Intrinsics.checkParameterIsNotNull(pairs, "pairs");
        if (plus.isEmpty()) {
    ...
    @NotNull
    public static final <K, V> Map<K, V> plus(@NotNull Map<? extends K, ? extends V> plus, @NotNull Tuples<? extends K, ? extends V>[] pairs) {
        Intrinsics.checkParameterIsNotNull(plus, "$this$plus");
        Intrinsics.checkParameterIsNotNull(pairs, "pairs");
        if (plus.isEmpty()) {
            return MapsKt.toMap(pairs);
    ...
    @NotNull
    public static final <K, V> Map<K, V> plus(@NotNull Map<? extends K, ? extends V> plus, @NotNull Sequence<? extends Tuples<? extends K, ? extends V>> pairs) {
        Intrinsics.checkParameterIsNotNull(plus, "$this$plus");
        Intrinsics.checkParameterIsNotNull(pairs, "pairs");
        LinkedHashMap linkedHashMap = new LinkedHashMap(plus);
        MapsKt.putAll(linkedHashMap, pairs);
    ...
    @InlineOnly
    private static final <K, V> void plusAssign(@NotNull Map<? super K, ? super V> plusAssign, Tuples<? extends K, ? extends V> tuples) {
        Intrinsics.checkParameterIsNotNull(plusAssign, "$this$plusAssign");
        plusAssign.put((K) tuples.getFirst(), (V) tuples.getSecond());
    }

    @InlineOnly
    private static final <K, V> void plusAssign(@NotNull Map<? super K, ? super V> plusAssign, Iterable<? extends Tuples<? extends K, ? extends V>> iterable) {
        Intrinsics.checkParameterIsNotNull(plusAssign, "$this$plusAssign");
        MapsKt.putAll(plusAssign, iterable);
    }

    @InlineOnly
    private static final <K, V> void plusAssign(@NotNull Map<? super K, ? super V> plusAssign, Tuples<? extends K, ? extends V>[] tuplesArr) {
        Intrinsics.checkParameterIsNotNull(plusAssign, "$this$plusAssign");
        MapsKt.putAll(plusAssign, tuplesArr);
    }

    @InlineOnly
    private static final <K, V> void plusAssign(@NotNull Map<? super K, ? super V> plusAssign, Sequence<? extends Tuples<? extends K, ? extends V>> sequence) {
        Intrinsics.checkParameterIsNotNull(plusAssign, "$this$plusAssign");
