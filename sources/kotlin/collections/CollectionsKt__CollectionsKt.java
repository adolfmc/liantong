...
public class CollectionsKt__CollectionsKt extends CollectionsJVM {
    ...
    @InlineOnly
    private static final <E> List<E> buildList(@Inference Function1<? super List<E>, Unit> function1) {
    ...
    @ExperimentalStdlibApi
    @InlineOnly
    private static final <E> List<E> buildList(int i, @Inference Function1<? super List<E>, Unit> function1) {
        ArrayList arrayList = new ArrayList(i);
        function1.invoke(arrayList);
        return arrayList;
    }
    ...
    @SinceKotlin(version = "1.3")
    @InlineOnly
    private static final Object ifEmpty(Collection collection, Functions functions) {
        return collection.isEmpty() ? functions.invoke() : collection;
    }
