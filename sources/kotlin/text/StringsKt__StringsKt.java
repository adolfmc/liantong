...
public class StringsKt__StringsKt extends StringsJVM {
    ...
    public static final Tuples<Integer, String> findAnyOf$StringsKt__StringsKt(@NotNull CharSequence charSequence, Collection<String> collection, int i, boolean z, boolean z2) {
        Object obj;
        Object obj2;
        if (!z && collection.size() == 1) {
            ...
            return TuplesKt.m1883to(Integer.valueOf(indexOf$default), str);
        }
            ...
            if (step < 0 ? first >= last : first <= last) {
                while (true) {
                    ...
                    if (str3 == null) {
                        ...
                        return TuplesKt.m1883to(Integer.valueOf(first), str3);
                    }
                }
            }
        } else {
            ...
            if (step2 < 0 ? first2 >= last2 : first2 <= last2) {
                while (true) {
                    ...
                    if (str5 == null) {
                        ...
                        return TuplesKt.m1883to(Integer.valueOf(first2), str5);
                    }
                }
            }
        }
    ...
    @Nullable
    public static final Tuples<Integer, String> findAnyOf(@NotNull CharSequence findAnyOf, @NotNull Collection<String> strings, int i, boolean z) {
    ...
    @Nullable
    public static final Tuples<Integer, String> findLastAnyOf(@NotNull CharSequence findLastAnyOf, @NotNull Collection<String> strings, int i, boolean z) {
    ...
    public static final int indexOfAny(@NotNull CharSequence indexOfAny, @NotNull Collection<String> strings, int i, boolean z) {
        ...
        Intrinsics.checkParameterIsNotNull(indexOfAny, "$this$indexOfAny");
        Intrinsics.checkParameterIsNotNull(strings, "strings");
        Tuples<Integer, String> findAnyOf$StringsKt__StringsKt = findAnyOf$StringsKt__StringsKt(indexOfAny, strings, i, z, false);
    ...
    public static final int lastIndexOfAny(@NotNull CharSequence lastIndexOfAny, @NotNull Collection<String> strings, int i, boolean z) {
        ...
        Intrinsics.checkParameterIsNotNull(lastIndexOfAny, "$this$lastIndexOfAny");
        Intrinsics.checkParameterIsNotNull(strings, "strings");
        Tuples<Integer, String> findAnyOf$StringsKt__StringsKt = findAnyOf$StringsKt__StringsKt(lastIndexOfAny, strings, i, z, true);
        if (findAnyOf$StringsKt__StringsKt == null || (first = findAnyOf$StringsKt__StringsKt.getFirst()) == null) {
            return -1;
        }
        return first.intValue();
    ...
    private static final Sequence<IntRange> rangesDelimitedBy$StringsKt__StringsKt(@NotNull CharSequence charSequence, final char[] cArr, int i, final boolean z, int i2) {
        ...
        return new Strings(charSequence, i, i2, new Function2<CharSequence, Integer, Tuples<? extends Integer, ? extends Integer>>() { // from class: kotlin.text.StringsKt__StringsKt$rangesDelimitedBy$2
            ...
            public /* synthetic */ Tuples<? extends Integer, ? extends Integer> invoke(CharSequence charSequence2, Integer num) {
                return invoke(charSequence2, num.intValue());
            }

            @Nullable
            public final Tuples<Integer, Integer> invoke(@NotNull CharSequence receiver, int i3) {
                Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
                int indexOfAny = StringsKt.indexOfAny(receiver, cArr, i3, z);
                if (indexOfAny < 0) {
                    return null;
                }
                return TuplesKt.m1883to(Integer.valueOf(indexOfAny), 1);
            }
        });
    }
    ...
    private static final Sequence<IntRange> rangesDelimitedBy$StringsKt__StringsKt(@NotNull CharSequence charSequence, String[] strArr, int i, final boolean z, int i2) {
        ...
        return new Strings(charSequence, i, i2, new Function2<CharSequence, Integer, Tuples<? extends Integer, ? extends Integer>>() { // from class: kotlin.text.StringsKt__StringsKt$rangesDelimitedBy$4
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
            ...
            public final Tuples<Integer, Integer> invoke(@NotNull CharSequence receiver, int i3) {
                ...
                if (findAnyOf$StringsKt__StringsKt != null) {
                    return TuplesKt.m1883to(findAnyOf$StringsKt__StringsKt.getFirst(), Integer.valueOf(((String) findAnyOf$StringsKt__StringsKt.getSecond()).length()));
                }
                return null;
            }
        });
