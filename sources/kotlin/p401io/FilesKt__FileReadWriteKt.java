        ...
        try {
            ...
            if (i > 0) {
                ...
                if (read2 != -1) {
                    ...
                    int length2 = bArr.length + fileReadWrite.size();
                    if (length2 < 0) {
                    ...
                    bArr = ArraysKt.copyInto(buffer, copyOf, bArr.length, 0, fileReadWrite.size());
                }
            }
