...
public final class ResultKt {
    ...
    private static final <R> Object runCatching(Functions<? extends R> functions) {
        try {
            ...
            return Result.m24489constructorimpl(functions.invoke());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            return Result.m24489constructorimpl(createFailure(th));
        }
    }
    ...
    private static final <T, R> Object runCatching(T t, Function1<? super T, ? extends R> function1) {
        try {
            Result.Companion companion = Result.Companion;
            return Result.m24489constructorimpl(function1.invoke(t));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            return Result.m24489constructorimpl(createFailure(th));
        }
    ...
    private static final <R, T extends R> R getOrElse(@NotNull Object obj, Function1<? super Throwable, ? extends R> function1) {
        ...
        return m24492exceptionOrNullimpl == null ? obj : function1.invoke(m24492exceptionOrNullimpl);
    }
    ...
    private static final <R, T extends R> R getOrDefault(@NotNull Object obj, R r) {
        return Result.m24495isFailureimpl(obj) ? r : obj;
    }
    ...
    private static final <R, T> R fold(@NotNull Object obj, Function1<? super T, ? extends R> function1, Function1<? super Throwable, ? extends R> function12) {
        ...
        return function12.invoke(m24492exceptionOrNullimpl);
    }
    ...
    private static final <R, T> Object map(@NotNull Object obj, Function1<? super T, ? extends R> function1) {
        if (Result.m24496isSuccessimpl(obj)) {
            Result.Companion companion = Result.Companion;
            return Result.m24489constructorimpl(function1.invoke(obj));
        }
        return Result.m24489constructorimpl(obj);
    }
    ...
    private static final <R, T extends R> Object recover(@NotNull Object obj, Function1<? super Throwable, ? extends R> function1) {
        ...
        Result.Companion companion = Result.Companion;
        return Result.m24489constructorimpl(function1.invoke(m24492exceptionOrNullimpl));
    }
    ...
    private static final <T> Object onFailure(@NotNull Object obj, Function1<? super Throwable, Unit> function1) {
        Throwable m24492exceptionOrNullimpl = Result.m24492exceptionOrNullimpl(obj);
        if (m24492exceptionOrNullimpl != null) {
            function1.invoke(m24492exceptionOrNullimpl);
        }
        return obj;
    }
