...
class MathKt__MathJVMKt extends MathH {
    ...
    @InlineOnly
    /* renamed from: ln */
    private static final double m1872ln(double d) {
        return Math.log(d);
    }
    ...
    @InlineOnly
    /* renamed from: ln */
    private static final float m1871ln(float f) {
